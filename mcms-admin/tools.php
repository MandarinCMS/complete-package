...
$is_privacy_guide = ( isset( $_GET['mcms-privacy-policy-guide'] ) && current_user_can( 'manage_privacy_options' ) );
...
if ( $is_privacy_guide ) {
	...
	get_current_screen()->add_help_tab( array(
		...
		'<p>' . __( 'The Categories and Tags Converter link on this screen will take you to the Import screen, where that Converter is one of the modules you can install. Once that module is installed, the Activate Module &amp; Run Importer link will take you to a screen where you can choose to convert tags into categories or vice versa.' ) . '</p>',
	) );

	get_current_screen()->set_help_sidebar(
		'<p><strong>' . __('For more information:') . '</strong></p>' .
		'<p>' . __('<a href="https://dev.mandarincms.com/Tools_Screen">Documentation on Tools</a>') . '</p>' .
...
if ( $is_privacy_guide ) {
	?>
	<div class="mcms-privacy-policy-guide">
		<?php MCMS_Privacy_Policy_Content::privacy_policy_guide(); ?>
	</div>
	<?php
