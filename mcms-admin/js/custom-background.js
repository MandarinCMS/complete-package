...
(function($) {
	$(document).ready(function() {
		...
		/**
		 * @summary Instantiates the MandarinCMS color picker and binds the change and clear events.
		 *
		 * @since 3.5.0
		 *
		 * @returns {void}
		 */
		$('#background-color').mcmsColorPicker({
		...
		/**
		 * @summary Binds the event for opening the MCMS Media dialog.
		 *
		 * @since 3.5.0
		 *
		 * @returns {void}
		...
		$('#choose-from-library-link').click( function( event ) {
			...
			frame = mcms.media.frames.customBackground = mcms.media({
