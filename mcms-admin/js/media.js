/* global ajaxurl, attachMediaBoxL10n, _mcmsMediaGridSettings, showNotice */
...
( function( $ ){
	...
	$( document ).ready( function() {
		var settings, $mediaGridWrap = $( '#mcms-media-grid' );

		// Opens a manage media frame into the grid.
		if ( $mediaGridWrap.length && window.mcms && window.mcms.media ) {
			settings = _mcmsMediaGridSettings;
