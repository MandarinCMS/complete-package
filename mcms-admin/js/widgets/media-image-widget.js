...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See MCMS_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	...
	ImageWidgetControl = component.MediaWidgetControl.extend({
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = mcms.template( 'mcms-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = mcms.template( 'mcms-media-widget-image-fields' );
		...
		editMedia: function editMedia() {
			...
			// Disable syncing of attachment changes back to server. See <https://core.trac.mandarincms.com/ticket/40403>.
			defaultSync = mcms.media.model.Attachment.prototype.sync;
			mcms.media.model.Attachment.prototype.sync = function rejectedSync() {
