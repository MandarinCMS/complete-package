...
(function( component ) {
	 ...
	 * @constructor
	 */
	AudioDetailsMediaFrame = mcms.media.view.MediaFrame.AudioDetails.extend({
		...
		createStates: function createStates() {
			this.states.add([
				...
				new mcms.media.controller.MediaLibrary({
					type: 'audio',
					id: 'add-audio-source',
					title: mcms.media.view.l10n.audioAddSourceTitle,
	 ...
	 * Audio widget model.
	 *
	 * See MCMS_Widget_Audio::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	...
	AudioWidgetControl = component.MediaWidgetControl.extend({
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = mcms.template( 'mcms-media-widget-audio-preview' );
