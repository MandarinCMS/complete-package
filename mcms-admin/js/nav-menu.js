/**
 * MandarinCMS Administration Navigation Menu
...
(function($) {
	...
	api = mcmsNavMenu = {
		...
		init : function() {
			...
			this.attachMySkinLocationsListeners();
			...
			if ( menus.oneMySkinLocationNoMenus )
				...
				addSelectedToMenu : function(processMethod) {
					...
					return this.each(function() {
						var t = $(this), menuItems = {},
							checkboxes = ( menus.oneMySkinLocationNoMenus && 0 === t.find( '.tabs-panel-active .categorychecklist li input:checked' ).length ) ? t.find( '#page-all li input[type="checkbox"]' ) : t.find( '.tabs-panel-active .categorychecklist li input:checked' ),
							re = /menu-item\[([^\]]*)/;
		...
		attachMySkinLocationsListeners : function() {
			var loc = $('#nav-menu-myskin-locations'), params = {};
		...
		eventOnClickMenuSave : function() {
			...
			// Copy menu myskin locations
			$('#nav-menu-myskin-locations select').each(function() {
	...
	$(document).ready(function(){ mcmsNavMenu.init(); });
