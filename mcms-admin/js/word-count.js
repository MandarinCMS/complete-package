...
( function() {
	 ...
	 *
	 * @namespace mcms.utils.wordcounter
	 * @memberof  mcms.utils
	 *
	 * @class
	 *
	 ...
	 *
	 * @since    2.6.0
	 * @memberof mcms.utils.wordcounter
	 *
	...
	// Add the WordCounter to the MCMS Utils.
	window.mcms = window.mcms || {};
	window.mcms.utils = window.mcms.utils || {};
	window.mcms.utils.WordCounter = WordCounter;
} )();
