...
if ( ! is_multisite() && ( get_option('upload_url_path') || ( get_option('upload_path') != 'mcms-plugins/uploads' && get_option('upload_path') ) ) ) {
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://dev.mandarincms.com/Settings_Media_Screen">Documentation on Media Settings</a>') . '</p>' .
...
<?php
/**
 * @global array $mcms_settings
 */
if ( isset( $GLOBALS['mcms_settings']['media']['embeds'] ) ) : ?>
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('mcms-plugins/uploads' or empty)
...
<p class="description"><?php
	/* translators: %s: mcms-plugins/uploads */
	printf( __( 'Default is %s' ), '<code>mcms-plugins/uploads</code>' );
?></p>
</td>
</tr>
