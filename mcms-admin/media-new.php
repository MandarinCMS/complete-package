 ...
 *
 * There are many filters in here for media. Modules can extend functionality
...
mcms_enqueue_script('plupload-handlers');
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://dev.mandarincms.com/Media_Add_New_Screen">Documentation on Uploading Media Files</a>') . '</p>' .
