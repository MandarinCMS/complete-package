...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://dev.mandarincms.com/Settings_Discussion_Screen">Documentation on Discussion Settings</a>') . '</p>' .
...
<p><label for="blacklist_keys"><?php _e('When a comment contains any of these words in its content, name, URL, email, or IP address, it will be put in the trash. One word or IP address per line. It will match inside words, so &#8220;press&#8221; will match &#8220;MandarinCMS&#8221;.'); ?></label></p>
<p>
...
<?php
// the above would be a good place to link to dev documentation on the gravatar functions, for putting it in myskins. anything like that?
