<?php
/**
 * MandarinCMS FTP Sockets Filesystem.
 *
 * @package MandarinCMS
...
/**
 * MandarinCMS Filesystem Class for implementing FTP Sockets.
 *
 * @since 2.5.0
 *
 * @see MCMS_Filesystem_Base
 */
class MCMS_Filesystem_ftpsockets extends MCMS_Filesystem_Base {
	/**
	 * @var ftp
	 */
	public $ftp;
	...
	public function __construct( $opt  = '' ) {
		...
		if ( ! @include_once( BASED_TREE_URI . 'mcms-admin/includes/class-ftp.php' ) ) {
			return;
		}
		$this->ftp = new ftp();
