...
// Media Hooks.
add_filter( 'mcms_handle_upload_prefilter', 'check_upload_size' );
...
// Site Hooks.
add_action( 'mcmsmueditblogaction', 'upload_space_setting' );

// Network hooks
add_action( 'update_site_option_admin_email', 'mcms_network_admin_email_change_notification', 10, 4 );

// Taxonomy Hooks
add_filter( 'get_term', 'sync_category_tag_slugs', 10, 2 );

// Post Hooks.
add_filter( 'mcms_insert_post_data', 'avoid_blog_page_permalink_collision', 10, 2 );
