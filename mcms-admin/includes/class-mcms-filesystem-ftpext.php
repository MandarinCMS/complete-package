...
/**
 * MandarinCMS Filesystem Class for implementing FTP.
 *
 * @since 2.5.0
 *
 * @see MCMS_Filesystem_Base
 */
class MCMS_Filesystem_FTPext extends MCMS_Filesystem_Base {
	public $link;
