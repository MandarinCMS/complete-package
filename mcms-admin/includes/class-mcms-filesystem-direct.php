...
/**
 * MandarinCMS Filesystem Class for direct PHP file and folder manipulation.
 *
 * @since 2.5.0
 *
 * @see MCMS_Filesystem_Base
 */
class MCMS_Filesystem_Direct extends MCMS_Filesystem_Base {
