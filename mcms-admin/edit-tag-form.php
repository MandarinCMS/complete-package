...
/**
 * Use with caution, see https://dev.mandarincms.com/Function_Reference/mcms_reset_vars
 */
mcms_reset_vars( array( 'mcms_http_referer' ) );

$mcms_http_referer = remove_query_arg( array( 'action', 'message', 'tag_ID' ), $mcms_http_referer );
...
<div id="message" class="updated">
	...
	<p><a href="<?php echo esc_url( mcms_validate_redirect( esc_url_raw( $mcms_http_referer ), admin_url( 'term.php?taxonomy=' . $taxonomy ) ) ); ?>"><?php
...
mcms_nonce_field( 'update-tag_' . $tag_ID );
...
<?php if ( !global_terms_enabled() ) { ?>
		<tr class="form-field term-slug-wrap">
			 ...
			 * @param object|MCMS_Post $tag  Term or MCMS_Post object.
			 */
...
<?php if ( is_taxonomy_hierarchical($taxonomy) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in mcms-admin/edit-tags.php */
...
<?php endif; // is_taxonomy_hierarchical() ?>
		<tr class="form-field term-description-wrap">
			...
			<p class="description"><?php _e('The description is not prominent by default; however, some myskins may show it.'); ?></p></td>
		</tr>
		<?php
		// Back compat hooks
		if ( 'category' == $taxonomy ) {
...
// Back compat hooks
if ( 'category' == $taxonomy ) {
	/** This action is documented in mcms-admin/edit-tags.php */
...
<div class="edit-tag-actions">
	...
	<?php if ( current_user_can( 'delete_term', $tag->term_id ) ) : ?>
		<span id="delete-link">
			<a class="delete" href="<?php echo admin_url( mcms_nonce_url( "edit-tags.php?action=delete&taxonomy=$taxonomy&tag_ID=$tag->term_id", 'delete-tag_' . $tag->term_id ) ) ?>"><?php _e( 'Delete' ); ?></a>
		</span>
	<?php endif; ?>
