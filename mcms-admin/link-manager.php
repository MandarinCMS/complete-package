...
$mcms_list_table = _get_list_table('MCMS_Links_List_Table');
...
'title'		=> __('Overview'),
'content'	=>
	'<p>' . sprintf(__('You can add links here to be displayed on your site, usually using <a href="%s">Widgets</a>. By default, links to several sites in the MandarinCMS community are included as examples.'), 'widgets.php') . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://dev.mandarincms.com/Links_Screen">Documentation on Managing Links</a>') . '</p>' .
...
<?php $mcms_list_table->search_box( __( 'Search Links' ), 'link' ); ?>
