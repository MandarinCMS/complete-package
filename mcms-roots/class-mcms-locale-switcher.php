<?php
/**
 * Locale API: MCMS_Locale_Switcher class
 *
 * @package MandarinCMS
 * @subpackage i18n
 * @since 4.7.0
...
class MCMS_Locale_Switcher {
	...
	/**
	 * Filters the locale of the MandarinCMS installation.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The locale of the MandarinCMS installation.
	 ...
	 *
	 * Loads the translations, changes the global `$mcms_locale` object and updates
