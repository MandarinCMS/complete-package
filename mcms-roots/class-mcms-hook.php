 ...
 * @see ArrayAccess
 */
final class MCMS_Hook implements Iterator, ArrayAccess {
	...
	public function add_filter( $tag, $function_to_add, $priority, $accepted_args ) {
		$idx = _mcms_filter_build_unique_id( $tag, $function_to_add, $priority );
	...
	public function remove_filter( $tag, $function_to_remove, $priority ) {
		$function_key = _mcms_filter_build_unique_id( $tag, $function_to_remove, $priority );
	...
	public function has_filter( $tag = '', $function_to_check = false ) {
		...
		$function_key = _mcms_filter_build_unique_id( $tag, $function_to_check, false );
		if ( ! $function_key ) {
			return false;
		}
	...
	/**
	 * Normalizes filters set up before MandarinCMS has initialized to MCMS_Hook objects.
	 *
	 * @since 4.7.0
	 * @static
	 *
	 * @param array $filters Filters to normalize.
	 * @return MCMS_Hook[] Array of normalized filters.
	 */
	public static function build_preinitialized_hooks( $filters ) {
		/** @var MCMS_Hook[] $normalized */
		$normalized = array();

		foreach ( $filters as $tag => $callback_groups ) {
			if ( is_object( $callback_groups ) && $callback_groups instanceof MCMS_Hook ) {
