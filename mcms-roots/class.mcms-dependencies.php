<?php
/**
 * Dependencies API: MCMS_Dependencies base class
 *
 * @since 2.6.0
 *
 * @package MandarinCMS
 ...
 * @since 2.6.0
 *
 * @see _MCMS_Dependency
 */
class MCMS_Dependencies {
	/**
	...
	/**
	 * An array of queued _MCMS_Dependency handle objects.
	 *
	 * @since 2.6.8
	 * @var array
	 */
	...
	/**
	 * An array of _MCMS_Dependency handle objects to queue.
	 *
	 * @since 2.6.0
	 * @var array
	 */
	...
	/**
	 * An array of _MCMS_Dependency handle objects already queued.
	 *
	 * @since 2.6.0
	 * @var array
	 */
	 ...
	 *
	 * @since 2.1.0
	 * @since 2.6.0 Moved from `MCMS_Scripts`.
	 * @since 2.8.0 Added the `$group` parameter.
	 *
	 ...
	 *
	 * @param string           $handle Name of the item. Should be unique.
	 * @param string           $src    Full URL of the item, or path of the item relative to the MandarinCMS root directory.
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new _MCMS_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 * @since 4.0.0
	 *
	 * @param array  $queue  An array of queued _MCMS_Dependency handle objects.
	 * @param string $handle Name of the item. Should be unique.
	 ...
	 * @return bool|_MCMS_Dependency Found, or object Item data.
	 */
