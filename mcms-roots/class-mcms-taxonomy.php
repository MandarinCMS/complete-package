<?php
/**
 * Taxonomy API: MCMS_Taxonomy class
 *
 * @package MandarinCMS
 * @subpackage Taxonomy
 * @since 4.7.0
...
final class MCMS_Taxonomy {
	 ...
	 * @since 4.7.0
	 *
	 * @global MCMS $mcms MCMS instance.
	 *
	...
	public function set_props( $object_type, $args ) {
		...
		if ( false !== $args['rewrite'] && ( is_admin() || '' != get_option( 'permalink_structure' ) ) ) {
			$args['rewrite'] = mcms_parse_args( $args['rewrite'], array(
				'with_front'   => true,
				'hierarchical' => false,
				'ep_mask'      => EP_NONE,
			) );
	...
	public function add_hooks() {
		add_filter( 'mcms_ajax_add-' . $this->name, '_mcms_ajax_add_hierarchical_term' );
	}
	...
	public function remove_hooks() {
		remove_filter( 'mcms_ajax_add-' . $this->name, '_mcms_ajax_add_hierarchical_term' );
	}
}
