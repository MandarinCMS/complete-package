 ...
 *
 * @since 2.1.0
 * @since 4.6.0 Moved to its own file from mcms-roots/locale.php.
 */
class MCMS_Locale {
	/**
	 ...
	 *
	 * @see MCMS_Locale::init() for how to handle the hack.
	 *
	 * @since 2.1.0
	 * @var array
	 */
	...
	public function init() {
		...
		/* translators: 'rtl' or 'ltr'. This sets the text direction for MandarinCMS. */
	 ...
	 * on mcms-admin/options-general.php to the general POT that would
