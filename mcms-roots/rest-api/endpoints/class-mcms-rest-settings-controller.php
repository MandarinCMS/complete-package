<?php
/**
 * REST API: MCMS_REST_Settings_Controller class
 *
 * @package MandarinCMS
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class MCMS_REST_Settings_Controller extends MCMS_REST_Controller {
	 ...
	 *
	 * @param MCMS_REST_Request $request Full details about the request.
	 * @return array|MCMS_Error Array on success, or MCMS_Error object on failure.
	 */
	...
	protected function prepare_value( $value, $schema ) {
		...
		if ( is_mcms_error( rest_validate_value_from_schema( $value, $schema ) ) ) {
			return null;
		}
	 ...
	 *
	 * @param MCMS_REST_Request $request Full details about the request.
	 * @return array|MCMS_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is_mcms_error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
	 ...
	 * @param  MCMS_REST_Request $request The request object.
