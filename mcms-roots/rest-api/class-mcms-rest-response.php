<?php
/**
 * REST API: MCMS_REST_Response class
 *
 * @package MandarinCMS
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class MCMS_REST_Response extends MCMS_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = mcms_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a MCMS_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return MCMS_Error|null MCMS_Error or null on not an errored response.
	 */
