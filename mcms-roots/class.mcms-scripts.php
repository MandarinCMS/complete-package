<?php
/**
 * Dependencies API: MCMS_Scripts class
 *
 * @since 2.6.0
 *
 * @package MandarinCMS
 ...
 * @since 2.1.0
 *
 * @see MCMS_Dependencies
 */
class MCMS_Scripts extends MCMS_Dependencies {
	/**
	...
	public function init() {
		/**
		 * Fires when the MCMS_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param MCMS_Scripts $this MCMS_Scripts instance (passed by reference).
		 */
		do_action_ref_array( 'mcms_default_scripts', array(&$this) );
	}
	...
	public function print_scripts_l10n( $handle, $echo = true ) {
		_deprecated_function( __FUNCTION__, '3.3.0', 'MCMS_Scripts::print_extra_script()' );
	...
	public function localize( $handle, $object_name, $l10n ) {
		...
		$script = "var $object_name = " . mcms_json_encode( $l10n ) . ';';
	 ...
	 * @since 2.8.0
	 *
	 * @see MCMS_Dependencies::set_group()
	 *
	 ...
	 * @since 2.1.0
	 *
	 * @see MCMS_Dependencies::all_deps()
	 *
	 ...
	 * @since 2.8.0
	 *
	 * @see MCMS_Dependencies::do_items()
	 *
	...
	public function in_default_dir( $src ) {
		...
		if ( 0 === strpos( $src, '/' . MCMSINC . '/js/l10n' ) ) {
			return false;
		}
