...
?>
	<div id="sidebar" role="complementary">
		<ul>
			<?php 	/* Widgetized sidebar, if you have the module installed. */
		...
		<ul role="navigation">
			<?php mcms_list_pages('title_li=<h2>' . __('Pages') . '</h2>' ); ?>
			...
			<?php mcms_list_categories(array('show_count' => 1, 'title_li' => '<h2>' . __('Categories') . '</h2>')); ?>
		</ul>
		<ul>
			<?php if ( is_home() || is_page() ) { /* If this is the frontpage */ ?>
				<?php mcms_list_bookmarks(); ?>
