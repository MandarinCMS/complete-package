<?php
/**
 * HTTP API: MCMS_HTTP_Requests_Response class
 *
 * @package MandarinCMS
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see MCMS_HTTP_Response
 */
class MCMS_HTTP_Requests_Response extends MCMS_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return MCMS_HTTP_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new MCMS_Http_Cookie( array(
				'name'    => $cookie->name,
	...
	/**
	 * Converts the object to a MCMS_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array MCMS_Http response array, per MCMS_Http::request().
	 */
