<?php
/**
 * Diff API: MCMS_Text_Diff_Renderer_Table class
 *
 * @package MandarinCMS
 * @subpackage Diff
 * @since 4.7.0
 ...
 */
class MCMS_Text_Diff_Renderer_Table extends Text_Diff_Renderer {
	 ...
	 * @since 2.6.0
	 */
	protected $inline_diff_renderer = 'MCMS_Text_Diff_Renderer_inline';
	...
	public function _deleted( $lines, $encode = true ) {
		...
		foreach ($lines as $line) {
			if ( $encode ) {
				...
				/** This filter is documented in mcms-roots/mcms-diff.php */
