<?php
/**
 * Widget API: MCMS_Widget_Media_Audio class
 *
 * @package MandarinCMS
 * @subpackage Widgets
 * @since 4.8.0
 ...
 * @see MCMS_Widget
 */
class MCMS_Widget_Media_Audio extends MCMS_Widget_Media {
	...
	public function get_instance_schema() {
		...
		foreach ( mcms_get_audio_extensions() as $audio_extension ) {
	...
	public function enqueue_preview_scripts() {
		...
		if ( 'mediaelement' === apply_filters( 'mcms_audio_shortcode_library', 'mediaelement' ) ) {
	...
	public function render_control_template_scripts() {
		...
		?>
		<script type="text/html" id="tmpl-mcms-media-widget-audio-preview">
