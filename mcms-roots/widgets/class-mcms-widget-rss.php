<?php
/**
 * Widget API: MCMS_Widget_RSS class
 *
 * @package MandarinCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MCMS_Widget
 */
class MCMS_Widget_RSS extends MCMS_Widget {
	...
	public function widget( $args, $instance ) {
		...
		mcms_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return mcms_widget_rss_process( $new_instance, $testurl );
	}
