<?php
/**
 * Widget API: MCMS_Widget_Tag_Cloud class
 *
 * @package MandarinCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MCMS_Widget
 */
class MCMS_Widget_Tag_Cloud extends MCMS_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		$tag_cloud = mcms_tag_cloud( apply_filters( 'widget_tag_cloud_args', array(
