<?php
/**
 * Widget API: MCMS_Widget_Archives class
 *
 * @package MandarinCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MCMS_Widget
 */
class MCMS_Widget_Archives extends MCMS_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<select id="<?php echo esc_attr( $dropdown_id ); ?>" name="archive-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'>
			...
			<?php mcms_get_archives( $dropdown_args ); ?>
		 ...
		 */
		mcms_get_archives( apply_filters( 'widget_archives_args', array(
			'type'            => 'monthly',
			'show_post_count' => $c
		), $instance ) );
		?>
	 ...
	 *                            MCMS_Widget_Archives::form().
	 * @param array $old_instance Old settings for this instance.
	 * @return array Updated settings to save.
	 */
	public function update( $new_instance, $old_instance ) {
		$instance = $old_instance;
		$new_instance = mcms_parse_args( (array) $new_instance, array( 'title' => '', 'count' => 0, 'dropdown' => '') );
	...
	public function form( $instance ) {
		$instance = mcms_parse_args( (array) $instance, array( 'title' => '', 'count' => 0, 'dropdown' => '') );
