<?php
/**
 * Widget API: MCMS_Widget_Links class
 *
 * @package MandarinCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MCMS_Widget
 */
class MCMS_Widget_Links extends MCMS_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 */
		mcms_list_bookmarks( apply_filters( 'widget_links_args', $widget_links_args, $instance ) );
	}
	...
	public function form( $instance ) {
		...
		//Defaults
		$instance = mcms_parse_args( (array) $instance, array( 'images' => true, 'name' => true, 'description' => false, 'rating' => false, 'category' => false, 'orderby' => 'name', 'limit' => -1 ) );
