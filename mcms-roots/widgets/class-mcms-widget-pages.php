<?php
/**
 * Widget API: MCMS_Widget_Pages class
 *
 * @package MandarinCMS
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see MCMS_Widget
 */
class MCMS_Widget_Pages extends MCMS_Widget {
	...
	public function widget( $args, $instance ) {
		 ...
		 * @param array $instance Array of settings for the current widget.
		 */
		$out = mcms_list_pages( apply_filters( 'widget_pages_args', array(
			'title_li'    => '',
			'echo'        => 0,
			'sort_column' => $sortby,
			'exclude'     => $exclude
	...
	public function form( $instance ) {
		//Defaults
		$instance = mcms_parse_args( (array) $instance, array( 'sortby' => 'post_title', 'title' => '', 'exclude' => '') );
		?>
		<p>
