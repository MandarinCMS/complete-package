<?php
/**
 * HTTP API: MCMS_Http_Encoding class
 *
 * @package MandarinCMS
 * @subpackage HTTP
 * @since 4.4.0
...
class MCMS_Http_Encoding {
	 ...
	 * https://core.trac.mandarincms.com/ticket/18273
	 *
	 * @since 2.8.1
	 * @link https://core.trac.mandarincms.com/ticket/18273
	...
	public static function accept_encoding( $url, $args ) {
		 ...
		 */
		$type = apply_filters( 'mcms_http_accept_encoding', $type, $url, $args );
