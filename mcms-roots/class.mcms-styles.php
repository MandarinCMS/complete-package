<?php
/**
 * Dependencies API: MCMS_Styles class
 *
 * @since 2.6.0
 *
 * @package MandarinCMS
 ...
 */
class MCMS_Styles extends MCMS_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		/**
		 * Fires when the MCMS_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param MCMS_Styles $this MCMS_Styles instance (passed by reference).
		 */
		do_action_ref_array( 'mcms_default_styles', array(&$this) );
	}
	...
	public function do_item( $handle ) {
		...
		if ( 'rtl' === $this->text_direction && isset($obj->extra['rtl']) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in mcms-roots/class.mcms-styles.php */
