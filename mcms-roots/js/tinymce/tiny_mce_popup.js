...
var tinyMCEPopup = {
  ...
  init: function () {
    ...
    if (settings.popup_css !== false) {
      if (settings.popup_css) {
        ...
        settings.popup_css = self.editor.baseURI.toAbsolute("modules/compat3x/css/dialog.css");
      }
    }
  ...
  /**
   * Loads a specific dialog language pack. If you pass in module_url as a argument
   * when you open the window it will load the <module url>/langs/<code>_dlg.js lang pack file.
   *
   * @method requireLangPack
   */
  requireLangPack: function () {
    var self = this, url = self.getWindowArg('module_url') || self.getWindowArg('myskin_url'), settings = self.editor.settings, lang;
