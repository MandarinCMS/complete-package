 ...
 *
 * Loaded only when external modules are added to TinyMCE.
 */
( function() {
	var main = {}, lang = 'en';
	...
	tinyMCE.addI18n( lang + ".mandarincms", {
		mcms_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		mcms_more_desc: "Insert More Tag (Alt + Shift + T)",
		mcms_page_desc: "Insert Page break (Alt + Shift + P)",
		mcms_help_desc: "Help (Alt + Shift + H)",
		mcms_more_alt: "More...",
		mcms_page_alt: "Next page...",
		add_media: "Upload&nbsp;Attachment",
		add_image: "Add an Image",
		add_video: "Add Video",
		add_audio: "Add Audio",
		editgallery: "Edit Gallery",
		delgallery: "Delete Gallery",
		mcms_fullscreen_desc: "Distraction-free writing mode (Alt + Shift + W)"
	});

	tinyMCE.addI18n( lang + ".mcmseditimage", {
		edit_img: "Edit Image",
