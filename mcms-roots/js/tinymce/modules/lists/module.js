...
var lists = (function () {
  ...
  var register$1 = function (editor) {
    var hasModule = function (editor, module) {
      var modules = editor.settings.modules ? editor.settings.modules : '';
      return global$5.inArray(modules.split(/[ ,]/), module) !== -1;
    };
    if (!hasModule(editor, 'advlist')) {
