...
var paste = (function () {
  ...
  var global = tinymce.util.Tools.resolve('tinymce.ModuleManager');

  var hasProModule = function (editor) {
    if (/(^|[ ,])powerpaste([, ]|$)/.test(editor.settings.modules) && global.get('powerpaste')) {
      if (typeof window.console !== 'undefined' && window.console.log) {
        window.console.log('PowerPaste is incompatible with Paste module! Remove \'paste\' from the \'modules\' option.');
      }
      return true;
    } else {
      return false;
  ...
  var $_5e30n7hljfuw8pt8 = { hasProModule: hasProModule };
  ...
  global.add('paste', function (editor) {
    if ($_5e30n7hljfuw8pt8.hasProModule(editor) === false) {
