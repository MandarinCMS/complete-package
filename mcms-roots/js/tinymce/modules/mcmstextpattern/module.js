/**
 * Text pattern module for TinyMCE
 *
 * @since 4.3.0
 *
 * This module can automatically format text patterns as you type. It includes several groups of patterns.
 *
 ...
 *
 * Setting for the patterns can be overridden by modules by using the `tiny_mce_before_init` PHP filter.
 * The setting name is `mcmstextpattern` and the value is an object containing override arrays for each
 * patterns group. There are three groups: "space", "enter", and "inline". Example (PHP):
 *
 * add_filter( 'tiny_mce_before_init', 'my_mce_init_mcmstextpattern' );
 * function my_mce_init_mcmstextpattern( $init ) {
 *   $init['mcmstextpattern'] = mcms_json_encode( array(
 *      'inline' => array(
...
( function( tinymce, setTimeout ) {
	...
	tinymce.ModuleManager.add( 'mcmstextpattern', function( editor ) {
		var VK = tinymce.util.VK;
		var settings = editor.settings.mcmstextpattern || {};
