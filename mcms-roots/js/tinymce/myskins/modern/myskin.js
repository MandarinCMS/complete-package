...
var modern = (function () {
  ...
  var render = function (editor, myskin, args) {
    ...
    panel = myskin.panel = global$4.create({
      type: 'panel',
      role: 'application',
      classes: 'tinymce',
  ...
  var render$1 = function (editor, myskin, args) {
  ...
  var setup = function (editor, myskin) {
    var throbber;
    editor.on('ProgressState', function (e) {
      throbber = throbber || new Throbber(myskin.panel.getEl('body'));
      if (e.state) {
  ...
  var renderUI = function (editor, myskin, args) {
    var skinUrl = getSkinUrl(editor);
    if (skinUrl) {
      args.skinUiCss = skinUrl + '/skin.min.css';
      editor.contentCSS.push(skinUrl + '/content' + (editor.inline ? '.inline' : '') + '.min.css');
    }
    $_bm31cfu2jfuw8sg3.setup(editor, myskin);
    return isInline(editor) ? $_g6zuymtgjfuw8sd6.render(editor, myskin, args) : $_6amrhfswjfuw8sbr.render(editor, myskin, args);
  };
