...
var inlite = (function () {
  ...
  var global = tinymce.util.Tools.resolve('tinymce.MySkinManager');
  ...
  var renderUI = function (editor, panel) {
    return editor.inline ? renderInlineUI(editor, panel) : fail('inlite myskin only supports inline mode.');
  };
  ...
  var $_cn53y617xjfuw8wgp = {
    ...
    moveTo: function (x, y) {
      ...
      if (self.settings.constrainToViemcmsort) {
        var viewPortRect = getViewPortRect(this);
  ...
  var insertTable = function (editor, cols, rows) {
    editor.modules.table ? editor.modules.table.insertTable(cols, rows) : insertTableHtml(editor, cols, rows);
  };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_52l0y51a7jfuw8mcmse.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_52l0y51a7jfuw8mcmse.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_52l0y51a7jfuw8mcmse.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_52l0y51a7jfuw8mcmse.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_7llj9o1a8jfuw8mcmsf.head(str).bind(function (head) {
      return $_7llj9o1a8jfuw8mcmsf.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_1vh2q91a6jfuw8mcmsc.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'edge/') && $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'chrome') && $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'safari') && $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'chrome') && !$_1vh2q91a6jfuw8mcmsc.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'msie') || $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_1vh2q91a6jfuw8mcmsc.contains(uastring, 'safari') || $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'mobile/')) && $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'iphone') || $_1vh2q91a6jfuw8mcmsc.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_bavmlr1a5jfuw8mcms6 = {
    browsers: $_d9fl1s17gjfuw8wew.constant(browsers),
    oses: $_d9fl1s17gjfuw8wew.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_bavmlr1a5jfuw8mcms6.browsers();
    var oses = $_bavmlr1a5jfuw8mcms6.oses();
    var browser = $_kiexy1a4jfuw8mcms2.detectBrowser(browsers, userAgent).fold($_ddjyrg1a0jfuw8wor.unknown, $_ddjyrg1a0jfuw8wor.nu);
    var os = $_kiexy1a4jfuw8mcms2.detectOs(oses, userAgent).fold($_2otgg1a2jfuw8wow.unknown, $_2otgg1a2jfuw8wow.nu);
  ...
  var all$2 = function (selector) {
    return $_9hz7rv1a9jfuw8mcmsg.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_bavy9s19kjfuw8wn5.ancestors(scope, function (e) {
      return $_9hz7rv1a9jfuw8mcmsg.is(e, selector);
    }, isRoot);
  };
  ...
  var descendants$1 = function (scope, selector) {
    return $_9hz7rv1a9jfuw8mcmsg.all(selector, scope);
  };
  ...
  var first$2 = function (selector) {
    return $_9hz7rv1a9jfuw8mcmsg.one(selector);
  };
  ...
  var descendant$1 = function (scope, selector) {
    return $_9hz7rv1a9jfuw8mcmsg.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_9hz7rv1a9jfuw8mcmsg.is, ancestor$1, scope, selector, isRoot);
  };
  ...
  var $_5jc0r41adjfuw8mcmst = { setup: setup };
  ...
  var Menu = FloatPanel.extend({
    ...
    init: function (settings) {
      ...
      settings.constrainToViemcmsort = true;
  ...
  var getApi = function () {
    return {
      ...
      FormatControls: $_5jc0r41adjfuw8mcmst,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_5jc0r41adjfuw8mcmst.setup(editor);
