 ...
 *
 * @param img
 *            A HTML image element to attach the module to
 * @param options
 *            An options object
 */
$.imgAreaSelect = function (img, options) {
    var
        ...
        /*
         * jQuery object representing the parent element that the module
        ...
        /* Base z-index for module elements */
        zIndex = 0,

        /* Module elements position */
        position = 'absolute',
        ...
        /* Are the module elements currently displayed? */
        shown,
    ...
    function update(resetKeyPress) {
        /* If module elements are hidden, do nothing */
        if (!shown) return;
    ...
    function imgLoad() {
         ...
         * that the module has been fully initialized and the object instance is
    ...
    /**
     * Apply style options to module element (or multiple elements)
     *
     * @param $elem
    ...
    function setOptions(newOptions) {
        ...
        /* Add classes to module elements */
