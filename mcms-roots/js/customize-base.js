...
(function( exports, $ ){
	 ...
	 * @alias mcms.customize.Value
	 *
	 * @constructor
	 */
	api.Value = api.Class.extend(/** @lends mcms.customize.Value.prototype */{
		/**
	 ...
	 *
	 * @memberOf mcms.customize
	 * @alias mcms.customize.Values
	 *
	 * @constructor
	 * @augments mcms.customize.Class
	 * @mixes mcms.customize.Events
	 */
	api.Values = api.Class.extend(/** @lends mcms.customize.Values.prototype */{
		 ...
		 *
		 * @param {string|mcms.customize.Class} item - The item instance to add, or the ID for the instance to add. When an ID string is supplied, then itemObject must be provided.
		 * @param {mcms.customize.Class}        [itemObject] - The item instance when the first argument is a ID string.
		 * @return {mcms.customize.Class} The new item's instance, or an existing instance if already added.
		 */
	 ...
	 *
	 * @memberOf mcms.customize
	 * @alias mcms.customize.Element
	 *
	 * @constructor
	 * @augments mcms.customize.Value
	 * @augments mcms.customize.Class
	 */
	api.Element = api.Value.extend(/** @lends mcms.customize.Element */{
	 ...
	 *
	 * @memberOf mcms.customize
	 * @alias mcms.customize.Messenger
	 *
	 * @constructor
	 * @augments mcms.customize.Class
	 * @mixes mcms.customize.Events
	 */
	api.Messenger = api.Class.extend(/** @lends mcms.customize.Messenger.prototype */{
		/**
		 * Create a new Value.
		 *
	 ...
	 *
	 * @memberOf mcms.customize
	 * @alias mcms.customize.Notification
	 *
	 ...
	 */
	api.Notification = api.Class.extend(/** @lends mcms.customize.Notification.prototype */{
		...
		render: function() {
			...
			if ( ! notification.template ) {
				notification.template = mcms.template( notification.templateId );
			}
	 ...
	 *
	 * @namespace mcms.customize.utils
	 */
	api.utils = {};
	...
	/**
	 * Expose the API publicly on window.mcms.customize
	 *
	 * @namespace mcms.customize
	 */
