...
( function( window, settings ) {
					...
					while ( i-- ) {
						...
						while ( ii-- ) {
							...
							if ( ! node || node.nodeType !== 1 ||
								( node.className && typeof node.className === 'string' && node.className.indexOf( 'mcms-exclude-emoji' ) !== -1 ) ) {
	...
	window.mcms.emoji = new mcmsEmoji();

} )( window, window._mcmsemojiSettings );
