...
(function ($) {
	/**
	 * Create the MandarinCMS Backbone namespace.
	 *
	 * @namespace mcms.Backbone
	 */
	mcms.Backbone = {};


	// mcms.Backbone.Subviews
	// --------------------
	//
	// A subview manager.
	mcms.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	mcms.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( mcms.Backbone.Subviews.prototype, {
		...
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || mcms.Backbone.Subviews,
	...
	//
	// The base view class.
	mcms.Backbone.View = Backbone.View.extend({
		// The constructor for the `Views` manager.
		Subviews: mcms.Backbone.Subviews,
