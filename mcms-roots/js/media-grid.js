...
/**
 * mcms.media.controller.EditAttachmentMetadata
 *
 ...
 */
EditAttachmentMetadata = mcms.media.controller.State.extend(/** @lends mcms.media.controller.EditAttachmentMetadata.prototype */{
	defaults: {
		id:      'edit-attachment',
...
/**
 * mcms.media.view.MediaFrame.Manage
 *
 ...
 */
Manage = MediaFrame.extend(/** @lends mcms.media.view.MediaFrame.Manage.prototype */{
	/**
	 * @constructs
	 */
	initialize: function() {
		...
		this.$window = $( window );
		this.$adminBar = $( '#mcmsadminbar' );
		// Store the Add New button for later reuse in mcms.media.view.UploaderInline.
		...
		this.gridRouter = new mcms.media.view.MediaFrame.Manage.Router();
	...
	openEditAttachmentModal: function( model ) {
		...
		if ( mcms.media.frames.edit ) {
			mcms.media.frames.edit.open().trigger( 'refresh', model );
		} else {
			mcms.media.frames.edit = mcms.media( {
	...
	browseContent: function( contentRegion ) {
		...
		this.browserView = contentRegion.view = new mcms.media.view.AttachmentsBrowser({
			controller: this,
	...
	startHistory: function() {
		...
		if ( window.history && window.history.pushState ) {
			...
			Backbone.history.start( {
				root: window._mcmsMediaGridSettings.adminUrl,
				pushState: true
			} );
		}
	}
...
var Details = mcms.media.view.Attachment.Details,
	TwoColumn;

/**
 * mcms.media.view.Attachment.Details.TwoColumn
 *
 * A similar view to media.view.Attachment.Details
 * for use in the Edit Attachment modal.
 *
 * @memberOf mcms.media.view.Attachment.Details
 *
 * @class
 * @augments mcms.media.view.Attachment.Details
 * @augments mcms.media.view.Attachment
 * @augments mcms.media.View
 * @augments mcms.Backbone.View
 * @augments Backbone.View
 */
TwoColumn = Details.extend(/** @lends mcms.media.view.Attachment.Details.TowColumn.prototype */{
	template: mcms.template( 'attachment-details-two-column' ),
	...
	render: function() {
		...
		mcms.media.mixin.removeAllPlayers();
		this.$( 'audio, video' ).each( function (i, elem) {
			var el = mcms.media.view.MediaDetails.prepareSrc( elem );
			new window.MediaElementPlayer( el, mcms.media.mixin.mejsSettings );
		} );
	}
});
...
/**
 * mcms.media.view.MediaFrame.Manage.Router
 *
 * A router for handling the browser history and application state.
 *
 * @memberOf mcms.media.view.MediaFrame.Manage
 *
 * @class
 * @augments Backbone.Router
 */
var Router = Backbone.Router.extend(/** @lends mcms.media.view.MediaFrame.Manage.Router.prototype */{
	routes: {
	...
	reset: function() {
		var frame = mcms.media.frames.edit;
	...
	editItem: function( query ) {
		this.showItem( query );
		mcms.media.frames.edit.content.mode( 'edit-details' );
	}
});
...
var View = mcms.media.View,
	EditImage = mcms.media.view.EditImage,
	Details;

/**
 * mcms.media.view.EditImage.Details
 *
 * @memberOf mcms.media.view.EditImage
 *
 * @class
 * @augments mcms.media.view.EditImage
 * @augments mcms.media.View
 * @augments mcms.Backbone.View
 * @augments Backbone.View
 */
Details = EditImage.extend(/** @lends mcms.media.view.EditImage.Details.prototype */{
...
var Frame = mcms.media.view.Frame,
	MediaFrame = mcms.media.view.MediaFrame,

	$ = jQuery,
	EditAttachments;

/**
 * mcms.media.view.MediaFrame.EditAttachments
 *
 ...
 * @mixes mcms.media.controller.StateMachine
 */
EditAttachments = MediaFrame.extend(/** @lends mcms.media.view.MediaFrame.EditAttachments.prototype */{

	className: 'edit-attachment-frame',
	template:  mcms.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new mcms.media.controller.EditAttachmentMetadata({
				model:   this.model,
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new mcms.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new mcms.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new mcms.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new mcms.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
...
var Button = mcms.media.view.Button,
	l10n = mcms.media.view.l10n,
	SelectModeToggle;

/**
 * mcms.media.view.SelectModeToggleButton
 *
 * @memberOf mcms.media.view
 *
 * @class
 * @augments mcms.media.view.Button
 * @augments mcms.media.View
 * @augments mcms.Backbone.View
 * @augments Backbone.View
 */
SelectModeToggle = Button.extend(/** @lends mcms.media.view.SelectModeToggle.prototype */{
	initialize: function() {
		_.defaults( this.options, {
			size : ''
		} );
...
/**
 * mcms.media.view.DeleteSelectedButton
 *
 ...
 * @augments Backbone.View
 */
DeleteSelected = Button.extend(/** @lends mcms.media.view.DeleteSelectedButton.prototype */{
	initialize: function() {
		Button.prototype.initialize.apply( this, arguments );
	...
	filterChange: function( model ) {
		...
		} else if ( mcms.media.view.settings.mediaTrash ) {
...
var Button = mcms.media.view.Button,
	DeleteSelected = mcms.media.view.DeleteSelectedButton,
	DeleteSelectedPermanently;

/**
 * mcms.media.view.DeleteSelectedPermanentlyButton
 *
 ...
 *
 * @class
 * @augments mcms.media.view.DeleteSelectedButton
 * @augments mcms.media.view.Button
 * @augments mcms.media.View
 * @augments mcms.Backbone.View
 * @augments Backbone.View
 */
DeleteSelectedPermanently = DeleteSelected.extend(/** @lends mcms.media.view.DeleteSelectedPermanentlyButton.prototype */{
	initialize: function() {
