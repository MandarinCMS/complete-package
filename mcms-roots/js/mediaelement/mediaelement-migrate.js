...
(function ( window, $ ) {
	// Reintegrate `modules` since they don't exist in MEJS anymore; it won't affect anything in the player
	if (mejs.modules === undefined) {
		mejs.modules = {};
		mejs.modules.silverlight = [];
		mejs.modules.silverlight.push({
			types: []
		});
	}
