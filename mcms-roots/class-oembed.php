 ...
 *
 * Used internally by the MCMS_Embed class, but is designed to be generic.
 *
 * @link https://dev.mandarincms.com/oEmbed oEmbed Codex Article
...
class MCMS_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://mandarincms\.tv/.*#i'                                        => array( 'https://mandarincms.tv/oembed/',                          true  ),
			...
			'#https?://(www\.)?issuu\.com/.+/docs/.+#i'                           => array( 'https://issuu.com/oembed_mcms',                           true  ),
			...
			'#https?://videopress\.com/v/.*#'                                     => array( 'https://public-api.mandarincms.com/oembed/?for=' . $host, true  ),
			'#https?://(www\.)?reddit\.com/r/[^/]+/comments/.*#i'                 => array( 'https://www.reddit.com/oembed',                         true  ),
			'#https?://(www\.)?speakerdeck\.com/.*#i'                             => array( 'https://speakerdeck.com/oembed.{format}',               true  ),
			'#https?://www\.facebook\.com/.*/posts/.*#i'                          => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/.*/activity/.*#i'                       => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/.*/photos/.*#i'                         => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/photo(s/|\.php).*#i'                    => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/permalink\.php.*#i'                     => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/media/.*#i'                             => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/questions/.*#i'                         => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/notes/.*#i'                             => array( 'https://www.facebook.com/modules/post/oembed.json/',    true  ),
			'#https?://www\.facebook\.com/.*/videos/.*#i'                         => array( 'https://www.facebook.com/modules/video/oembed.json/',   true  ),
			'#https?://www\.facebook\.com/video\.php.*#i'                         => array( 'https://www.facebook.com/modules/video/oembed.json/',   true  ),
		 ...
		 *
		 * Since MandarinCMS 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized
		 ...
		 * | MandarinCMS.tv | mandarincms.tv                      |      Yes       | 2.9.0   |
		...
		// Fix any embeds that contain new lines in the middle of the HTML which breaks mcmsautop().
	 ...
	 *
	 * The provider is added just-in-time when mcms_oembed_add_provider() is called before
	 * the {@see 'modules_loaded'} hook.
	 *
	 ...
	 *
	 * The provider is removed just-in-time when mcms_oembed_remove_provider() is called before
	 * the {@see 'modules_loaded'} hook.
	 *
	 ...
	 * @static
	 *
	 * @see mcms_oembed_remove_provider()
	 *
	...
	public function discover( $url ) {
		...
		// Fetch URL content
		$request = mcms_safe_remote_get( $url, $args );
		if ( $html = mcms_remote_retrieve_body( $request ) ) {
	...
	public function fetch( $provider, $url, $args = '' ) {
		$args = mcms_parse_args( $args, mcms_embed_defaults( $url ) );
		...
		foreach ( array( 'json', 'xml' ) as $format ) {
			...
			if ( is_mcms_error( $result ) && 'not-implemented' == $result->get_error_code() )
				continue;
			return ( $result && ! is_mcms_error( $result ) ) ? $result : false;
		}
		return false;
	}
	 ...
	 * @return false|object|MCMS_Error False on failure, otherwise the result in the form of an object.
	 */
	private function _fetch_with_format( $provider_url_with_args, $format ) {
		$provider_url_with_args = add_query_arg( 'format', $format, $provider_url_with_args );

		/** This filter is documented in mcms-roots/class-oembed.php */
		$args = apply_filters( 'oembed_remote_get_args', array(), $provider_url_with_args );

		$response = mcms_safe_remote_get( $provider_url_with_args, $args );
		if ( 501 == mcms_remote_retrieve_response_code( $response ) )
			return new MCMS_Error( 'not-implemented' );
		if ( ! $body = mcms_remote_retrieve_body( $response ) )
			return false;
	...
	/**
	 * Converts a data object from MCMS_oEmbed::fetch() and returns the HTML.
	 *
	 * @since 2.9.0
	 *
	 ...
	 * @param object $data Data object from MCMS_oEmbed::data2html()
