<?php
/**
 * Feed API: MCMS_SimplePie_Sanitize_KSES class
 *
 * @package MandarinCMS
 * @subpackage Feed
 * @since 4.7.0
 ...
 */
class MCMS_SimplePie_Sanitize_KSES extends SimplePie_Sanitize {

	/**
	 * MandarinCMS SimplePie sanitization using KSES.
	 *
