<?php
/**
 * Customize API: MCMS_Customize_Date_Time_Control class
 *
 * @package MandarinCMS
 ...
 */
class MCMS_Customize_Date_Time_Control extends MCMS_Customize_Control {
	...
	public function content_template() {
		...
		<# _.defaults( data, <?php echo mcms_json_encode( $data ); ?> ); #>
	...
	public function get_month_choices() {
		...
		$months = array();
		for ( $i = 1; $i < 13; $i++ ) {
			$month_text = $mcms_locale->get_month_abbrev( $mcms_locale->get_month( $i ) );
