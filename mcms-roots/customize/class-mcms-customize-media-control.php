<?php
/**
 * Customize API: MCMS_Customize_Media_Control class
 *
 * @package MandarinCMS
 ...
 */
class MCMS_Customize_Media_Control extends MCMS_Customize_Control {
	/**
	 * Control type.
	 *
	 * @since 4.2.0
	 ...
	 *
	 * @since 4.1.0
	 * @since 4.2.0 Moved from MCMS_Customize_Upload_Control.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = mcms_parse_args( $this->button_labels, $this->get_default_button_labels() );
	}
	...
	public function to_json() {
		...
		if ( is_object( $this->setting ) ) {
			...
			if ( $value && $this->setting->default && $value === $this->setting->default ) {
				...
				$this->json['attachment'] = mcms_prepare_attachment_for_js( $value );
			}
		}
	}
	 ...
	 * @since 4.2.0 Moved from MCMS_Customize_Upload_Control.
	 *
	 * @see MCMS_Customize_Media_Control::content_template()
	 */
			...
			<div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
				<div class="thumbnail thumbnail-{{ data.attachment.type }}">
					...
					<# } else if ( 'video' === data.attachment.type ) { #>
						<div class="mcms-media-wrapper mcms-video">
