<?php
/**
 * Customize API: MCMS_Customize_Nav_Menu_Locations_Control class
 *
 * @package MandarinCMS
 ...
 * @since 4.9.0
 */
class MCMS_Customize_Nav_Menu_Locations_Control extends MCMS_Customize_Control {
		...
		if ( current_myskin_supports( 'menus' ) ) :
			...
			<ul class="menu-location-settings">
				<li class="customize-control assigned-menu-locations-title">
					<span class="customize-control-title">{{ mcms.customize.Menus.data.l10n.locationsTitle }}</span>
					<# if ( data.isCreating ) { #>
						<p>
							...
							<em class="new-menu-locations-widget-note">
								...
								printf(
									...
									__( 'https://dev.mandarincms.com/MandarinCMS_Widgets' ),
					...
					<li class="customize-control customize-control-checkbox assigned-menu-location">
						<span class="customize-inside-control-row">
							...
							<label for="{{ elementId }}">
								...
								<span class="myskin-location-set">
									<?php
