<?php
/**
 * Customize API: MCMS_Customize_Site_Icon_Control class
 *
 * @package MandarinCMS
 ...
 * @since 4.3.0
 *
 * @see MCMS_Customize_Cropped_Image_Control
 */
class MCMS_Customize_Site_Icon_Control extends MCMS_Customize_Cropped_Image_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		add_action( 'customize_controls_print_styles', 'mcms_site_icon', 99 );
	}
		...
		<# if ( data.attachment && data.attachment.id ) { #>
			<div class="attachment-media-view">
				<# if ( data.attachment.sizes ) { #>
					<div class="site-icon-preview mcms-clearfix">
