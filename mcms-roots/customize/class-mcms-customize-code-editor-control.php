<?php
/**
 * Customize API: MCMS_Customize_Code_Editor_Control class
 *
 * @package MandarinCMS
 ...
 */
class MCMS_Customize_Code_Editor_Control extends MCMS_Customize_Control {
	...
	public function enqueue() {
		$this->editor_settings = mcms_enqueue_code_editor( array_merge(
			array(
				'type' => $this->code_type,
				'codemirror' => array(
					'indentUnit' => 2,
	 ...
	 *
	 * @since 4.9.0
	 * @see MCMS_Customize_Control::json()
	 *
