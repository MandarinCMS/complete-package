<?php
/**
 * Customize API: MCMS_Customize_Partial class
 *
 * @package MandarinCMS
 ...
 * This class is analogous of MCMS_Customize_Control.
 *
 * @since 4.5.0
 */
class MCMS_Customize_Partial {
	 ...
	 *
	 * @since 4.5.0
	 * @see MCMS_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *                 MCMS_Customize_Partial. The callback can either echo the
	 ...
	 * @since 4.5.0
	 *
	 * @param MCMS_Customize_Selective_Refresh $component Customize Partial Refresh module instance.
	 ...
	 * }
	 */
	public function __construct( MCMS_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param MCMS_Customize_Partial $partial           MCMS_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking MCMS_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( MCMS_Customize_Partial $partial, $context = array() ) {
