<?php
/**
 * Customize API: MCMS_Customize_Nav_Menu_Item_Control class
 *
 * @package MandarinCMS
 ...
 * @since 4.3.0
 */
class MCMS_Customize_Nav_Menu_Item_Control extends MCMS_Customize_Control {
	 ...
	 *
	 * @since 4.3.0
	 * @var MCMS_Customize_Nav_Menu_Item_Setting
	 */
	public $setting;
	 ...
	 * @since 4.3.0
	 *
	 * @see MCMS_Customize_Control::__construct()
	 *
		...
		<div class="menu-item-bar">
			<div class="menu-item-handle">
				...
				<span class="item-title" aria-hidden="true">
					...
					<span class="menu-item-title<# if ( ! data.title && ! data.original_title ) { #> no-title<# } #>">{{ data.title || data.original_title || mcms.customize.Menus.data.l10n.untitled }}</span>
				</span>
				<span class="item-controls">
					<button type="button" class="button-link item-edit" aria-expanded="false"><span class="screen-reader-text"><?php
						/* translators: 1: Title of a menu item, 2: Type of a menu item */
						printf( __( 'Edit menu item: %1$s (%2$s)' ), '{{ data.title || mcms.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span><span class="toggle-indicator" aria-hidden="true"></span></button>
					<button type="button" class="button-link item-delete submitdelete deletion"><span class="screen-reader-text"><?php
						/* translators: 1: Title of a menu item, 2: Type of a menu item */
						printf( __( 'Remove Menu Item: %1$s (%2$s)' ), '{{ data.title || mcms.customize.Menus.data.l10n.untitled }}', '{{ data.item_type_label }}' );
					?></span></button>
				</span>
			</div>
		</div>
		...
		<# } #>
			...
			<p class="field-description description description-thin">
				<label for="edit-menu-item-description-{{ data.menu_item_id }}">
					...
					<span class="description"><?php _e( 'The description will be displayed in the menu if the current myskin supports it.' ); ?></span>
				</label>
			</p>
