<?php
/**
 * Customize API: MCMS_Customize_Color_Control class
 *
 * @package MandarinCMS
 ...
 */
class MCMS_Customize_Color_Control extends MCMS_Customize_Control {
	/**
	 * Type.
	 *
	 * @var string
	 ...
	 *
	 * @since 3.4.0
	 * @uses MCMS_Customize_Control::__construct()
	 *
	 ...
	 *
	 * @since 3.4.0
	 * @uses MCMS_Customize_Control::to_json()
	 */
