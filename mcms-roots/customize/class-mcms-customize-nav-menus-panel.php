<?php
/**
 * Customize API: MCMS_Customize_Nav_Menus_Panel class
 *
 * @package MandarinCMS
 ...
 */
class MCMS_Customize_Nav_Menus_Panel extends MCMS_Customize_Panel {
	...
	public function render_screen_options() {
		...
		$screen = MCMS_Screen::get( 'nav-menus.php' );
	 ...
	 *
	 * @since 4.3.0
	 * @deprecated 4.5.0 Deprecated in favor of mcms_nav_menu_manage_columns().
	 */
	public function mcms_nav_menu_manage_columns() {
		_deprecated_function( __METHOD__, '4.5.0', 'mcms_nav_menu_manage_columns' );
		require_once BASED_TREE_URI . 'mcms-admin/includes/nav-menu.php';
		return mcms_nav_menu_manage_columns();
	}
