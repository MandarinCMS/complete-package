<?php
/**
 * Bookmark Template Functions for usage in MySkins
 *
 * @package MandarinCMS
 * @subpackage Template
 */
 ...
 * HTML.
 *
 * This function is used internally by mcms_list_bookmarks() and should not be
 * used by myskins.
 *
 * @since 2.1.0
 * @access private
 ...
 *                                      the $class argument used for formatting in myskins.
 ...
 */
function mcms_list_bookmarks( $args = '' ) {
	$defaults = array(
	 ...
	 */
	$html = apply_filters( 'mcms_list_bookmarks', $output );
