...
function pum_support_page() { ?>
	...
	<div class="pum-secure-notice">
		...
		<span><?php _e( '<b>Secure HTTPS contact page</b>, running via iframe from external domain', 'baloonup-maker' ); ?> </span>
		<i class="dashicons dashicons-info" title="https://api.mcmsbaloonupmaker.com/dashboard-support/"></i>
	</div>
		...
		<script type="text/javascript">
            (function ($) {
                var frame = $('<iframe scrolling="no">')
                    .css({height: '535px'})
                    .attr('src', '<?php echo 'https://api.mcmsbaloonupmaker.com/dashboard-support/?' . build_query( pum_support_assist_args() ); ?>')
