...
class PUM_BuddyPress_Integration {
	...
	public static function get_conditions( $conditions = array() ) {
		...
		$conditions['bp_is_current_component'] = array(
			'group'    => __( 'BuddyPress', 'buddypress' ),
			'name'     => __( 'BP: Is Current Component', 'baloonup-maker' ),
			'fields'   => array(
				'selected' => array(
					'type'     => 'select',
					'multiple' => true,
		...
		$conditions['bp_is_current_action'] = array(
			'group'    => __( 'BuddyPress', 'buddypress' ),
			'name'     => __( 'BP: Is Current Action', 'baloonup-maker' ),
			'fields'   => array(
				'selected' => array(
					'type'  => 'text',
		...
		$conditions['bp_is_action_variable'] = array(
			'group'    => __( 'BuddyPress', 'buddypress' ),
			'name'     => __( 'BP: Is Action Variable', 'baloonup-maker' ),
			'fields'   => array(
				'selected' => array(
					'type'  => 'text',
