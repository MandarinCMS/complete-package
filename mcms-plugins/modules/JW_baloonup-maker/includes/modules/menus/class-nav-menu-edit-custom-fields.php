 ...
 *
 * Add mcms_nav_menu_item_custom_fields hook to the nav menu editor.
 *
 * Credits:
 ...
 * @danieliser - refactor for less complexity between MCMS versions & updating versioned classes for proper backward compatibility with the new methods.
 *
 * @since MandarinCMS 3.6.0
...
class Walker_Nav_Menu_Edit_Custom_Fields extends Walker_Nav_Menu_Edit {
	...
	protected function get_custom_fields( $item, $depth, $args = array() ) {
		...
		/**
		 * Get menu item custom fields from modules/myskins
		 *
		 ...
		 */
		do_action( 'mcms_nav_menu_item_custom_fields', $item_id, $item, $depth, $args );
