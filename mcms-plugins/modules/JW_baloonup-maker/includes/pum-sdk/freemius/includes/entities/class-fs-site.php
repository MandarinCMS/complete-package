<?php
    ...
    class FS_Site extends FS_Scope_Entity {
        ...
        public $charset;
        /**
         * @var string Platform version (e.g MandarinCMS version).
         */
        ...
        static function is_localhost_by_address( $url ) {
            ...
            return (
                ...
                fs_starts_with( $subdomain, 'staging' ) ||
                // MCMSEngine staging.
                fs_ends_with( $subdomain, '.staging.mcmsengine.com' ) ||
                // Pantheon
        ...
        function is_localhost() {
            return ( MCMS_FS__IS_LOCALHOST_FOR_SERVER || self::is_localhost_by_address( $this->url ) );
        }
         ...
         */
        function is_trial() {
            return is_numeric( $this->trial_plan_id ) && ( strtotime( $this->trial_ends ) > MCMS_FS__SCRIPT_START_TIME );
        }
