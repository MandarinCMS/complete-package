<?php
    ...
    /**
     * Class FS_Module_License
     */
    class FS_Module_License extends FS_Entity {
         ...
         */
        function is_expired() {
            return ! $this->is_lifetime() && ( strtotime( $this->expiration ) < MCMS_FS__SCRIPT_START_TIME );
        }
        ...
        function is_utilized( $is_localhost = null ) {
            if ( is_null( $is_localhost ) ) {
                $is_localhost = MCMS_FS__IS_LOCALHOST_FOR_SERVER;
            }
        ...
        function is_first_payment_pending() {
            return ( MCMS_FS__TIME_24_HOURS_IN_SEC >= strtotime( $this->expiration ) - strtotime( $this->created ) );
        }
