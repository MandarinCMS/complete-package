<?php
    ...
    /**
     * MCMS Admin notices manager both for site level and network level.
     *
    ...
    class FS_Admin_Notices {
        ...
        function add_sticky(
            ...
            $notices->add_sticky( $message, $id, $title, $type, $mcms_user_id, $module_title, $is_network_and_blog_admins );
        }
