<?php
	...
	$fs_text = array(
		...
		'activate-x-now'                => _fs_x( 'Complete "%s" Activation Now',
			'%s - module name. As complete "Jetpack" activation now' ),
		'few-module-tweaks'             => _fs_text( 'We made a few tweaks to the %s, %s' ),
		'optin-x-now'                   => _fs_text( 'Opt in to make "%s" Better!' ),
		'error'                         => _fs_text( 'Error' ),
		'failed-finding-main-path'      => _fs_text( 'Freemius SDK couldn\'t find the module\'s main file. Please contact sdk@freemius.com with the current error.' ),
		...
		'version'                      => _fs_x( 'Version', 'as module version' ),
		'name'                         => _fs_text( 'Name' ),
		...
		'module'                       => _fs_text( 'Module' ),
		'modules'                      => _fs_text( 'Modules' ),
		'myskin'                        => _fs_text( 'mySkin' ),
		'myskins'                       => _fs_text( 'mySkins' ),
		...
		'slug'                         => _fs_x( 'Slug', 'as MCMS module slug' ),
		'id'                           => _fs_text( 'ID' ),
		...
		'myskin-switch'                             => _fs_text( 'mySkin Switch' ),
		...
		'reason-found-a-better-module'             => _fs_text( 'I found a better %s' ),
		...
		'placeholder-module-name'                  => _fs_text( "What's the %s's name?" ),
		...
		'permissions-site_desc'                    => _fs_text( 'Site URL, MCMS version, PHP info, modules & myskins' ),
		'permissions-events'                       => _fs_text( 'Current %s Events' ),
		'permissions-events_desc'                  => _fs_text( 'Activation, deactivation and uninstall' ),
		'permissions-modules_myskins'               => _fs_text( 'Modules & mySkins' ),
		'permissions-modules_myskins_desc'          => _fs_text( 'Titles, versions and state.' ),
		...
		'activating'                               => _fs_x( 'Activating', 'as activating module' ),
		...
		'click-here-to-use-module-anonymously'     => _fs_text( 'Click here to use the module anonymously' ),
		...
		'module-path'                              => _fs_x( 'Module Path', 'as module folder path' ),
		'sdk-path'                                 => _fs_x( 'SDK Path', 'as sdk path' ),
		'addons-of-x'                              => _fs_text( 'Add Ons of Module %s' ),
		...
		'modules-myskins-sync'                      => _fs_text( 'Modules & mySkins Sync' ),
		...
		'x-requires-access-to-api'                 => _fs_x( '%s requires an access to our API.',
			'as moduleX requires an access to our API' ),
		...
		'deactivate-module-title'                  => _fs_text( 'That\'s exhausting, please deactivate' ),
		'deactivate-module-desc'                   => _fs_text( 'We feel your frustration and sincerely apologize for the inconvenience. Hope to see you again in the future.' ),
		...
		'addon-x-cannot-run-without-y'             => _fs_x( '%s cannot run without %s.',
			'addonX cannot run without moduleY' ),
		'addon-x-cannot-run-without-parent'        => _fs_x( '%s cannot run without the module.', 'addonX cannot run...' ),
		'module-x-activation-message'              => _fs_x( '%s activation was successfully completed.',
			'moduleX activation was successfully...' ),
		'features-and-pricing'                     => _fs_x( 'Features & Pricing', 'Module installer section title' ),
		'free-addon-not-deployed'                  => _fs_text( 'Add-on must be deployed to MandarinCMS.org or Freemius.' ),
		'paid-addon-not-deployed'                  => _fs_text( 'Paid add-on must be deployed to Freemius.' ),
		#--------------------------------------------------------------------------------
		#region Add-On Licensing
		#--------------------------------------------------------------------------------
		'addon-no-license-message'                 => _fs_text( '%s is a premium only add-on. You have to purchase a license first before activating the module.' ),
		...
		'start-trial-prompt-message'               => _fs_text( 'For compliance with the MandarinCMS.org guidelines, before we start the trial we ask that you opt in with your user and non-sensitive site information, allowing the %s to periodically send data to %s to check for version updates and to validate your trial.' ),
		...
		#--------------------------------------------------------------------------------
		'installing-module-x'                        => _fs_text( 'Installing module: %s' ),
		...
		'module-package-rename-failure'              => _fs_text( 'The remote module package does not contain a folder with the desired slug and renaming did not work.' ),
		...
		'auto-install-error-serviceware'             => _fs_text( 'Module is a "Serviceware" which means it does not have a premium code version.' ),
        #endregion
	...
	/**
	 * Localization of the strings in the module/myskin info dialog box.
	 *
	...
	$fs_module_info_text = array(
		'description'                 => _fs_x( 'Description', 'Module installer section title' ),
		'installation'                => _fs_x( 'Installation', 'Module installer section title' ),
		'faq'                         => _fs_x( 'FAQ', 'Module installer section title' ),
		'changelog'                   => _fs_x( 'Changelog', 'Module installer section title' ),
		'reviews'                     => _fs_x( 'Reviews', 'Module installer section title' ),
		'other_notes'                 => _fs_x( 'Other Notes', 'Module installer section title' ),
		...
		'requires-mandarincms-version:' => _fs_text( 'Requires MandarinCMS Version:' ),
		'author:'                     => _fs_x( 'Author:', 'as the module author' ),
		'compatible-up-to:'           => _fs_text( 'Compatible up to:' ),
		'downloaded:'                 => _fs_text( 'Downloaded:' ),
		'mcms-org-module-page'          => _fs_text( 'MandarinCMS.org Module Page' ),
		'module-homepage'             => _fs_text( 'Module Homepage' ),
		'donate-to-module'            => _fs_text( 'Donate to this module' ),
		...
		'module-install'              => _fs_text( 'Module Install' ),
		'not-tested-warning'          => _fs_text( 'This module has not been tested with your current version of MandarinCMS.' ),
		'not-compatible-warning'      => _fs_text( 'This module has not been marked as compatible with your version of MandarinCMS.' ),
