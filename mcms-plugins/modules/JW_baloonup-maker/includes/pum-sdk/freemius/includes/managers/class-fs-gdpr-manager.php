<?php
    ...
    class FS_GDPR_Manager {
        ...
        private function __construct() {
            $this->_storage     = FS_Option_Manager::get_manager( MCMS_FS__GDPR_OPTION_NAME, true, true );
            $this->_mcms_user_id  = Freemius::get_current_mcms_user_id();
            $this->_option_name = "u{$this->_mcms_user_id}";
        ...
        public function is_opt_in_notice_shown() {
            return $this->_notices->has_sticky( "gdpr_optin_actions_{$this->_mcms_user_id}", true );
        }
        ...
        public function remove_opt_in_notice() {
            $this->_notices->remove_sticky( "gdpr_optin_actions_{$this->_mcms_user_id}", true );
        ...
        public function notice_was_just_shown() {
            $this->update_option( 'notice_shown_at', MCMS_FS__SCRIPT_START_TIME );
        }
         ...
         * @since  2.1.0
         */
        public function add_opt_in_sticky_notice( $message, $module_title = null ) {
            $this->_notices->add_sticky(
                $message,
                "gdpr_optin_actions_{$this->_mcms_user_id}",
                '',
                'promotion',
                true,
                $this->_mcms_user_id,
