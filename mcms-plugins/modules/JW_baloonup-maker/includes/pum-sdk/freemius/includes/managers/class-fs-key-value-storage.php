<?php
	 ...
	 * @property bool          $module_upgrade_mode
	 * @property bool          $module_downgrade_mode
	 * @property string        $module_version
	 * @property string        $module_last_version
	 * @property bool          $is_module_new_install
	 * @property bool          $was_module_loaded
	 * @property object        $module_main_file
	...
	class FS_Key_Value_Storage implements ArrayAccess, Iterator, Countable {
		...
		protected function __construct( $id, $secondary_id, $network_level_or_blog_id = false ) {
			$this->_logger = FS_Logger::get_logger( MCMS_FS__SLUG . '_' . $secondary_id . '_' . $id, MCMS_FS__DEBUG_SDK, MCMS_FS__ECHO_DEBUG_SDK );
		 ...
		 */
		function load() {
			$all_modules_data = $this->get_all_data();
			$this->_data      = isset( $all_modules_data[ $this->_secondary_id ] ) ?
				$all_modules_data[ $this->_secondary_id ] :
				array();
		}
