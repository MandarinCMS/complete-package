<?php
    ...
    class FS_Admin_Notice_Manager {
        ...
        protected function __construct(
            ...
            $this->_id                  = $id;
            $this->_logger              = FS_Logger::get_logger( MCMS_FS__SLUG . '_' . $this->_id . '_data', MCMS_FS__DEBUG_SDK, MCMS_FS__ECHO_DEBUG_SDK );
            ...
            if ( ( $this->_is_network_notices && $is_network_admin ) ||
                ...
                if ( 0 < count( $this->_sticky_storage ) ) {
                    ...
                    add_action( "mcms_ajax_fs_dismiss_notice_action_{$ajax_action_suffix}", array(
                        &$this,
                    ...
                    foreach ( $this->_sticky_storage as $msg ) {
                        ...
                        $this->add(
                            ...
                            $msg['id'],
                            false,
                            isset( $msg['mcms_user_id'] ) ? $msg['mcms_user_id'] : null,
                            ! empty( $msg['module'] ) ? $msg['module'] : null,
                            $is_network_and_blog_admins
                        );
                    }
                }
        ...
        function _admin_notices_hook() {
            ...
            foreach ( $this->_notices as $id => $msg ) {
                if ( isset( $msg['mcms_user_id'] ) && is_numeric( $msg['mcms_user_id'] ) ) {
                    if ( get_current_user_id() != $msg['mcms_user_id'] ) {
                        continue;
                    }
                }
         ...
         * @param number|null $mcms_user_id
         * @param string|null $module_title
        ...
        function add(
            ...
            $message_object = array(
                ...
                'id'         => $id,
                'manager_id' => $this->_id,
                'module'     => ( ! is_null( $module_title ) ? $module_title : $this->_title ),
                'mcms_user_id' => $mcms_user_id,
            );
         ...
         *                                                and blog admin pages.
         */
        function add_sticky( $message, $id, $title = '', $type = 'success', $mcms_user_id = null, $module_title = null, $is_network_and_blog_admins = false ) {
            ...
            $this->add( $message, $title, $type, true, $id, true, $mcms_user_id, $module_title, $is_network_and_blog_admins );
        }
