<?php
    ...
    class FS_Storage {
        ...
        /**
         * Tells this storage wrapper class that the context module is network active. This flag will affect how values
        ...
        function migrate_to_network() {
            ...
            foreach ( self::$_NETWORK_OPTIONS_MAP as $option => $storage_level ) {
                ...
                if ( isset( $this->_storage->{$option} ) && ! isset( $this->_network_storage->{$option} ) ) {
                     ...
                     *      will downgrade to an older version of the module with the prev storage structure,
...
//            $this->_storage->save();
        ...
        private static function load_network_options_map() {
            self::$_NETWORK_OPTIONS_MAP = array(
                ...
                'was_module_loaded'          => 0,
                'network_user_id'            => 0,
                'module_upgrade_mode'        => 0,
                'module_downgrade_mode'      => 0,
