<?php
	 ...
	 */
	class FS_Customizer_Upsell_Control extends MCMS_Customize_Control {
		 ...
		 */
		public function __construct( MCMS_Customize_Manager $manager, $id, array $args ) {
		...
		public function to_json() {
			...
			// Load features.
			$pricing = $this->fs->get_api_module_scope()->get( 'pricing.json' );
