<?php
	...
	/**
	 * Class Zerif_Customizer_mySkin_Info_Main
	 *
	 * @since  1.0.0
	 * @access public
	 */
	class FS_Customizer_Support_Section extends MCMS_Customize_Section {
		...
		public function json() {
			...
			$json['myskin_title'] = $this->fs->get_module_name();

			if ( $is_contact_visible && $is_support_visible ) {
				$json['myskin_title'] .= ' ' . $this->fs->get_text_inline( 'Support', 'support' );
			}
