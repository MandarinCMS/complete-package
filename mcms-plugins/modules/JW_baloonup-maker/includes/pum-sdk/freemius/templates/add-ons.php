...
?>
	<div id="fs_addons" class="wrap fs-section">
		<?php if ( ! $has_tabs ) : ?>
		<h2><?php echo esc_html( sprintf( fs_text_inline( 'Add Ons for %s', 'add-ons-for-x', $slug ), $fs->get_module_name() ) ) ?></h2>
		<?php endif ?>
			...
			<ul class="fs-cards-list">
				<?php if ( $has_addons ) : ?>
					<?php foreach ( $addons as $addon ) : ?>
						...
						$result    = $fs->get_api_module_scope()->get( "/addons/{$addon->id}/pricing.json?type=visible" );
