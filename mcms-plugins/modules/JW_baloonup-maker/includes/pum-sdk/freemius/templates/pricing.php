<?php
	...
	if ( $fs->is_payments_sandbox() ) // Append module secure token for sandbox mode authentication.)
	{
	...
	$query_params = array_merge( $context_params, $_GET, array(
		...
		'module_version'   => $fs->get_module_version(),
		// Billing cycle.
		'billing_cycle'    => fs_request_get( 'billing_cycle', MCMS_FS__PERIOD_ANNUALLY ),
