<?php
    ...
    $module_title = $fs->get_module_title();
    $module_type  = $fs->is_module() ?
                            ...
                            <div id="application_form_container" <?php echo ( $is_pending_affiliate ) ? '' : 'style="display: none"' ?>>
                                ...
                                <form>
                                    ...
                                    <div class="input-container input-container-text">
                                        ...
                                        <?php if ( ! $is_affiliate ) : ?>
                                            <p class="description"><?php echo esc_html( sprintf( fs_text_inline( 'Please provide details on how you intend to promote %s (please be as specific as possible).', 'promotion-method-desc-field-desc', $slug ), $module_title ) ) ?></p>
                                        <?php endif ?>
                                    </div>
                                </form>
                            </div>
