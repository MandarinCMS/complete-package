<?php
    ...
    $use_module_anonymously_text = fs_text_inline( 'Click here to use the module anonymously', 'click-here-to-use-module-anonymously', $slug );
    ...
    echo sprintf( fs_text_inline( "You might have missed it, but you don't have to share any data and can just %s the opt-in.", 'dont-have-to-share-any-data', $slug ), "<a href='{$skip_url}'>{$skip_text}</a>" )
            . " <a href='{$skip_url}' class='button button-small button-secondary'>{$use_module_anonymously_text}</a>";