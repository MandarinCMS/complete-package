<?php
	...
	if ( $fs->is_registered() ) {
		...
		$freemius_site_url = $fs->has_paid_plan() ?
			'https://freemius.com/mandarincms/' :
			// Insights platform information.
			'https://freemius.com/mandarincms/usage-tracking/';
    ...
    if ( $is_network_activation ) {
        ...
        foreach ( $all_sites as $site ) {
            ...
            if ( is_object( $install ) && FS_Module_License::is_valid_id( $install->license_id ) ) {
...
HTML;
        ...
        if ( $total_available_licenses > 1 ) {
            ...
            /**
             * @var FS_Module_License $available_license
             */
