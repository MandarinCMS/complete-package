...
(function ($) {
    ...
    $(document)
        ...
        .ready(function () {
            ...
            window.mcms.mce = window.mcms.mce || {};
            window.mcms.mce.pum_shortcodes = window.mcms.mce.pum_shortcodes || {};
            ...
            _.each(shortcodes, function (args, tag) {
                 ...
                 * @type Object
                 */
                mcms.mce.pum_shortcodes[tag] = _.extend({}, base, {
                    version: args.version || 1,
                    shortcode_args: args,
                    /**
                     * For compatibility with MCMS prior to v4.2:
                     */
                    View: { //
                        type: tag,
                        template: function (options) {
                            return mcms.mce.pum_shortcodes[this.type].template(options);
                        },
                        postID: $('#post_ID').val(),
                        initialize: function (options) {
                            this.shortcode = options.shortcode;
                            mcms.mce.pum_shortcodes[this.type].shortcode_data = this.shortcode;
                        },
                        getHtml: function () {
                 ...
                 */
                if (typeof mcms.mce.views !== 'undefined' && typeof mcms.mce.views.register === 'function') {
                    mcms.mce.views.register(tag, mcms.mce.pum_shortcodes[tag]);
                }
            });
        });
