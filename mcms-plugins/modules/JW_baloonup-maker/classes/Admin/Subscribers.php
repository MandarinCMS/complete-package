...
class PUM_Admin_Subscribers {
	...
	public static function page() {
		...
		<div class="wrap">
			<h1><?php _e( 'Subscribers', 'baloonup-maker' ); ?></h1>
			<div id="pum-subscribers">
				<div id="pum-subscribers-post-body">
					<form id="pum-subscribers-list-form" method="get">
						...
						<?php
						self::list_table()->search_box( __( 'Find', 'baloonup-maker' ), 'pum-subscriber-find' );
	...
	public static function load_user_list_table_screen_options() {
		add_screen_option( 'per_page', array(
			'label'   => __( 'Subscribers Per Page', 'baloonup-maker' ),
			'default' => 20,
			'option'  => 'pum_subscribers_per_page',
		) );

		/*
		 * Instantiate the User List Table. Creating an instance here will allow the core MCMS_List_Table class to automatically
