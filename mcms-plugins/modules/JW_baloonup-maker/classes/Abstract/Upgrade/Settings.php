...
abstract class PUM_Abstract_Upgrade_Settings extends PUM_Abstract_Upgrade {
	...
	public function get_message( $code ) {
		...
		switch ( $code ) {
			...
			case 'start':
				$message = sprintf( __( 'Updating settings for v%s compatibility.', 'baloonup-maker' ), '1.7' );
				break;

			case 'done':
				$message = __( 'Settings updated successfully.', 'baloonup-maker' );
				break;
	...
	/**
	 * Process needed upgrades on BaloonUp Maker settings
	 *
