...
class PUM_Options {
	...
	/**
	 * Unique Prefix per module.
	 *
	 * @var string
	 */
	public static $_prefix = 'balooncreate_';
	...
	public static function init( $force = false ) {
		...
		if ( ! isset( self::$_data ) || $force ) {
			...
			/** @deprecated 1.7.0 */
			$balooncreate_options = self::$_data;
		}
	}
	...
	public static function get_all() {
		...
		/* @deprecated filter. */
		$settings = apply_filters( 'balooncreate_get_settings', $settings );
	...
	public static function update_all( $new_options = array() ) {
		...
		$new_options = mcms_parse_args( $new_options, $options );
