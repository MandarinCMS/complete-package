...
class MCMSCF7_FormTag implements ArrayAccess {
	...
	public function get_default_option( $default = '', $args = '' ) {
		...
		foreach ( $options as $opt ) {
			...
			if ( 'user_' == substr( $opt, 0, 5 ) && is_user_logged_in() ) {
				...
				$vals = array_map( 'mcmscf7_sanitize_query_var', $vals );
	...
	public function get_data_option( $args = '' ) {
		...
		return apply_filters( 'mcmscf7_form_tag_data_option', null, $options, $args );
	}
