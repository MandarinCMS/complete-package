...
class ThunderSliderEventsManager {
	...
	public static function getArrFilterTypes(){
			...
			$arrEventsSort = array("none" => __("All Events",'thunderslider'),
								   "today" => __("Today",'thunderslider'),
								   "tomorrow"=>__("Tomorrow",'thunderslider'),
								   "future"=>__("Future",'thunderslider'),
								   "past"=>__("Past",'thunderslider'),
								   "month"=>__("This Month",'thunderslider'),
								   "nextmonth"=>__("Next Month",'thunderslider')
			);
	 ...
	 * get meta query
	 */
	public static function getMCMSQuery($filterType, $sortBy){
		$response = array();
		...
		switch($filterType){
			...
			break;
			default:
				ThunderSliderFunctions::throwError("Wrong event filter");
			break;
		} 
	...
	public static function getArrSortBy(){
		$arrSortBy = array();
		$arrSortBy["event_start_date"] = __("Event Start Date",'thunderslider');
		$arrSortBy["event_end_date"] = __("Event End Date",'thunderslider');
		return($arrSortBy);			
	}
 ...
 * @since: 5.0
 **/
class UniteEmRev extends ThunderSliderEventsManager {}
?>