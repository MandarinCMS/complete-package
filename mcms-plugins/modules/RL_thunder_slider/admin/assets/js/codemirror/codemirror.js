...
window.CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = wrapper.CodeMirror = {
      ...
      lineInfo: lineInfo,
      getViemcmsort: function() { return {from: showingFrom, to: showingTo};},
    ...
    function updateDisplay(changes, suppressCallback, scrollTop) {
      ...
      if (from != showingFrom || to != showingTo && options.onViemcmsortChange)
        setTimeout(function(){
          if (options.onViemcmsortChange) options.onViemcmsortChange(instance, from, to);
        });
    ...
    function myskinChanged() {
      scroller.className = scroller.className.replace(/\s*cm-s-\S+/g, "") +
        options.myskin.replace(/(^|\s)\s*/g, " cm-s-");
    }
