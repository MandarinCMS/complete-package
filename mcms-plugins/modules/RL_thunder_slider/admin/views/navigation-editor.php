...
$navigation = intval(ThunderSliderBase::getGetVar('navigation', 0));

$navigs = $nav->get_all_navigations();

$rsopr = new ThunderSliderOperations();
...
<div class='wrap'>
	...
	<div class="title_line nobgnopd" style="margin-bottom: 20px !important;">
		...
		<div class="view_title">
			<?php _e('Navigation Editor', 'thunderslider'); ?>
		</div>
	</div>
	
	<div class="setting_box navig" style="margin-bottom: 20px;">
		<h3><span class="setting-step-number">1</span><span style="max-width: 400px;"><?php _e('Select the Navigation Category to Edit', 'thunderslider'); ?></span> <a original-title="" class="button-primary revblue" id="rs-add-new-navigation-element" href="javascript:void(0);"><?php _e('Add New', 'thunderslider'); ?></a></h3>
		
		<div class="table-titles">				
			<div class="rs-nav-table-cell rs-nav-table-title"><?php _e('#ID', 'thunderslider'); ?></div>
			<div class="rs-nav-table-cell rs-nav-table-title"><?php _e('Skin Name', 'thunderslider'); ?></div>
			<div class="rs-nav-table-cell rs-nav-table-title"><?php _e('Arrows', 'thunderslider'); ?></div>
			<div class="rs-nav-table-cell rs-nav-table-title"><?php _e('Bullets', 'thunderslider'); ?></div>
			<div class="rs-nav-table-cell rs-nav-table-title"><?php _e('Thumbs', 'thunderslider'); ?></div>
			<div class="rs-nav-table-cell rs-nav-table-title"><?php _e('Tabs', 'thunderslider'); ?></div>	
			<div class="rs-nav-table-cell rs-nav-table-title" style="width:auto;text-align:left;padding:0px 20px;"><?php _e('Actions', 'thunderslider'); ?></div>
		</div>
	...
	<div class="setting_box navig" style="margin-bottom: 20px;">
		<div class="rs-editing-wrapper" style="display: none;">
			<h3 style="border:0;"><span class="setting-step-number">2</span><span style="max-width: 400px;"><?php _e('Editing', 'thunderslider'); ?> <span class="rs-nav-editing-title"></span></span> <a href="javascript:void(0);" class="button-primary revred rs-remove-nav-element"><?php _e('Remove', 'thunderslider'); ?></a></h3>
			<div class="rs-editing-markups-wrap">
				<div class="rs-markup-selector">
					<div class="rs-selector-title"><?php _e('Markup', 'thunderslider'); ?></div> <span class="rs-editor-open-field"><i class="revicon-list-add"></i></span>
				</div>
				<div class="rs-markup-wrapper" style="display: none;">
					<div class="rs-markup-elements">
						<div style="padding: 20px;" class="closemeshowhide">
							<div class="helper-wrappers">
								<h4><?php _e('Actions', 'thunderslider'); ?></h4>
								<ul class="rs-element-list">
								<!--	<li id="reset-markup-arrow" data-call="arrows_markup"><span class="libtn"><?php _e('Reset Defaults', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-markup-bullets" data-call="bullets_markup"><span class="libtn"><?php _e('Reset Defaults', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-markup-thumbs" data-call="thumbs_markup"><span class="libtn"><?php _e('Reset Defaults', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-markup-tabs" data-call="tabs_markup"><span class="libtn"><?php _e('Reset Defaults', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>-->
									<li><span class="libtn"><?php _e('Parameters', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<ul style="display: none;" class="rs-element-add">
											<li data-call="params_special" data-paramid="title"><span class="libtn"><?php _e('Slide Title', 'thunderslider'); ?></span></li>
											<li data-call="params_special" data-paramid="description"><span class="libtn"><?php _e('Slide Description', 'thunderslider'); ?></span></li>
											<?php
											for($i=1;$i<=10;$i++){
												?>
												<li data-call="params_markup" data-paramid="<?php echo $i; ?>"><span class="libtn"><?php _e('Parameter ', 'thunderslider'); ?> <?php echo $i; ?></span></li>
												<?php
											}
											?>
										</ul>
					...
					<div class="rs-selector-title"><?php _e('CSS', 'thunderslider'); ?></div> <span class="rs-editor-open-field"><i class="revicon-list-add"></i></span>
				</div>
				<div class="rs-css-wrapper" style="display: none;">
					<div class="rs-css-elements">
						<div style="padding: 20px;" class="closemeshowhide">
							<div class="helper-wrappers rea-open">
								<h4><span class="libtn"><?php _e('Style Helper', 'thunderslider'); ?><span class="more-values-available"></span></span></h4>
								<ul class="rs-element-list collapsable" style="display:block">
									<li data-call="color_value"><span class="libtn"><?php _e('Color Value', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<div style="display: none;" class="rs-element-add rs-element-add-color">										
											...
											<a href="javascript:void(0);" id="rs-add-css-color" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
									<li data-call="border_radius"><span class="libtn"><?php _e('Border Radius', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<div style="display: none;" class="rs-element-add rs-element-add-border-radius">
											<label><?php _e('Top Left', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-radius-top-left" value="1"></td>
											<label><?php _e('Top Right', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-radius-top-right" value="1"></td>
											<label><?php _e('Bottom Right', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-radius-bottom-right" value="1"></td>
											<label><?php _e('Bottom Left', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-radius-bottom-left" value="1"></td>
											<span class="tp-clearfix"></span>
											<a href="javascript:void(0);" id="rs-add-css-border-radius" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
									<li data-call="border"><span class="libtn"><?php _e('Border', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<div style="display: none;" class="rs-element-add rs-element-add-border">
											<label><?php _e('Top', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-top" value="1">
											<label><?php _e('Right', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-right" value="1">
											<label><?php _e('Bottom', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-border-bottom" value="1">
											<label><?php _e('Left', 'thunderslider'); ?></label>
											...
											<span class="tp-clearfix"></span>																				
											<a href="javascript:void(0);" id="rs-add-css-border" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
									<li data-call="text_shadow"><span class="libtn"><?php _e('Text-Shadow', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<div style="display: none;" class="rs-element-add rs-element-add-text-shadow">
											<label><?php _e('Angle', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-text-shadow-angle" value="0">
											<label><?php _e('Distance', 'thunderslider'); ?></label>
											<input class="rs-small-input" type="text" name="rs-text-shadow-distance" value="0">
											<label><?php _e('Blur', 'thunderslider'); ?></label>
											...
											<span class="tp-clearfix"></span>										
											<a href="javascript:void(0);" id="rs-add-css-text-shadow" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
									<li data-call="box_shadow"><span class="libtn"><?php _e('Box-Shadow', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<div style="display: none;" class="rs-element-add rs-element-add-box-shadow">
											...
											<span class="tp-clearfix"></span>										
											<a href="javascript:void(0);" id="rs-add-css-box-shadow" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
									<li data-call="font_families"><span class="libtn"><?php _e('Font Family', 'thunderslider'); ?><span class="more-values-available"></span></span>
										<div style="display: none;" class="rs-element-add rs-element-add-box-shadow">
											...
											<a href="javascript:void(0);" id="rs-add-css-font-family" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
								</ul>								
							</div>
							<div class="helper-wrappers">
								<!--<h4><span class="libtn"><?php _e('Resets', 'thunderslider'); ?><span class="more-values-available"></span></span></h4>
								<ul class="rs-element-list collapsable" style="display:none">
									<li id="reset-css-arrow" data-call="arrows_css"><span class="libtn"><?php _e('Classes & Style', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-arrow-empty" data-call="arrows_css_empty"><span class="libtn"><?php _e('Only Classes', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-bullets" data-call="bullets_css"><span class="libtn"><?php _e('Classes & Style', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-bullets-empty" data-call="bullets_css_empty"><span class="libtn"><?php _e('Only Classes', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-thumbs" data-call="thumbs_css"><span class="libtn"><?php _e('Classes & Style', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-thumbs-empty" data-call="thumbs_css_empty"><span class="libtn"><?php _e('Only Classes', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-tabs" data-call="tabs_css"><span class="libtn"><?php _e('Classes & Style', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
									<li id="reset-css-tabs-empty" data-call="tabs_css_empty"><span class="libtn"><?php _e('Only Classes', 'thunderslider'); ?><span class="more-values-available resetme"></span></span></li>
								</ul>-->		
							</div>
							<div class="helper-wrappers">
								<h4><span class="libtn"><?php _e('Dynamic Values', 'thunderslider'); ?><span class="more-values-available"></span></span></h4>
								<ul class="rs-element-list collapsable" id="rs-placeholder-container" style="display:none">
									<li class="rs-always-stay">
										<div class="rs-element-add rs-element-add-placeholder">
											<a href="javascript:void(0);" id="rs-add-placeholder" class="button-primary revblue" original-title=""><?php _e('Add', 'thunderslider'); ?></a>
										</div>
									</li>
								</ul>
							</div>
			...
			<div class="rs-editing-preview-wrap">
				...
				<span class="little-info"><?php _e('Live Preview - Hover & Click for test', 'thunderslider'); ?></span>
				<span class="little-sizes">
					<?php _e('Suggested Width:', 'thunderslider'); ?>
					<input class="rs-small-input" type="text" name="rs-test-width" value="160" style="width:45px !important; margin-right:15px;">
					<?php _e('Suggested Height:', 'thunderslider'); ?>
	...
	<!--a class="button-primary revgreen" id="rs-save-navigation-style" href="javascript:void(0);"><i class="rs-icon-save-light"></i><?php _e('Save All Changes','thunderslider'); ?></a-->
	
	
	<script type="text/javascript">
		var rs_navigations = jQuery.parseJSON(<?php echo ThunderSliderFunctions::jsonEncodeForClientSide($navigs); ?>) || new Array();

		jQuery(document).ready(function(){
			var rs_current_editing = false;
			var cur_edit_type = false;
			var latest_nav_id = 0;
			var global_navigation_template = mcms.template( "rs-navigation-wrap" );
			var global_navigation_template_header = mcms.template( "rs-navigation-header-wrap" );
			...
			function rs_add_navigation_element(nav_values, is_new){
				...
				data['show_text'] = (typeof(nav_values['default']) !== 'undefined' && nav_values['default'] == true) ? '<?php _e('View', 'thunderslider'); ?>' : '<?php _e('Edit', 'thunderslider'); ?>';
				...
				if(cur_edit.settings !== undefined && cur_edit.settings.placeholders !== undefined){
					...
					for(var key in cur_edit.settings.placeholders){
						...
						switch(cur_edit.settings.placeholders[key]['type']){
							case 'color':
								ph_title = '<?php _e('Color', 'thunderslider'); ?>';
							break;
							case 'color-rgba':
								ph_title = '<?php _e('Color-RGBA', 'thunderslider'); ?>';
							break;
							case 'font-family':
								ph_title = '<?php _e('Font Family', 'thunderslider'); ?>';
							break;
							case 'custom':
								ph_title = '<?php _e('Custom', 'thunderslider'); ?>';
							break;
							default:
								continue;
							break;
			...
			jQuery('body').on('click', '.rs-edit-placeholder', function(){
				...
				alert('<?php _e('Entry not found', 'thunderslider'); ?>');
			});
			
			
			jQuery('body').on('click', '.rs-remove-placeholder', function(){
				if(confirm('<?php _e('Delete this Placeholder?', 'thunderslider'); ?>')){
					var placeholder = jQuery(this).closest('li').data('placeholder').replace(/#/g, '');
					var cur_id = rs_nav_get_selected_id();
					var nav_type = rs_get_current_nav_type();
					...
					alert('<?php _e('Could not delete, entry not found', 'thunderslider'); ?>');
				}
			});
			...
			function rs_add_all_navigation_entries(){
				rs_add_navigation_header('<?php _e('Custom Navigations', 'thunderslider'); ?>', 'rs-custom-t-wrap');
				
				for(var i = 1; i<=2; i++){
					if(i === 2) rs_add_navigation_header('<?php _e('Default Navigations', 'thunderslider'); ?>', 'rs-default-t-wrap');
				...
				if(entry != undefined){
					...
					switch(entry['type']){
						...
						case 'custom':
							...
							break;
						default:
							alert('<?php _e('Wrong Handle', 'thunderslider'); ?>');
							return false;
						break;
					}
					...
					var btn_title = "<?php _e('Currently Editing:', 'thunderslider'); ?> "+entry['title'];
					
					var btn_text = '<?php _e('Update', 'thunderslider'); ?>';
				}else{
					//check what type we currently are
					var nav_type = rs_get_current_nav_type();
					
					var btn_title = "<?php _e('Currently Editing a New Dynamic Value', 'thunderslider'); ?>";
					...
					var btn_text = '<?php _e('Add', 'thunderslider'); ?>';
				}
						...
						if(ph_handle !== '' && ph_title !== ''){
							...
							for(var key in rs_navigations){
								if(rs_navigations[key]['handle'] == ph_handle){
									alert('<?php _e('Handle already existing', 'thunderslider'); ?>');
									return false;
								}
							}
							for(var key in rs_navigations){
							...
							alert('<?php _e('Navigation not found', 'thunderslider'); ?>');
						}else{
							alert('<?php _e('Please add a valid handle/title', 'thunderslider'); ?>');
						}
...
<div id="add-placeholder-dialog" style="display: none">
	...
	<ul id="placeholder-options">
		<li data-menu="never" style="display: none;">
			<label><?php _e('On Navigation:', 'thunderslider'); ?></label>
			<select name="ph-nav-type">
				<option value="arrows"><?php _e('Arrows', 'thunderslider'); ?></option>
				<option value="bullets"><?php _e('Bullets', 'thunderslider'); ?></option>
				<option value="thumbs"><?php _e('Thumbs', 'thunderslider'); ?></option>
				<option value="tabs"><?php _e('Tabs', 'thunderslider'); ?></option>
			</select>
		</li>
		<li>
			<label><?php _e('Type:', 'thunderslider'); ?></label>
			<select name="ph-type">
				<option value="color"><?php _e('Color RGB', 'thunderslider'); ?></option>
				<option value="color-rgba"><?php _e('Color RGBA', 'thunderslider'); ?></option>
				<option value="font-family"><?php _e('Font Family', 'thunderslider'); ?></option>
				<option value="custom"><?php _e('Text/Custom', 'thunderslider'); ?></option>
			</select>
		</li>
		<li data-menu="always">
		...
		<li data-menu="always">
			<label><?php _e('Handle:', 'thunderslider'); ?></label>
			<span style="margin-left:-20px">##<input type="text" name="ph-handle" value="">##</span>
		</li>
		<li data-menu="color">
			<label><?php _e('Default Value:', 'thunderslider'); ?></label>
