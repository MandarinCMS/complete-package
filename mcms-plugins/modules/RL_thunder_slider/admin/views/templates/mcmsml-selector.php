...
$textDelete = __("Delete Slide",'thunderslider');
$textEdit = __("Edit Slide",'thunderslider');
$textPreview = __("Preview Slide",'thunderslider');
...
$langFloatMenu = ThunderSliderWpml::getLangsWithFlagsHtmlList("id='slides_langs_float' class='slides_langs_float'",$htmlBefore);
...
<div id="rev_lang_list">
	<div class="slide_langs_selector editor_buttons_wrapper  postbox unite-postbox" style="margin-bottom:20px; max-width:100% !important; min-width:1040px !important;">
		<div class="slide-main-settings-form" style="padding:15px;">
			...
			<label style="display:inline-block; margin-right:15px;"><?php _e("Choose slide language",'thunderslider'); ?>:</label>
			...
			<ul class="list_slide_icons" style="display:inline-block; vertical-align: middle; margin-bottom:0px;">
				...
				foreach($arrChildLangs as $arrLang){
					...
					$class = "";
					$urlEditSlide = self::getViewUrl(ThunderSliderAdmin::VIEW_SLIDE,"id=$childSlideID");
