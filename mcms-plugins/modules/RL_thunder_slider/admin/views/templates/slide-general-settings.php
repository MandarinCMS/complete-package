...
$slide_general_addon = apply_filters('thunderslider_slide_settings_addons', array(), $slide, $slider);
?>
...
<ul id="context-menu-first-ul" class="context-menu__items">
  ...
  <li class="context-menu__item not_in_ctx_bg" id="ctx-m-activelayer">
    <div class="ctx_item_inner"><i id="cx-selected-layer-icon" class="rs-icon-layerimage_n context-menu__link" data-action="nothing"></i><span id="cx-selected-layer-name"><?php _e('Black Canon DSLR', 'thunderslider'); ?></span>
  ...
  <li class="context-menu__item context-with-sub not_in_ctx_layer">
  	<div class="ctx_item_inner"><div class="context-menu__link"><i class="rs-icon-addlayer2"></i><span class="cx-layer-name"><?php _e('Add Layer', 'thunderslider'); ?></span></div><i class="fa-icon-chevron-right"></i></div>    
    <ul class="context-submenu">
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addtextlayer"><i class="rs-icon-layerfont_n"></i><span class="cx-layer-name"><?php _e('Add Text/Html Layer', 'thunderslider'); ?></span></div></div></li>
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addimagelayer"><i class="rs-icon-layerimage_n"></i><span class="cx-layer-name"><?php _e('Add Image Layer', 'thunderslider'); ?></span></div></div></li>
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addaudiolayer"><i class="rs-icon-layeraudio_n"></i><span class="cx-layer-name"><?php _e('Add Audio Layer', 'thunderslider'); ?></span></div></div></li>
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addvideolayer"><i class="rs-icon-layervideo_n"></i><span class="cx-layer-name"><?php _e('Add Video Layer', 'thunderslider'); ?></span></div></div></li>
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addbuttonlayer"><i class="rs-icon-layerbutton_n"></i><span class="cx-layer-name"><?php _e('Add Button Layer', 'thunderslider'); ?></span></div></div></li>
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addshapelayer"><i class="rs-icon-layershape_n"></i><span class="cx-layer-name"><?php _e('Add Shape Layer', 'thunderslider'); ?></span></div></div></li>
    	<li class="context-menu__item"><div class="ctx_item_inner"><div class="context-menu__link" data-action="addobjectlayer"><i class="rs-icon-layersvg_n"></i><span class="cx-layer-name"><?php _e('Add Object Layer', 'thunderslider'); ?></span></div></div></li>
  ...
  <li class="context-menu__item ctx-m-top-divider context-with-sub" id="ctx-select-layer">
    <div class="ctx_item_inner"><div class="context-menu__link" data-action="select layer"><i class="eg-icon-menu"></i><span class="cx-layer-name"><?php _e('Select Layer', 'thunderslider'); ?></span></div><i class="fa-icon-chevron-right"></i></div>
  ...
  <li class="context-menu__item not_in_ctx_bg">
    <div class="ctx_item_inner"><div class="context-menu__link" data-action="delete"><i class="rs-lighttrash"></i><span class="cx-layer-name"><?php _e('Delete Layer', 'thunderslider'); ?></span></div></div>
  </li>

  <li class="context-menu__item not_in_ctx_bg">
    <div class="ctx_item_inner"><div class="context-menu__link" data-action="duplicate"><i class="rs-lightcopy"></i><span class="cx-layer-name"><?php _e('Duplicate Layer', 'thunderslider'); ?></span></div></div>
  </li>
  <!-- LAYER VISIBILTY AND LOCK -->
  <li class="context-menu__item ctx-m-top-divider context-with-sub">
    <div class="ctx_item_inner"><div class="context-menu__link"><i class="eg-icon-eye"></i><span class="cx-layer-name"><?php _e('Show Layers', 'thunderslider'); ?></span></div><i class="fa-icon-chevron-right"></i></div>
    <ul class="context-submenu" id="ctx_list_of_invisibles">
    	<li class="context-menu__item">
		    <div class="ctx_item_inner"><div class="context-menu__link" data-action="showalllayer"><i class="fa-icon-asterisk"></i><span class="cx-layer-name"><?php _e('Show All Layers', 'thunderslider'); ?></span></div></div>
		  </li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner"><div class="context-menu__link" data-action="showonlycurrent"><i class="fa-icon-hand-o-right"></i><span class="cx-layer-name"><?php _e('Show Only Current Layer', 'thunderslider'); ?></span></div></div>
		</li>
    </ul>
  </li>

  <li class="context-menu__item not_in_ctx_bg" id="cx-selected-layer-visible">
    <div class="ctx_item_inner"><div class="context-menu__link" data-action="showhide"><i class="eg-icon-eye-off"></i><span class="cx-layer-name"><?php _e('Hide Layer', 'thunderslider'); ?></span></div></div>
  </li>

  <li class="context-menu__item not_in_ctx_bg" id="cx-selected-layer-locked">
    <div class="ctx_item_inner"><div class="context-menu__link" data-action="lockunlock"><i class="eg-icon-lock-open"></i><span class="cx-layer-name"><?php _e('Lock Layer', 'thunderslider'); ?></span></div></div>
  </li>

  <!-- LAYER SPECIALS -->
  <!-- STYLE OF LAYERS -->
  <li class="context-menu__item ctx-m-top-divider context-with-sub not_in_ctx_bg">
  	<div class="ctx_item_inner"><div class="context-menu__link"><i class="fa-icon-paint-brush"></i><span class="cx-layer-name"><?php _e('Style', 'thunderslider'); ?></span></div><i class="fa-icon-chevron-right"></i></div>    
    <ul class="context-submenu">
    	<li class="context-menu__item">
		    <div class="ctx_item_inner"><div class="context-menu__link" data-action="copystyle"><i class="fa-icon-cut"></i><span class="cx-layer-name"><?php _e('Copy Style', 'thunderslider'); ?></span></div></div>
		</li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner"><div class="context-menu__link" data-action="pastestyle"><i class="fa-icon-edit"></i><span class="cx-layer-name"><?php _e('Paste Style', 'thunderslider'); ?></span></div></div>
		</li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner">
		    	<div style="display:inline-block" class="context-menu__link" data-action="nothing"><i class="fa-icon-edit"></i><span class="cx-layer-name"><?php _e('Inherit Style from', 'thunderslider'); ?></span></div>
		...
		<li class="context-menu__item">
		    <div class="ctx_item_inner"><div class="context-menu__link" data-action="advancedcss"><i class="fa-icon-code"></i><span class="cx-layer-name"><?php _e('Advanced Layer CSS', 'thunderslider'); ?></span></div></div>
		</li>
		<li class="context-menu__item ctx-m-top-divider _ho_image _ho_group _ho_row _ho_column _ho_svg _ho_audio _ho_video _ho_group _ho_shape _ho_button">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="delegate" data-delegate="ctx_linebreak"><i class="fa-icon-level-down"></i><span class="cx-layer-name"><?php _e('Line Break', 'thunderslider'); ?></span><div id="ctx_linebreak" class="ctx-td-switcher context-menu__link" data-action="linebreak"></div></div>
		</li>
		 <li class="context-menu__item _ho_image _ho_group _ho_row _ho_column _ho_svg _ho_audio _ho_video _ho_group _ho_notincolumn">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="nothing"><i class="fa-icon-text-width"></i><span class="cx-layer-name"><?php _e('Display Mode', 'thunderslider'); ?></span><div class="context-menu__link ctx-td-option-selector-wrapper" data-action="nothing"><div id="ctx_displayblock" class="ctx-td-option-selector context-menu__link selected" data-action="displayblock">Block</div><div id="ctx_displayinline" class="ctx-td-option-selector context-menu__link" data-action="displayinline">Inline</div></div></div>
		</li>
		
		<li class="context-menu__item ctx-m-top-divider _ho_text  _ho_row _ho_column _ho_audio _ho_shape _ho_button">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="delegate" data-delegate="ctx_keepaspect"><i class="fa-icon-expand"></i><span class="cx-layer-name"><?php _e('Keep Aspect Ratio', 'thunderslider'); ?></span><div id="ctx_keepaspect" class="ctx-td-switcher context-menu__link" data-action="aspectratio"></div></div>
		</li>
		<li class="context-menu__item _ho_text _ho_group _ho_row _ho_column _ho_audio _ho_video _ho_shape _ho_button">
			<div class="ctx_item_inner"><div class="context-menu__link" data-action="resetsize"><i class="fa-icon-rotate-left"></i><span class="cx-layer-name"><?php _e('Reset Size', 'thunderslider'); ?></span></div></div>		    
		</li>
    </ul>
  </li>
  <!-- RESPONSIVENESS -->
  <li class="context-menu__item context-with-sub not_in_ctx_bg">
    <div class="ctx_item_inner"><div class="context-menu__link"><i class="fa-icon-compress"></i><span class="cx-layer-name"><?php _e('Layer Responsiveness', 'thunderslider'); ?></span></div><i class="fa-icon-chevron-right"></i></div>
    <ul class="context-submenu">
    	<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link" data-action="nothing"><span class="cx-layer-name"><?php _e('Alignment', 'thunderslider'); ?></span><div class="context-menu__link ctx-td-option-selector-wrapper" data-action="nothing"><div id="ctx_gridbased" class="ctx-td-option-selector context-menu__link selected" data-action="gridbased">Grid Based</div><div id="ctx_slidebased" class="ctx-td-option-selector context-menu__link" data-action="slidebased">Slide Based</div></div></div>
		</li>
    	<li class="context-menu__item _ho_row _ho_column">
		    <div class="ctx_item_inner context-menu__link" data-action="delegate" data-delegate="ctx_autoresponsive"><span class="cx-layer-name"><?php _e('Auto Responsive', 'thunderslider'); ?></span><div id="ctx_autoresponsive" class="ctx-td-switcher context-menu__link" data-action="autoresponsive"></div></div>
		</li>
		<li class="context-menu__item _ho_row _ho_column">
		    <div class="ctx_item_inner context-menu__link" data-action="delegate" data-delegate="ctx_childrenresponsive"><span class="cx-layer-name"><?php _e('Children Responsive', 'thunderslider'); ?></span><div id="ctx_childrenresponsive" class="ctx-td-switcher context-menu__link" data-action="childrenresponsive"></div></div>
		</li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link" data-action="delegate" data-delegate="ctx_responsiveoffset"><span class="cx-layer-name"><?php _e('Responsive Offset', 'thunderslider'); ?></span><div id="ctx_responsiveoffset" class="ctx-td-switcher context-menu__link" data-action="responsiveoffset"></div></div>
		</li>
    </ul>
  </li>
   ...
   <!-- VISIBILITY -->
  <li class="context-menu__item context-with-sub not_in_ctx_bg">
    <div class="ctx_item_inner"><div class="context-menu__link"><i class="fa-icon-eye"></i><span class="cx-layer-name"><?php _e('Visibility', 'thunderslider'); ?></span></div><i class="fa-icon-chevron-right"></i></div>
    <ul class="context-submenu">    	
    	<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="delegate" data-delegate="ctx_showhideondesktop"><i class="rs-displays-icon rs-slide-ds-desktop"></i><span class="cx-layer-name"><?php _e('Desktop', 'thunderslider'); ?></span><div id="ctx_showhideondesktop" class="ctx-td-switcher context-menu__link" data-action="showhideondesktop"></div></div>
		</li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="delegate" data-delegate="ctx_showhideonnotebook"><i class="rs-displays-icon rs-slide-ds-notebook"></i><span class="cx-layer-name"><?php _e('Notebook', 'thunderslider'); ?></span><div id="ctx_showhideonnotebook" class="ctx-td-switcher context-menu__link" data-action="showhideonnotebook"></div></div>
		</li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="delegate" data-delegate="ctx_showhideontablet"><i class="rs-displays-icon rs-slide-ds-tablet"></i><span class="cx-layer-name"><?php _e('Tablet', 'thunderslider'); ?></span><div id="ctx_showhideontablet" class="ctx-td-switcher context-menu__link" data-action="showhideontablet"></div></div>
		</li>
		<li class="context-menu__item">
		    <div class="ctx_item_inner context-menu__link noleftmargin" data-action="delegate" data-delegate="ctx_showhideonmobile"><i class="rs-displays-icon rs-slide-ds-mobile"></i><span class="cx-layer-name"><?php _e('Mobile', 'thunderslider'); ?></span><div id="ctx_showhideonmobile" class="ctx-td-switcher context-menu__link" data-action="showhideonmobile"></div></div>
		</li>
	...
	<div class="box-closed tp-accordion" style="border-bottom:5px solid #ddd;">
		<ul class="rs-slide-settings-tabs">
			...
			if(!$slide->isStaticSlide()){
				?>
				<li id="v_sgs_mp_1" data-content="#slide-main-image-settings-content" class="selected"><i style="height:45px" class="rs-mini-layer-icon eg-icon-picture-1 rs-toolbar-icon"></i><span><?php _e("Main Background",'thunderslider'); ?></span></li>					
				<?php
			}
			?>				
				<li id="v_sgs_mp_2" class="<?php echo ($slide->isStaticSlide()) ? ' selected' : ''; ?>" data-content="#slide-general-settings-content"><i style="height:45px" class="rs-mini-layer-icon rs-icon-chooser-2 rs-toolbar-icon"></i><?php _e("General Settings",'thunderslider'); ?></li>
			<?php
			if(!$slide->isStaticSlide()){
				?>
				<li id="v_sgs_mp_3" data-content="#slide-thumbnail-settings-content"><i style="height:45px" class="rs-mini-layer-icon eg-icon-flickr-1 rs-toolbar-icon"></i><?php _e("Thumbnail",'thunderslider'); ?></li>
				<li id="v_sgs_mp_4" data-content="#slide-animation-settings-content" id="slide-animation-settings-content-tab"><i style="height:45px" class="rs-mini-layer-icon rs-icon-chooser-3 rs-toolbar-icon"></i><?php _e("Slide Animation",'thunderslider'); ?></li>
				<li id="v_sgs_mp_5" data-content="#slide-seo-settings-content"><i style="height:45px" class="rs-mini-layer-icon rs-icon-advanced rs-toolbar-icon"></i><?php _e("Link & Seo",'thunderslider'); ?></li>
				<li id="v_sgs_mp_6" data-content="#slide-info-settings-content"><i style="height:45px; font-size:16px;" class="rs-mini-layer-icon eg-icon-info-circled rs-toolbar-icon"></i><?php _e("Slide Info",'thunderslider'); ?></li>						
				<li id="main-menu-nav-settings-li" data-content="#slide-nav-settings-content"><i style="height:45px; font-size:16px;" class="rs-mini-layer-icon eg-icon-magic rs-toolbar-icon"></i><?php _e("Nav. Overwrite",'thunderslider'); ?></li>
				<?php
			}
			?>				
			<?php if(!empty($slide_general_addon)){ ?>
				<li data-content="#slide-addon-wrapper"><i style="height:45px; font-size:16px;" class="rs-mini-layer-icon eg-icon-plus-circled rs-toolbar-icon"></i><?php _e("AddOns",'thunderslider'); ?></li>
			<?php } ?>
		</ul>
		...
		<form name="form_slide_params" id="form_slide_params" class="slide-main-settings-form">
			...
			if(!$slide->isStaticSlide()){
				...
				<div id="slide-main-image-settings-content" class="slide-main-settings-form">
					...
					<ul class="rs-layer-main-image-tabs" style="display:inline-block; ">
						<li data-content="#mainbg-sub-source" class="selected"><?php _e('Source', 'thunderslider'); ?></li>
						<li class="mainbg-sub-settings-selector" data-content="#mainbg-sub-setting"><?php _e('Source Settings', 'thunderslider'); ?></li>					
						<li class="mainbg-sub-filtres-selector" data-content="#mainbg-sub-filters"><?php _e('Filters', 'thunderslider'); ?></li>
						<li class="mainbg-sub-parallax-selector" data-content="#mainbg-sub-parallax"><?php _e('Parallax / 3D', 'thunderslider'); ?></li>
						<li class="mainbg-sub-kenburns-selector" data-content="#mainbg-sub-kenburns"><?php _e('Ken Burns', 'thunderslider'); ?></li>
					</ul>
					...
					<span id="mainbg-sub-source" style="display:block">
						...
						<span class="diblock bg-settings-block">
							...
							if($slider_type == 'posts' || $slider_type == 'specific_posts' || $slider_type == 'current_post' || $slider_type == 'woocommerce'){
								?>
								<label><?php _e("Featured Image",'thunderslider'); ?></label>
								<input type="radio" name="background_type" value="image" class="bgsrcchanger" data-callid="tp-bgimagemcmssrc" data-imgsettings="on" data-bgtype="image" id="radio_back_image" <?php checked($bgType, 'image'); ?>>
								
								<?php
								/*
								<div class="tp-clearfix"></div>
								<label><?php _e("Meta Image",'thunderslider'); ?></label>
								<input type="radio" name="background_type" value="meta" class="bgsrcchanger" data-callid="tp-bgimagemcmssrc" data-imgsettings="on" data-bgtype="meta" <?php checked($bgType, 'meta'); ?>>
								<span id="" class="" style="margin-left:20px;">
									<span style="margin-right: 10px"><?php _e('Meta Handle', 'thunderslider'); ?></span>
									<input type="text" id="meta_handle" name="meta_handle" value="<?php echo $meta_handle; ?>">
								</span>*/ ?>
								<?php
							}elseif($slider_type !== 'gallery'){
								?>
								<label><?php _e("Stream Image",'thunderslider'); ?></label>
								<input type="radio" name="background_type" value="image" class="bgsrcchanger" data-callid="tp-bgimagemcmssrc" data-imgsettings="on" data-bgtype="image" id="radio_back_image" <?php checked($bgType, 'image'); ?>>
								<?php
								if($slider_type == 'vimeo' || $slider_type == 'youtube' || $slider_type == 'instagram' || $slider_type == 'twitter'){
									?>
									<div class="tp-clearfix"></div>
									<label><?php _e("Stream Video",'thunderslider'); ?></label>
									<input type="radio" name="background_type" value="stream<?php echo $slider_type; ?>" class="bgsrcchanger" data-callid="tp-bgimagemcmssrc" data-imgsettings="on" data-bgtype="stream<?php echo $slider_type; ?>" <?php checked($bgType, 'stream'.$slider_type); ?>>
									<span id="streamvideo_cover" class="streamvideo_cover" style="display:none;margin-left:20px;">
										<span style="margin-right: 10px"><?php _e("Use Cover",'thunderslider'); ?></span>
									...
									<div class="tp-clearfix"></div>
									<label><?php _e("Stream Video + Image",'thunderslider'); ?></label>
									<input type="radio" name="background_type" value="stream<?php echo $slider_type; ?>both" class="bgsrcchanger" data-callid="tp-bgimagemcmssrc" data-imgsettings="on" data-bgtype="stream<?php echo $slider_type; ?>both" <?php checked($bgType, 'stream'.$slider_type.'both'); ?>>
								...
								?>
								<label ><?php _e("Main / Background Image",'thunderslider'); ?></label>
								<input type="radio" name="background_type" value="image" class="bgsrcchanger" data-callid="tp-bgimagemcmssrc" data-imgsettings="on" data-bgtype="image" id="radio_back_image" <?php checked($bgType, 'image'); ?>>
							...
							<span id="tp-bgimagemcmssrc" class="bgsrcchanger-div" style="display:none;margin-left:20px;">																
								<a href="javascript:void(0)" id="button_change_image" class="button-primary revblue" ><i class="fa-icon-mandarincms"></i><?php _e("Media Library", 'thunderslider'); ?></a>
								<a href="javascript:void(0)" id="button_change_image_objlib" class="button-primary revpurple" ><i class="fa-icon-book"></i><?php _e("Object Library", 'thunderslider'); ?></a>
							</span>
							...
							<!-- IMAGE FROM EXTERNAL -->
							<label><?php _e("External URL",'thunderslider'); ?></label>
							...
							<span id="tp-bgimageextsrc" class="bgsrcchanger-div" style="display:none;margin-left:20px;">
								...
								<a href="javascript:void(0)" id="button_change_external" class="button-primary revblue" ><?php _e("Get External",'thunderslider'); ?></a>
							</span>
							
							<div class="tp-clearfix"></div>
							
							<!-- TRANSPARENT BACKGROUND -->
							<label><?php _e("Transparent",'thunderslider'); ?></label>
							...
							<!-- COLORED BACKGROUND -->
							<label><?php _e("Colored",'thunderslider'); ?></label>
							...
							<label id="label_radio_back_youtube"><?php _e("YouTube Video",'thunderslider'); ?></label>
							...
							<span id="tp-bgyoutubesrc" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
								<label style="min-width:180px"><?php _e("ID:",'thunderslider'); ?></label>
								...
								<?php _e('example: T8--OggjJKQ', 'thunderslider'); ?>
								<div class="tp-clearfix"></div>
								<label style="min-width:180px"><?php _e("Cover Image:",'thunderslider'); ?></label>
								<span id="youtube-image-picker"><a href="javascript:void(0)" id="button_change_image_yt" class="button-primary revgreen" ><i class="fa-icon-photo"></i><?php _e("YouTube Video Poster", 'thunderslider'); ?></a></span>
							</span>
							<div class="tp-clearfix"></div>
							
							<!-- THE VIMEO SELECTOR -->
							<label id="label_radio_back_vimeo"><?php _e("Vimeo Video",'thunderslider'); ?></label>
							...
							<span id="tp-bgvimeosrc" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
								...
								<?php _e('example: 30300114', 'thunderslider'); ?>
								<div class="tp-clearfix"></div>
								<label style="min-width:180px"><?php _e("Cover Image:",'thunderslider'); ?></label>
							...
							<!-- THE HTML5 SELECTOR -->
							<label><?php _e("HTML5 Video",'thunderslider'); ?></label>
							...
							<span id="tp-bghtmlvideo" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
								...
								<label style="min-width:180px"><?php _e('MPEG:', 'thunderslider'); ?></label>
								...
								<span class="vidsrcchanger-div" style="margin-left:20px;">
									<a href="javascript:void(0)" data-inptarget="slide_bg_html_mpeg" class="button_change_video button-primary revblue" ><?php _e('Change Video', 'thunderslider'); ?></a>
								</span>
								<div class="tp-clearfix"></div>
								<label style="min-width:180px"><?php _e('WEBM:', 'thunderslider'); ?></label>
								...
								<span class="vidsrcchanger-div" style="margin-left:20px;">
									<a href="javascript:void(0)" data-inptarget="slide_bg_html_webm" class="button_change_video button-primary revblue" ><?php _e('Change Video', 'thunderslider'); ?></a>
								</span>
								<div class="tp-clearfix"></div>
								<label style="min-width:180px"><?php _e('OGV:', 'thunderslider'); ?></label>
								...
								<span class="vidsrcchanger-div" style="margin-left:20px;">
									<a href="javascript:void(0)" data-inptarget="slide_bg_html_ogv" class="button_change_video button-primary revblue" ><?php _e('Change Video', 'thunderslider'); ?></a>
								</span>
								<div class="tp-clearfix"></div>
								<label style="min-width:180px"><?php _e('Cover Image:', 'thunderslider'); ?></label>
					...
					<div id="mainbg-sub-setting" style="display:none">
						...
						<div class="rs-img-source-url">						
							<label><?php _e('Source Info:', 'thunderslider'); ?></label>
							<span class="text-selectable" id="the_image_source_url" style="margin-right:20px"></span>
							<span class="description"><?php _e('Read Only ! Image can be changed from "Source Tab"','thunderslider'); ?></span>
						</div>

						<div class="rs-img-source-size">
							
							<label><?php _e('Image Source Size:', 'thunderslider'); ?></label>
						...
						<div id="tp-bgimagesettings" class="bgsrcchanger-div" style="display:none;">
							<!-- ALT -->
							<div>
								<?php $alt_option = ThunderSliderFunctions::getVal($slideParams, 'alt_option', 'media_library'); ?>
								<label><?php _e("Alt:",'thunderslider'); ?></label>
								<select id="alt_option" name="alt_option">
									<option value="media_library" <?php selected($alt_option, 'media_library'); ?>><?php _e('From Media Library', 'thunderslider'); ?></option>
									<option value="file_name" <?php selected($alt_option, 'file_name'); ?>><?php _e('From Filename', 'thunderslider'); ?></option>
									<option value="custom" <?php selected($alt_option, 'custom'); ?>><?php _e('Custom', 'thunderslider'); ?></option>
								</select>
								<?php $alt_attr = ThunderSliderFunctions::getVal($slideParams, 'alt_attr', ''); ?>
							...
							<!-- TITLE -->
							<div>
								<?php $title_option = ThunderSliderFunctions::getVal($slideParams, 'title_option', 'media_library'); ?>
								<label><?php _e('Title:','thunderslider'); ?></label>
								<select id="title_option" name="title_option">
									<option value="media_library" <?php selected($title_option, 'media_library'); ?>><?php _e('From Media Library', 'thunderslider'); ?></option>
									<option value="file_name" <?php selected($title_option, 'file_name'); ?>><?php _e('From Filename', 'thunderslider'); ?></option>
									<option value="custom" <?php selected($title_option, 'custom'); ?>><?php _e('Custom', 'thunderslider'); ?></option>
								</select>
								<?php $title_attr = ThunderSliderFunctions::getVal($slideParams, 'title_attr', ''); ?>
						...
						<div id="video-settings" style="display: block;">
							<div>
								<label for="video_force_cover" class="video-label"><?php _e('Force Cover:', 'thunderslider'); ?></label>
							...
							<span id="video_dotted_overlay_wrap">
								...
								<select id="video_dotted_overlay" name="video_dotted_overlay" style="width:100px">
									<option <?php selected($video_dotted_overlay, 'none'); ?> value="none"><?php _e('none', 'thunderslider'); ?></option>
									<option <?php selected($video_dotted_overlay, 'twoxtwo'); ?> value="twoxtwo"><?php _e('2 x 2 Black', 'thunderslider'); ?></option>
									<option <?php selected($video_dotted_overlay, 'twoxtwowhite'); ?> value="twoxtwowhite"><?php _e('2 x 2 White', 'thunderslider'); ?></option>
									<option <?php selected($video_dotted_overlay, 'threexthree'); ?> value="threexthree"><?php _e('3 x 3 Black', 'thunderslider'); ?></option>
									<option <?php selected($video_dotted_overlay, 'threexthreewhite'); ?> value="threexthreewhite"><?php _e('3 x 3 White', 'thunderslider'); ?></option>
								</select>
								<div style="clear: both;"></div>
							</span>
							...
							<select id="video_ratio" name="video_ratio" style="width:100px">
								<option <?php selected($video_ratio, '16:9');?> value="16:9"><?php _e('16:9','thunderslider'); ?></option>
								<option <?php selected($video_ratio, '4:3');?> value="4:3"><?php _e('4:3','thunderslider'); ?></option>
							</select>
							<div style="clear: both;"></div>
							<div>
								<label for="video_ratio">
									<?php _e("Start At:", 'thunderslider'); ?>
								</label>				
								<input type="text" value="<?php echo $video_start_at; ?>" name="video_start_at"> <?php _e('For Example: 00:17', 'thunderslider'); ?>
								<div style="clear: both;"></div>
							</div>
							<div>
								<label for="video_ratio">
									<?php _e("End At:", 'thunderslider'); ?>
								</label>				
								<input type="text" value="<?php echo $video_end_at; ?>" name="video_end_at"> <?php _e('For Example: 02:17', 'thunderslider'); ?>
								<div style="clear: both;"></div>
							</div>
							<div>
								<label for="video_loop"><?php _e('Loop Video:', 'thunderslider'); ?></label>
								<select id="video_loop" name="video_loop" style="width: 200px;">
									<option <?php selected($video_loop, 'none');?> value="none"><?php _e('Disable', 'thunderslider'); ?></option>
									<option <?php selected($video_loop, 'loop');?> value="loop"><?php _e('Loop, Slide is paused', 'thunderslider'); ?></option>
									<option <?php selected($video_loop, 'loopandnoslidestop');?> value="loopandnoslidestop"><?php _e('Loop, Slide does not stop', 'thunderslider'); ?></option>
								</select>
							</div>
							
							<div>	
								<label for="video_nextslide"><?php _e('Next Slide On End:', 'thunderslider'); ?></label>
							...
							<div>
								<label for="video_force_rewind"><?php _e('Rewind at Slide Start:', 'thunderslider'); ?></label>
							...
							<div>	
								<label for="video_mute"><?php _e('Mute Video:', 'thunderslider'); ?></label>
							...
							<div class="vid-rev-vimeo-youtube video_volume_wrapper">
								<label for="video_volume"><?php _e('Video Volume:', 'thunderslider'); ?></label>
								<input type="text" id="video_volume" name="video_volume" value="<?php echo esc_attr($video_volume); ?>">
							</div>

							<span id="vid-rev-youtube-options">
								<div>
									<label for="video_speed"><?php _e('Video Speed:', 'thunderslider'); ?></label>
									<select id="video_speed" name="video_speed" style="width:75px">
										<option <?php selected($video_speed, '0.25');?> value="0.25"><?php _e('0.25', 'thunderslider'); ?></option>
										<option <?php selected($video_speed, '0.50');?> value="0.50"><?php _e('0.50', 'thunderslider'); ?></option>
										<option <?php selected($video_speed, '1');?> value="1"><?php _e('1', 'thunderslider'); ?></option>
										<option <?php selected($video_speed, '1.5');?> value="1.5"><?php _e('1.5', 'thunderslider'); ?></option>
										<option <?php selected($video_speed, '2');?> value="2"><?php _e('2', 'thunderslider'); ?></option>
									</select>
								</div>
								<div>
									<label><?php _e('Arguments YouTube:', 'thunderslider'); ?></label>
							...
							<div id="vid-rev-vimeo-options">
								<label><?php _e('Arguments Vimeo:', 'thunderslider'); ?></label>
						...
						<div id="bg-setting-wrap">
							<div id="bg-setting-bgfit-wrap">
								<label for="slide_bg_fit"><?php _e('Background Fit:', 'thunderslider'); ?></label>
							...
							<div id="bg-setting-bgpos-def-wrap">
								<div id="bg-setting-bgpos-wrap">
									<label for="slide_bg_position" id="bg-position-lbl"><?php _e('Background Position:', 'thunderslider'); ?></label>
							...
							<div id="bg-setting-bgrep-wrap">
								<label><?php _e("Background Repeat:",'thunderslider')?></label>
								<span>
					...
					<span id="mainbg-sub-parallax" style="display:none">
						<p>
							...
							if ($use_parallax=="off") {						
								...
								?>
								<label><?php _e("Parallax Level:",'thunderslider'); ?></label>
								<select name="slide_parallax_level" id="slide_parallax_level">
									<option value="-" <?php selected($slide_parallax_level, '-'); ?>><?php _e('No Parallax', 'thunderslider'); ?></option>
								...
								?>							
									<label><?php _e("Selected 3D Depth:",'thunderslider'); ?></label>
									<input style="min-width:54px;width:54px" type="text" disabled value="<?php echo $parallax_level[15];?>%" />							
									<span><i><?php _e('3D Parallax is Enabled via Slider Settings !', 'thunderslider'); ?></i></span>
								<?php
									} else {								
										?>
											<label><?php _e("Background 3D is Disabled",'thunderslider'); ?></label>									
											<span style="display: inline-block;vertical-align: middle;line-height:32px"><i><?php _e('To Enable 3D Parallax for Background please change the Option "BG 3D Disabled" to "OFF" via the Slider Settings !', 'thunderslider'); ?></i></span>
										<?php
									}
								}
							}
					...
					<span id="mainbg-sub-filters" style="display:none">
						<div style="display:none; margin-bottom: 10px;">																	
							<select id="media-filter-type" name="media-filter-type">
								<option value="none"><?php _e('No Filter', 'thunderslider'); ?></option>
						...
						<div id="inst-filter-grid">									
							<div data-type="none" class="filter_none inst-filter-griditem selected"><div class="ifgname"><?php _e('No Filter', 'thunderslider'); ?></div><div class="inst-filter-griditem-img none" style="visibility: inherit; opacity: 1;"></div><div class="inst-filter-griditem-img-noeff"></div></div>
					...
					<div id="mainbg-sub-kenburns" style="display:none; position:relative">
						<div>
							<label><?php _e('Ken Burns / Pan Zoom:', 'thunderslider'); ?></label>
						...
						<div id="kenburn_wrapper" <?php echo ($kenburn_effect == 'off') ? 'style="display: none;"' : ''; ?>>						
							<div id="ken_burn_example_wrapper">									
								<div id="kenburn-playpause-wrapper"><i class="eg-icon-play"></i><span><?php _e('PLAY', 'thunderslider'); ?></span></div><div id="kenburn-backtoidle"></div>
							...
							<p>
								<label><?php _e('Scale: (in %):', 'thunderslider'); ?></label>
								<label style="min-width:40px"><?php _e('From', 'thunderslider'); ?></label>
								...
								<label style="min-width:20px"><?php _e('To', 'thunderslider')?></label>
							...
							<p>
								<label><?php _e('Horizontal Offsets (+/-):', 'thunderslider')?></label>
								<label style="min-width:40px"><?php _e('From', 'thunderslider'); ?></label>							
							...
							<p>
								<label><?php _e('Vertical Offsets (+/-):', 'thunderslider')?></label>		
								<label style="min-width:40px"><?php _e('From', 'thunderslider'); ?></label>												
							...
							<p>
								<label><?php _e('Rotation:', 'thunderslider')?></label>		
								<label style="min-width:40px"><?php _e('From', 'thunderslider'); ?></label>												
							...
							<p>
								<label><?php _e('Blur Filter:', 'thunderslider')?></label>
								<label style="min-width:40px"><?php _e('From', 'thunderslider'); ?></label>							
							...
							<p>
								<label><?php _e('Easing:', 'thunderslider'); ?></label>
							...
							<p>
								<label><?php _e('Duration (in ms):', 'thunderslider')?></label>
				...
				<div id="slide-general-settings-content" style="<?php echo (!$slide->isStaticSlide()) ? ' display:none' : ''; ?>">
					...
					?>
						...
						<p style="display:none">
							<?php $title = esc_attr(stripslashes(ThunderSliderFunctions::getVal($slideParams, 'title','Slide'))); ?>
							<label><?php _e("Slide Title",'thunderslider'); ?></label>
							<input type="text" class="medium" id="title" disabled="disabled" name="title" value="<?php echo $title; ?>">
							<span class="description"><?php _e("The title of the slide, will be shown in the slides list.",'thunderslider'); ?></span>
						</p>

						<!-- SLIDE DELAY -->
						<p>
							<?php $delay = ThunderSliderFunctions::getVal($slideParams, 'delay',''); ?>
							<label><?php _e('Slide "Delay":','thunderslider'); ?></label>
							<input type="text" class="small-text" id="delay" name="delay" value="<?php echo intval($delay); ?>">
							<span class="description"><?php _e("A new delay value for the Slide. If no delay defined per slide, the delay defined via Options (9000ms) will be used.",'thunderslider'); ?></span>
						</p>

						<!-- SLIDE PAUSE ON PURPOSE -->
						<p>
							<?php $stoponpurpose = ThunderSliderFunctions::getVal($slideParams, 'stoponpurpose','published'); ?>
							<label><?php _e("Pause Slider:",'thunderslider'); ?></label>
							<select id="stoponpurpose" name="stoponpurpose">
								<option value="false"<?php selected($stoponpurpose, 'false'); ?>><?php _e("Default",'thunderslider'); ?></option>
								<option value="true"<?php selected($stoponpurpose, 'true'); ?>><?php _e("Stop Slider Progress",'thunderslider'); ?></option>						
							</select>
							<span class="description"><?php _e("Stop Slider Progress on this slider or use Slider Settings Defaults",'thunderslider'); ?></span>
						</p>


						<!-- SLIDE PAUSE ON PURPOSE -->
						<p>
							<?php $invisibleslide = ThunderSliderFunctions::getVal($slideParams, 'invisibleslide','published'); ?>
							<label><?php _e("Slide in Navigation (invisible):",'thunderslider'); ?></label>
							<select id="invisibleslide" name="invisibleslide">
								<option value="false"<?php selected($invisibleslide, 'false'); ?>><?php _e("Show Always",'thunderslider'); ?></option>
								<option value="true"<?php selected($invisibleslide, 'true'); ?>><?php _e("Only Via Actions",'thunderslider'); ?></option>						
							</select>
							<span class="description"><?php _e("Show Slide always or only on Action calls. Invisible slides are not available due Navigation Elements.",'thunderslider'); ?></span>
						</p>


						<!-- SLIDE STATE -->
						<p>
							<?php $state = ThunderSliderFunctions::getVal($slideParams, 'state','published'); ?>
							<label><?php _e("Slide State:",'thunderslider'); ?></label>
							<select id="state" name="state">
								<option value="published"<?php selected($state, 'published'); ?>><?php _e("Published",'thunderslider'); ?></option>
								<option value="unpublished"<?php selected($state, 'unpublished'); ?>><?php _e("Unpublished",'thunderslider'); ?></option>
							</select>
							<span class="description"><?php _e("The state of the slide. The unpublished slide will be excluded from the slider.",'thunderslider'); ?></span>
						</p>

						<!-- SLIDE HIDE AFTER LOOP -->
						<p>
							<?php $hideslideafter = ThunderSliderFunctions::getVal($slideParams, 'hideslideafter',0); ?>
							<label><?php _e('Hide Slide After Loop:','thunderslider'); ?></label>
							<input type="text" class="small-text" id="hideslideafter" name="hideslideafter" value="<?php echo $hideslideafter; ?>">
							<span class="description"><?php _e("After how many Loops should the Slide be hidden ? 0 = Slide is never hidden.",'thunderslider'); ?></span>
						</p>

						<!-- HIDE SLIDE ON MOBILE -->
						<p>
							<?php $hideslideonmobile = ThunderSliderFunctions::getVal($slideParams, 'hideslideonmobile', 'off'); ?>
							<label><?php _e('Hide Slide On Mobile:','thunderslider'); ?></label>
							...
							<span class="description"><?php _e("Show/Hide this Slide if Slider loaded on Mobile Device.",'thunderslider'); ?></span>
						</p>
						...
						if(isset($slider) && $slider->isInited()){
							...
							$useWpml = $slider->getParam("use_mcmsml","off");

							if($isWpmlExists && $useWpml == "on"){
								$arrLangs = ThunderSliderWpml::getArrLanguages();
								$curset_lang = ThunderSliderFunctions::getVal($slideParams, "lang","all");
								?>
								<p>
									<label><?php _e("Language",'thunderslider'); ?></label>
									<select name="lang">
										<?php
									...
									<span class="description"><?php _e("The language of the slide (uses MCMSML module).",'thunderslider'); ?></span>
								</p>
								<?php
							}
						}
						...
						<!-- SLIDE VISIBLE FROM -->
						<p>
							<?php $date_from = ThunderSliderFunctions::getVal($slideParams, 'date_from',''); ?>
							<label><?php _e("Visible from:",'thunderslider'); ?></label>
							<input type="text" class="inputDatePicker" id="date_from" name="date_from" value="<?php echo $date_from; ?>">
							<span class="description"><?php _e("If set, slide will be visible after the date is reached.",'thunderslider'); ?></span>
						</p>

						<!-- SLIDE VISIBLE UNTIL -->
						<p>
							<?php $date_to = ThunderSliderFunctions::getVal($slideParams, 'date_to',''); ?>
							<label><?php _e("Visible until:",'thunderslider'); ?></label>
							<input type="text" class="inputDatePicker" id="date_to" name="date_to" value="<?php echo $date_to; ?>">
							<span class="description"><?php _e("If set, slide will be visible till the date is reached.",'thunderslider'); ?></span>
						</p>

						
						<!-- SLIDE VISIBLE FROM -->
						<p style="display:none">
							<?php $save_performance = ThunderSliderFunctions::getVal($slideParams, 'save_performance','off'); ?>
							<label><?php _e("Save Performance:",'thunderslider'); ?></label>
							...
							<span class="description"><?php _e("Slide End Transition will first start when last Layer has been removed.",'thunderslider'); ?></span>
						</p>
					<?php
					} else {
					?>
						...
						<p>
							<?php $staticoverflow = ThunderSliderFunctions::getVal($slideParams, 'staticoverflow','published'); ?>
							<label><?php _e("Static Layers Overflow:",'thunderslider'); ?></label>
							<select id="staticoverflow" name="staticoverflow">
								<option value="visible"<?php selected($staticoverflow, 'visible'); ?>><?php _e("Visible",'thunderslider'); ?></option>
								<option value="hidden"<?php selected($staticoverflow, 'hidden'); ?>><?php _e("Hidden",'thunderslider'); ?></option>						
							</select>
							<span class="description"><?php _e("Set the Overflow of Static Layers to Visible or Hidden.",'thunderslider'); ?></span>
						</p>
						
						<!-- STATIC LAYER POSITION (FRONT/BACK) -->
						<p>
							<?php $staticlayersposition = ThunderSliderFunctions::getVal($slideParams, 'staticlayersposition','front'); ?>
							<label><?php _e("Static Layers Position:",'thunderslider'); ?></label>
							<select id="staticlayersposition" name="staticlayersposition">
								<option value="front"<?php selected($staticlayersposition, 'front'); ?>><?php _e("Front",'thunderslider'); ?></option>
								<option value="back"<?php selected($staticlayersposition, 'back'); ?>><?php _e("Back",'thunderslider'); ?></option>						
							</select>
							<span class="description"><?php _e("Choose if Static Layers should appear above or behind Slide content (<a href='https://www.jiiworks.net/thunderslider-doc/main-background/?tab=transparentcolor' target='_blank'>transparent bg's required</a>)",'thunderslider'); ?></span>
						</p>
			...
			if(!$slide->isStaticSlide()){
				...
				<div id="slide-thumbnail-settings-content" style="display:none">
					...
					<div style="margin-top:10px">
						<?php $slide_thumb = ThunderSliderFunctions::getVal($slideParams, 'slide_thumb',''); ?>
						<span style="display:inline-block; vertical-align: top;">
							<label><?php _e("Thumbnail:",'thunderslider'); ?></label>
						</span>
						<div style="display:inline-block; vertical-align: top;">
							<div id="slide_thumb_button_preview" class="setting-image-preview"><?php
							if(intval($slide_thumb) > 0){
								?>
								<div style="width:100px;height:70px;background:url('<?php echo admin_url( 'admin-ajax.php' ); ?>?action=thunderslider_show_image&amp;img=<?php echo $slide_thumb; ?>&amp;w=100&amp;h=70&amp;t=exact'); background-position:center center; background-size:cover;"></div>
								<?php
							}elseif($slide_thumb !== ''){
								?>
							...
							<span class="description"><?php _e("Slide Thumbnail. If not set - it will be taken from the slide image.",'thunderslider'); ?></span>
						</div>
					</div>
					<?php $thumb_dimension = ThunderSliderFunctions::getVal($slideParams, 'thumb_dimension', 'slider'); ?>
					<?php $thumb_for_admin = ThunderSliderFunctions::getVal($slideParams, 'thumb_for_admin', 'off'); ?>

					<p>
						<span style="display:inline-block; vertical-align: top;">
							<label><?php _e("Thumbnail Dimensions:",'thunderslider'); ?></label>
						</span>
						<select name="thumb_dimension">
							<option value="slider" <?php selected($thumb_dimension, 'slider'); ?>><?php _e('From Slider Settings', 'thunderslider'); ?></option>
							<option value="orig" <?php selected($thumb_dimension, 'orig'); ?>><?php _e('Original Size', 'thunderslider'); ?></option>
						</select>
						<span class="description"><?php _e("Width and height of thumbnails can be changed in the Slider Settings -> Navigation -> Thumbs tab.",'thunderslider'); ?></span>
					</p>

					<p style="display:none;" class="show_on_thumbnail_exist">
						<span style="display:inline-block; vertical-align: top;">
							<label><?php _e("Thumbnail Admin Purpose:",'thunderslider'); ?></label>
						</span>
						<span style="display:inline-block; width:200px; margin-right:20px;line-height:27px">
						...
						<span class="description"><?php _e("Use the Thumbnail also for Admin purposes. This will use the selected Thumbnail to represent the Slide in all Slider Admin area.",'thunderslider'); ?></span>
					</p>
				</div>
				...
				<div id="slide-animation-settings-content" style="display:none">
					...
					<div id="slide_transition_row">
						<?php
							$slide_transition = ThunderSliderFunctions::getVal($slideParams, 'slide_transition',$def_transition);
						...
						?>
						<?php $slot_amount = (array) ThunderSliderFunctions::getVal($slideParams, 'slot_amount','default'); ?>
						<?php $transition_rotation = (array) ThunderSliderFunctions::getVal($slideParams, 'transition_rotation','0'); ?>
						<?php $transition_duration = (array) ThunderSliderFunctions::getVal($slideParams, 'transition_duration',$def_transition_duration); ?>
						<?php $transition_ease_in = (array) ThunderSliderFunctions::getVal($slideParams, 'transition_ease_in','default'); ?>
						<?php $transition_ease_out = (array) ThunderSliderFunctions::getVal($slideParams, 'transition_ease_out','default'); ?>
						<script type="text/javascript">
						...
						<div id="slide_transition"  multiple="" size="1" style="z-index: 100;">
							...
							<div class="slide-trans-cur-selected">
								<p><?php _e("Used Transitions (Order in Loops)",'thunderslider'); ?></p>
							...
							<div class="slide-trans-cur-selected-settings">
								...
								<label><?php _e("Slot / Box Amount:",'thunderslider'); ?></label>
								...
								<span class="description"><?php _e("# of slots/boxes the slide is divided into or divided by.",'thunderslider'); ?></span>					
								<span class="tp-clearfix"></span>
								
								<!-- ROTATION -->
								
								<label><?php _e("Slot Rotation:",'thunderslider'); ?></label>
								...
								<span class="tp-clearfix"></span>
								<span class="description"><?php _e("Start Rotation of Transition (deg).",'thunderslider'); ?></span>
								<span class="tp-clearfix"></span>

								<!-- DURATION -->
								
								<label><?php _e("Animation Duration:",'thunderslider'); ?></label>
								...
								<span class="tp-clearfix"></span>
								<span class="description"><?php _e("The duration of the transition.",'thunderslider'); ?></span>
								<span class="tp-clearfix"></span>

								<!-- IN EASE -->
								
								<label><?php _e("Easing In:",'thunderslider'); ?></label>
								...
								<span class="tp-clearfix"></span>
								<span class="description"><?php _e("The easing of Appearing transition.",'thunderslider'); ?></span>
								<span class="tp-clearfix"></span>

								<!-- OUT EASE -->
								
								<label><?php _e("Easing Out:",'thunderslider'); ?></label>
								...
								<span class="tp-clearfix"></span>
								<span class="description"><?php _e("The easing of Disappearing transition.",'thunderslider'); ?></span>
				...
				<div id="slide-nav-settings-content" style="display:none">		
					<ul class="rs-layer-nav-settings-tabs" style="display:inline-block; ">
						<li id="custom-nav-arrows-tab-selector" data-content="arrows" class="selected"><?php _e('Arrows', 'thunderslider'); ?></li>
						<li id="custom-nav-bullets-tab-selector" data-content="bullets"><?php _e('Bullets', 'thunderslider'); ?></li>					
						<li id="custom-nav-tabs-tab-selector" data-content="tabs"><?php _e('Tabs', 'thunderslider'); ?></li>
						<li id="custom-nav-thumbs-tab-selector" data-content="thumbs"><?php _e('Thumbnails', 'thunderslider'); ?></li>
					</ul>
									...
									if(isset($nav['settings']) && isset($nav['settings']['placeholders'])){
										foreach($nav['settings']['placeholders'] as $placeholder){
											...
											foreach($placeholder['data'] as $k => $d){
												$get_from = ThunderSliderFunctions::getVal($slideParams, 'ph-'.$ph_arr_type.'-'.$pht.'-'.$placeholder['handle'].'-'.$k.'-slide', 'off');
												if($get_from == 'on'){ //get from Slide
													$ph_vals[$k] = stripslashes(ThunderSliderFunctions::getVal($slideParams, 'ph-'.$ph_arr_type.'-'.$pht.'-'.$placeholder['handle'].'-'.$k, $d));											
											...
											<?php if ($placeholder['nav-type'] === $pht) { ?>
												...
												switch($placeholder['type']){
													case 'color':
														$get_from = ThunderSliderFunctions::getVal($slideParams, 'ph-'.$ph_arr_type.'-'.$pht.'-'.$placeholder['handle'].'-color-slide', 'off');
														?>
													...
													case 'color-rgba':
														$get_from = ThunderSliderFunctions::getVal($slideParams, 'ph-'.$ph_arr_type.'-'.$pht.'-'.$placeholder['handle'].'-color-rgba-slide', 'off');
														?>
														<label><?php echo $placeholder['title']; ?></label>
													...
													break;
													case 'font-family':
														$get_from_font_family = ThunderSliderFunctions::getVal($slideParams, 'ph-'.$ph_arr_type.'-'.$pht.'-'.$placeholder['handle'].'-font_family-slide', 'off');
														?>
														<label><?php echo $placeholder['title']; ?></label>
													...
													break;
													case 'custom':
														$get_from_custom = ThunderSliderFunctions::getVal($slideParams, 'ph-'.$ph_arr_type.'-'.$pht.'-'.$placeholder['handle'].'-custom-slide', 'off');
														?>
														<label><?php echo $placeholder['title']; ?></label>
					...
					<p style="margin-top:25px"><i><?php _e("The Custom Settings are always depending on the current selected Navigation Elements in Slider Settings, and will only be active on the current Slide.",'thunderslider'); ?></i></p>
					<script type="text/javascript">
						jQuery(document).ready(function() {
			...
			<div id="slide-addon-wrapper" style="margin:-15px; display:none">
				<div id="rs-addon-wrapper-button-row">
					<span class="rs-layer-toolbar-box" style="padding:5px 20px"><?php _e('Select Add-on', 'thunderslider'); ?></span>
					<?php
			...
			if(!$slide->isStaticSlide()){
				...
				<div id="slide-info-settings-content" style="display:none">
					<ul>
						...
						for($i=1;$i<=10;$i++){
							?>
							<li>
								<label><?php _e('Parameter', 'thunderslider'); echo ' '.$i; ?></label> <input type="text" name="params_<?php echo $i; ?>" value="<?php echo stripslashes(esc_attr(ThunderSliderFunctions::getVal($slideParams, 'params_'.$i,''))); ?>">
								<?php _e('Max. Chars', 'thunderslider'); ?> <input type="text" style="width: 50px; min-width: 50px;" name="params_<?php echo $i; ?>_chars" value="<?php echo esc_attr(ThunderSliderFunctions::getVal($slideParams, 'params_'.$i.'_chars',10, ThunderSlider::FORCE_NUMERIC)); ?>">
					...
					<!-- BASIC DESCRIPTION -->
					<p>
						<?php $slide_description = stripslashes(ThunderSliderFunctions::getVal($slideParams, 'slide_description', '')); ?>
						<label><?php _e("Description of Slider:",'thunderslider'); ?></label>

						<textarea name="slide_description" style="height: 425px; width: 100%"><?php echo $slide_description; ?></textarea>
						<span class="description"><?php _e('Define a description here to show at the navigation if enabled in Slider Settings','thunderslider'); ?></span>
					</p>
				</div>
				...
				<div id="slide-seo-settings-content" style="display:none">
					<!-- CLASS -->
					<p>
						<?php $class_attr = ThunderSliderFunctions::getVal($slideParams, 'class_attr',''); ?>
						<label><?php _e("Class:",'thunderslider'); ?></label>
						<input type="text" class="" id="class_attr" name="class_attr" value="<?php echo $class_attr; ?>">
						<span class="description"><?php _e('Adds a unique class to the li of the Slide like class="rev_special_class" (add only the classnames, seperated by space)','thunderslider'); ?></span>
					</p>

					<!-- ID -->
					<p>
						<?php $id_attr = ThunderSliderFunctions::getVal($slideParams, 'id_attr',''); ?>
						<label><?php _e("ID:",'thunderslider'); ?></label>
						<input type="text" class="" id="id_attr" name="id_attr" value="<?php echo $id_attr; ?>">
						<span class="description"><?php _e('Adds a unique ID to the li of the Slide like id="rev_special_id" (add only the id)','thunderslider'); ?></span>
					</p>

					<!-- CUSTOM FIELDS -->
					<p>
						<?php $data_attr = stripslashes(ThunderSliderFunctions::getVal($slideParams, 'data_attr','')); ?>
						<label><?php _e("Custom Fields:",'thunderslider'); ?></label>
						<textarea id="data_attr" name="data_attr"><?php echo $data_attr; ?></textarea>
						<span class="description"><?php _e('Add as many attributes as you wish here. (i.e.: data-layer="firstlayer" data-custom="somevalue").','thunderslider'); ?></span>
					</p>

					<!-- Enable Link -->
					<p>
						<?php $enable_link = ThunderSliderFunctions::getVal($slideParams, 'enable_link','false'); ?>
						<label><?php _e("Enable Link:",'thunderslider'); ?></label>
						<select id="enable_link" name="enable_link">
							<option value="true"<?php selected($enable_link, 'true'); ?>><?php _e("Enable",'thunderslider'); ?></option>
							<option value="false"<?php selected($enable_link, 'false'); ?>><?php _e("Disable",'thunderslider'); ?></option>
						</select>
						<span class="description"><?php _e('Link the Full Slide to an URL or Action.','thunderslider'); ?></span>
					</p>
					
					<div class="rs-slide-link-setting-wrapper">
						<!-- Link Type -->
						<p>
							<?php $enable_link = ThunderSliderFunctions::getVal($slideParams, 'link_type','regular'); ?>
							<label><?php _e("Link Type:",'thunderslider'); ?></label>
							<span style="display:inline-block; width:200px; margin-right:20px;">
								<input type="radio" id="link_type_1" value="regular" name="link_type"<?php checked($enable_link, 'regular'); ?>><span style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('Regular','thunderslider'); ?></span>
								<input type="radio" id="link_type_2" value="slide" name="link_type"<?php checked($enable_link, 'slide'); ?>><span style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('To Slide','thunderslider'); ?></span>
							</span>
							<span class="description"><?php _e('Regular - Link to URL,  To Slide - Call a Slide Action','thunderslider'); ?></span>
						</p>

						<div class="rs-regular-link-setting-wrap">
							<!-- SLIDE LINK -->
							<p>
								<?php $val_link = ThunderSliderFunctions::getVal($slideParams, 'link',''); ?>
								<label><?php _e("Slide Link:",'thunderslider'); ?></label>
								<input type="text" id="rev_link" name="link" value="<?php echo $val_link; ?>">
								<span class="description"><?php _e('A link on the whole slide pic (use {{link}} or {{meta:somemegatag}} in template sliders to link to a post or some other meta)','thunderslider'); ?></span>
							</p>
						
							<!-- LINK TARGET -->
							<p>
								<?php $link_open_in = ThunderSliderFunctions::getVal($slideParams, 'link_open_in','same'); ?>
								<label><?php _e("Link Target:",'thunderslider'); ?></label>
								<select id="link_open_in" name="link_open_in">
									<option value="same"<?php selected($link_open_in, 'same'); ?>><?php _e('Same Window','thunderslider'); ?></option>
									<option value="new"<?php selected($link_open_in, 'new'); ?>><?php _e('New Window','thunderslider'); ?></option>
								</select>
								<span class="description"><?php _e('The target of the slide link.','thunderslider'); ?></span>
							</p>
						</div>
						<!-- LINK TO SLIDE -->
						<p class="rs-slide-to-slide">
							<?php $slide_link = ThunderSliderFunctions::getVal($slideParams, 'slide_link','nothing');
							//num_slide_link
							$arrSlideLink = array();
							$arrSlideLink["nothing"] = __("-- Not Chosen --",'thunderslider');
							$arrSlideLink["next"] = __("-- Next Slide --",'thunderslider');
							$arrSlideLink["prev"] = __("-- Previous Slide --",'thunderslider');

							$arrSlideLinkLayers = $arrSlideLink;
							$arrSlideLinkLayers["scroll_under"] = __("-- Scroll Below Slider --",'thunderslider');
							$arrSlideNames = array();
							if(isset($slider) && $slider->isInited())
							...
							?>
							<label><?php _e("Link To Slide:",'thunderslider'); ?></label>
							...
							<span class="description"><?php _e('Call Slide Action','thunderslider'); ?></span>
						</p>
						<!-- Link POSITION -->
						<p>
							<?php $link_pos = ThunderSliderFunctions::getVal($slideParams, 'link_pos','front'); ?>
							<label><?php _e("Link Sensibility:",'thunderslider'); ?></label>
							<span style="display:inline-block; width:200px; margin-right:20px;">
								<input type="radio" id="link_pos_1" value="front" name="link_pos"<?php checked($link_pos, 'front'); ?>><span style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('Front','thunderslider'); ?></span>
								<input type="radio" id="link_pos_2" value="back" name="link_pos"<?php checked($link_pos, 'back'); ?>><span style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('Back','thunderslider'); ?></span>
							</span>
							<span class="description"><?php _e('The z-index position of the link related to layers','thunderslider'); ?></span>
						</p>
					</div>
				</div>
			<?php
...
<script type="text/javascript">
	var rs_module_url = '<?php echo RS_PLUGIN_URL; ?>';
