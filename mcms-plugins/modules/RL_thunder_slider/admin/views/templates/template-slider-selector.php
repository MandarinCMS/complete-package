	...
	<div id="template_header_part">
		...
		<div class="revolution-template-switcher">		
			<span id="template_filter_buttons_wrapper" style="display:table-cell;vertical-align:top">	
				...
				<span  style="display:none" id="leave_selected_template_package"><?php _e('Back', 'thunderslider'); ?></span>
				<span class="template_filter_button selected" data-type="temp_all"><?php _e('All Templates', 'thunderslider'); ?></span>
				<span class="template_filter_button" data-type="template_free"><?php _e('Free Templates', 'thunderslider'); ?></span>
				<span class="template_filter_button" data-type="template_premium"><?php _e('Premium Templates', 'thunderslider'); ?></span>
				<span class="template_filter_button" data-type="template_package_parent"><?php _e('Packages', 'thunderslider'); ?></span>
				...
				<span class="template_filter_button" data-type="temp_notinstalled"><?php _e('Not Installed', 'thunderslider'); ?></span>
				<span class="template_filter_button" data-type="temp_socialmedia"><?php _e('Social Media', 'thunderslider'); ?></span>
				<span class="template_filter_button" data-type="temp_postbased"><?php _e('Post-Based', 'thunderslider'); ?></span>
				<span class="template_filter_button temp_new_udpated" data-type="temp_newupdate"><?php _e('New / Updated', 'thunderslider'); ?></span>			
			</span>
			...
			function callTemplateSlider() {
				...
				if (recalls_amount>5000) {
					...
					if (jQuery('#template_area').length>0) {
						...
						ThunderSliderAdmin.load_slider_template_html();
...
<div id="dialog_import_template_slider" title="<?php _e("Import Template Slider",'thunderslider'); ?>" class="dialog_import_template_slider" style="display:none">
	<form id="form-import-online-slider-local" action="<?php echo ThunderSliderBase::$url_ajax; ?>" enctype="multipart/form-data" method="post">
		...
		<span style="margin-top:45px;display:block"><input type="submit" class="rs-import-slider-button button-primary revblue tp-be-button" value="<?php _e("Import Template Slider",'thunderslider'); ?>"></span>
		<span class="tp-clearfix"></span>
		<span style="font-weight: 700;"><?php _e("Note: style templates will be updated if they exist!",'thunderslider'); ?></span>
...
<div id="dialog_import_template_slider_from" title="<?php _e("Import Template Slider",'thunderslider'); ?>" class="dialog_import_template_slider_from" style="display:none">
	<?php _e('Import Slider from local or from MandarinCMS server?', 'thunderslider'); ?>
	<form action="<?php echo ThunderSliderBase::$url_ajax; ?>" enctype="multipart/form-data" method="post" name="rs-import-template-from-server" id="rs-import-template-from-server">
		<input type="hidden" name="action" value="thunderslider_ajax_action">
...
<div id="dialog_import_template_slider_info" title="<?php _e('Importing Status','thunderslider'); ?>" class="dialog_import_template_slider_info" style="display:none">
...
<div id="dialog_import_template_slider_page_template" title="<?php _e("Create Blank Page",'thunderslider'); ?>" class="dialog_import_template_slider_page_template" style="display:none">
	<?php
	_e('Create a Blank Demo Page with this Slider added to it?', 'thunderslider');
	?>
</div>