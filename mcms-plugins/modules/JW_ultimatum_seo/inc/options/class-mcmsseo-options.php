...
class MCMSSEO_Options {
	...
	public static $options = array(
		'mcmsseo'               => 'MCMSSEO_Option_Wpseo',
		'mcmsseo_permalinks'    => 'MCMSSEO_Option_Permalinks',
		'mcmsseo_titles'        => 'MCMSSEO_Option_Titles',
		'mcmsseo_social'        => 'MCMSSEO_Option_Social',
		'mcmsseo_rss'           => 'MCMSSEO_Option_RSS',
		'mcmsseo_internallinks' => 'MCMSSEO_Option_InternalLinks',
		'mcmsseo_xml'           => 'MCMSSEO_Option_XML',
		'mcmsseo_ms'            => 'MCMSSEO_Option_MS',
		'mcmsseo_taxonomy_meta' => 'MCMSSEO_Taxonomy_Meta',
	);
	...
	/**
	 * Instantiate all the MCMSSEO option management classes
	 */
	...
	public static function get_option_names() {
		...
		if ( $option_names === array() ) {
			...
			$option_names = apply_filters( 'mcmsseo_options', $option_names );
		}
	...
	/**
	 * Retrieve one or more options for the SEO module.
	 *
	 * @static
	 *
	...
	/**
	 * Retrieve a single option for the SEO module.
	 *
	 * @static
	 *
	...
	public static function clean_up( $option_name = null, $current_version = null ) {
		...
		elseif ( isset( $option_name ) && is_array( $option_name ) && $option_name !== array() ) {
			...
			delete_option( 'mcmsseo_indexation' );
		}
	}
	...
	public static function bring_back_breadcrumb_defaults() {
		if ( isset( self::$option_instances['mcmsseo_internallinks'] ) ) {
			self::$option_instances['mcmsseo_internallinks']->bring_back_defaults();
		}
	}
	...
	public static function initialize() {
		/* Force WooMySkins to use Ultimatum SEO data. */
	 ...
	 * specified default blog if one was chosen on the network page or the module defaults if it was not
	 *
	 * @static
	 *
		...
		if ( is_multisite() ) {
			...
			if ( is_array( $option_names ) && $option_names !== array() ) {
				...
				foreach ( $option_names as $option_name ) {
					...
					/* Remove sensitive, myskin dependent and site dependent info */
	 ...
	 *
	 * @param string $mcmsseo_options_group_name The name for the mcmsseo option group in the database.
	 ...
	 */
	public static function save_option( $mcmsseo_options_group_name, $option_name, $option_value ) {
		$options                           = MCMSSEO_Options::get_option( $mcmsseo_options_group_name );
		$options[ $option_name ] = $option_value;
		update_option( $mcmsseo_options_group_name, $options );

		// Check if everything got saved properly.
		$saved_option = self::get_option( $mcmsseo_options_group_name );
	...
	public static function grant_access() {
		_deprecated_function( __METHOD__, 'MCMSSEO 1.5.6.1', 'MCMSSEO_Utils::grant_access()' );
	...
	public static function clear_cache() {
		_deprecated_function( __METHOD__, 'MCMSSEO 1.5.6.1', 'MCMSSEO_Utils::clear_cache()' );
	 ...
	 *
	 * @deprecated 1.5.6.1
	 * @deprecated use MCMSSEO_Utils::flush_w3tc_cache()
	 * @see        MCMSSEO_Utils::flush_w3tc_cache()
	 */
	public static function flush_w3tc_cache() {
		_deprecated_function( __METHOD__, 'MCMSSEO 1.5.6.1', 'MCMSSEO_Utils::flush_w3tc_cache()' );
		MCMSSEO_Utils::flush_w3tc_cache();
	}
	...
	public static function clear_rewrites() {
		_deprecated_function( __METHOD__, 'MCMSSEO 1.5.6.1', 'MCMSSEO_Utils::clear_rewrites()' );
