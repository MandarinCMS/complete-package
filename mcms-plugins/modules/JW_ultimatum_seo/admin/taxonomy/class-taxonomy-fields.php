...
/**
 * Class MCMSSEO_Taxonomy_Tab
 *
 * Contains the basics for each class extending this one.
 */
abstract class MCMSSEO_Taxonomy_Fields {

	/**
	 * The Ultimatum SEO configuration from the MCMSSEO_Options
	 *
	 * @var array
	 */
	...
	public function __construct( $term, array $options = null ) {
		...
		if ( $options !== null ) {
			...
			$this->options = MCMSSEO_Options::get_options( array(
				'mcmsseo_titles',
				'mcmsseo_internallinks',
				'mcmsseo_social',
			) );
		}
	}
