...
/**
 * Handles all things with the metabox in combination with the MandarinCMS editor.
 */
class MCMSSEO_Metabox_Editor {

	/**
	 * Registers hooks to MandarinCMS
	 */
	 ...
	 *
	 * @param string $css_files The CSS files that MandarinCMS wants to load inside the editor.
	 * @return string The CSS files MandarinCMS wants to load and our CSS file.
	 */
	public function add_css_inside_editor( $css_files ) {
		...
		/** @var MCMSSEO_Admin_Asset $inside_editor */
		$inside_editor = $styles['inside-editor'];

		$url = $inside_editor->get_url( MCMSSEO_Admin_Asset::TYPE_CSS, MCMSSEO_FILE );
	 ...
	 *
	 * @param array $tinymce_config The tinyMCE config as configured by MandarinCMS.
	 *
