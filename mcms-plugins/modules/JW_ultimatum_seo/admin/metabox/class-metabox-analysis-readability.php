 ...
 */
class MCMSSEO_Metabox_Analysis_Readability implements MCMSSEO_Metabox_Analysis {
	...
	public function is_user_enabled() {
		return ! get_the_author_meta( 'mcmsseo_content_analysis_disable', get_current_user_id() );
	}
