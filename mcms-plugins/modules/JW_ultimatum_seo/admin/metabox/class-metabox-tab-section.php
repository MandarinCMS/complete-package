 ...
 */
class MCMSSEO_Metabox_Tab_Section implements MCMSSEO_Metabox_Section {

	/**
	 * @var MCMSSEO_Metabox_Tab[]
	 */
	public $tabs = array();
	 ...
	 * @param array  $tabs         The metabox tabs (`MCMSSEO_Metabox_Tabs[]`) to be included in the section.
	...
	public function display_link() {
		if ( $this->has_tabs() ) {
			printf(
				'<li><a href="#mcmsseo-meta-section-%1$s" class="mcmsseo-meta-section-link %2$s"%3$s%4$s>%5$s</a></li>',
				esc_attr( $this->name ),
	...
	public function display_content() {
		if ( $this->has_tabs() ) {
			$html = '<div id="mcmsseo-meta-section-%1$s" class="mcmsseo-meta-section">';
			$html .= '<div class="mcmsseo-metabox-tabs-div">';
			$html .= '<ul class="mcmsseo-metabox-tabs mcmsseo-metabox-tab-%1$s">%2$s</ul>%3$s';
			$html .= '</div></div>';
	...
	/**
	 * Add a `MCMSSEO_Metabox_Tab` object to the tabs.
	 *
	 * @param MCMSSEO_Metabox_Tab $tab Tab to add.
	 */
	public function add_tab( MCMSSEO_Metabox_Tab $tab ) {
		$this->tabs[] = $tab;
	}
