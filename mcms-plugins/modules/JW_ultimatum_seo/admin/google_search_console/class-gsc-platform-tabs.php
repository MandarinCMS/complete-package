...
/**
 * Class MCMSSEO_GSC_Platform_Tabs
 */
class MCMSSEO_GSC_Platform_Tabs {
	...
	private function platform_tabs() {
		$tabs = array( 'settings' => __( 'Settings', 'mandarincms-seo' ) );

		$platforms = array(
			'web'             => __( 'Desktop', 'mandarincms-seo' ),
			'smartphone_only' => __( 'Smartphone', 'mandarincms-seo' ),
			'mobile'          => __( 'Feature phone', 'mandarincms-seo' ),
		);
		...
		$admin_link = admin_url( 'admin.php?page=mcmsseo_search_console&tab=' );
