...
/**
 * Abstract object for handling the importing and deactivating of the module
 */
abstract class MCMSSEO_Import_Hooks {
	...
	/**
	 * Handle deactivation of the module
	 *
	 * @since 3.0
	 */
	public function show_deactivate_message() {
		if ( filter_input( INPUT_GET, $this->deactivation_listener ) === '1' ) {
			// Deactivate AIO.
			deactivate_modules( $this->module_file );
	...
	protected function is_active() {
		return is_module_active( $this->module_file );
	}
}
