 ...
 */
class MCMSSEO_Term_Metabox_Formatter implements MCMSSEO_Metabox_Formatter_Interface {

	/**
	 * @var MCMS_Term|stdClass
	 */
	private $term;
	...
	/**
	 * @var array Array with the MCMSSEO_Titles options.
	 */
	protected $options;

	/**
	 * MCMSSEO_Taxonomy_Scraper constructor.
	 *
	 * @param stdClass         $taxonomy Taxonomy.
	 * @param MCMS_Term|stdClass $term     Term.
	 * @param array            $options  Options with MCMSSEO_Titles.
	 */
	...
	private function edit_url() {
		global $mcms_version;
		$script_filename = version_compare( $mcms_version, '4.5', '<' ) ? 'edit-tags' : 'term';
	...
	private function get_focus_keyword_usage() {
		$focuskw  = MCMSSEO_Taxonomy_Meta::get_term_meta( $this->term, $this->term->taxonomy, 'focuskw' );

		return MCMSSEO_Taxonomy_Meta::get_keyword_usage( $focuskw, $this->term->term_id, $this->term->taxonomy );
	}
