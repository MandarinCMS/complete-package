 ...
 */
class MCMSSEO_Post_Metabox_Formatter implements MCMSSEO_Metabox_Formatter_Interface {
	 ...
	 * Constructor.
	 *
	 * @param MCMS_Post|array $post      Post object.
	...
	public function get_values() {
		...
		if ( $this->post instanceof MCMS_Post ) {
			$values_to_set = array(
	...
	private function get_focus_keyword_usage() {
		$keyword = MCMSSEO_Meta::get_value( 'focuskw', $this->post->ID );

		return array(
			$keyword => MCMSSEO_Meta::keyword_usage( $keyword, $this->post->ID ),
		);
	}
