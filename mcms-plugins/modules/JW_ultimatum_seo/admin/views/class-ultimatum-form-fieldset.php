 ...
 */
class Ultimatum_Form_Fieldset implements Ultimatum_Form_Element {
	...
	public function render_view() {
		...
		require( dirname( MCMSSEO_FILE ) . '/admin/views/form/fieldset.php' );
	}
	...
	public function add_attributes( $attributes ) {
		$this->attributes = mcms_parse_args( $attributes, $this->attributes );
	}
	...
	public function legend_add_attributes( $attributes ) {
		$this->legend_attributes = mcms_parse_args( $attributes, $this->legend_attributes );
	}
	...
	public function legend_hide() {
		$this->legend_attributes = mcms_parse_args(
