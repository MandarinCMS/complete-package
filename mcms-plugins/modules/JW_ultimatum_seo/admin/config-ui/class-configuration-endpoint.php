...
/**
 * Class MCMSSEO_Configuration_Endpoint
 */
class MCMSSEO_Configuration_Endpoint {

	const REST_NAMESPACE = 'ultimatum/v1';
	...
	/** @var MCMSSEO_Configuration_Service Service to use */
	protected $service;

	/**
	 * Sets the service to use.
	 *
	 * @param MCMSSEO_Configuration_Service $service Service to use.
	 */
	public function set_service( MCMSSEO_Configuration_Service $service ) {
