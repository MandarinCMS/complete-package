 ...
 */
class MCMSSEO_Admin_Stop_Words {
	/**
	...
	public function list_stop_words() {
		 ...
		 */
		$stopwords = apply_filters( 'mcmsseo_stopwords', $stopwords );
