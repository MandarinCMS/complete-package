...
class MCMSSEO_Recalculate_Scores {
	...
	public function modal_box() {
		...
		$progress = sprintf(
			...
			__( '%1$s of %2$s done.', 'mandarincms-seo' ),
			'<span id="mcmsseo_count">0</span>',
			'<strong id="mcmsseo_count_total">0</strong>'
		);

		?>
		<div id="mcmsseo_recalculate" class="hidden">
			<p><?php esc_html_e( 'Recalculating SEO scores for all pieces of content with a focus keyword.', 'mandarincms-seo' ); ?></p>

			<div id="mcmsseo_progressbar"></div>
