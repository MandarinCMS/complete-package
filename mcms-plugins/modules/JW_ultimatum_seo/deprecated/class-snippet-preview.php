...
class MCMSSEO_Snippet_Preview {
	...
	public function __construct( $post, $title, $description ) {
		_deprecated_constructor( 'MCMSSEO_Snippet_Preview', 'MCMSSEO 3.0' );
	}
	...
	public function get_content() {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::get_content', 'MCMSSEO 3.0', 'javascript' );
		return $this->content;
	}
	...
	protected function set_date() {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::set_date', 'MCMSSEO 3.0', 'javascript' );
	}
	...
	protected function get_post_date() {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::get_post_date', 'MCMSSEO 3.0', 'javascript' );
		return '';
	}
	...
	protected function set_url() {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::set_url', 'MCMSSEO 3.0', 'javascript' );
	}
	...
	protected function set_slug() {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::set_slug', 'MCMSSEO 3.0', 'javascript' );
	}
	...
	protected function set_content() {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::set_content', 'MCMSSEO 3.0', 'javascript' );
	}
	...
	protected function set_content_through_filter( $content ) {
		_deprecated_function( 'MCMSSEO_Snippet_Preview::set_content_through_filter', 'MCMSSEO 3.0', 'javascript' );
	}
}
