 ...
 */
class Ultimatum_TextStatistics {
	/**
	...
	public function __construct( $strEncoding = '' ) {
		_deprecated_constructor( 'Ultimatum_TextStatistics', 'MCMSSEO 3.0' );
	}
	...
	public function flesch_kincaid_reading_ease( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::flesch_kincaid_reading_ease', 'MCMSSEO 3.0' );
	...
	public function text_length( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::text_length', 'MCMSSEO 3.0' );
	...
	public function letter_count( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::letter_count', 'MCMSSEO 3.0' );
	...
	protected function clean_text( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::clean_text', 'MCMSSEO 3.0' );
	...
	protected function lower_case( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::lower_case', 'MCMSSEO 3.0' );
	...
	protected function upper_case( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::upper_case', 'MCMSSEO 3.0' );
	...
	public function sentence_count( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::sentence_count', 'MCMSSEO 3.0' );
	...
	public function word_count( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::word_count', 'MCMSSEO 3.0' );
	...
	public function average_words_per_sentence( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::average_words_per_sentence', 'MCMSSEO 3.0' );
	...
	public function average_syllables_per_word( $strText ) {
		_deprecated_function( 'Ultimatum_TextStatistics::average_syllables_per_word', 'MCMSSEO 3.0' );
	...
	public function syllable_count( $strWord ) {
		_deprecated_function( 'Ultimatum_TextStatistics::syllable_count', 'MCMSSEO 3.0' );
	...
	public function normalize_score( $score, $min, $max, $dps = 1 ) {
		_deprecated_function( 'Ultimatum_TextStatistics::normalize_score', 'MCMSSEO 3.0' );
