...
/**
 * Class MCMSSEO_Redirect_File
 */
abstract class MCMSSEO_Redirect_File_Exporter implements MCMSSEO_Redirect_Exporter {
	...
	protected function get_format( $redirect_format ) {
		if ( $redirect_format === MCMSSEO_Redirect::FORMAT_PLAIN ) {
	...
	protected function save( $file_content ) {
		...
		if ( is_writable( MCMSSEO_Redirect_File_Util::get_file_path() ) ) {
			MCMSSEO_Redirect_File_Util::write_file( MCMSSEO_Redirect_File_Util::get_file_path(), $file_content );
		}
