...
/**
 * Class MCMSSEO_Htaccess_Redirect_File
 */
class MCMSSEO_Redirect_Htaccess_Exporter extends MCMSSEO_Redirect_Apache_Exporter {
	...
	protected function save( $file_content ) {
		$file_path = MCMSSEO_Redirect_Htaccess_Util::get_htaccess_file_path();

		// Update the .htaccess file.
		if ( is_writable( $file_path ) ) {
			$htaccess = $this->get_htaccess_content( $file_path, $file_content );
			$return   = (bool) MCMSSEO_Redirect_File_Util::write_file( $file_path, $htaccess );
