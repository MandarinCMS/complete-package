 ...
 */
class MCMSSEO_Redirect_Apache_Exporter extends MCMSSEO_Redirect_File_Exporter {
	 ...
	 *
	 * @param MCMSSEO_Redirect $redirect The redirect data.
	 *
	 * @return string
	 */
	public function format( MCMSSEO_Redirect $redirect ) {
		...
		if ( $redirect->get_format() === MCMSSEO_Redirect::FORMAT_PLAIN ) {
			return sprintf(
	 ...
	 * @return string
	 */
	public function format_non_target( MCMSSEO_Redirect $redirect ) {
