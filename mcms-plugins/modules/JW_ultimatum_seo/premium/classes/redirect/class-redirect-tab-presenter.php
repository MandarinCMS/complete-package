...
/**
 * Class MCMSSEO_Redirect_Tab_Presenter
 */
abstract class MCMSSEO_Redirect_Tab_Presenter {
	...
	public function display() {
		...
		include( MCMSSEO_PATH . 'premium/classes/redirect/views/redirects-tab-' . $this->view . '.php' );
	}
