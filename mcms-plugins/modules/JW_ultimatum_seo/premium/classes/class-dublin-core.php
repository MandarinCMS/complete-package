...
class MCMSSEO_Dublin_Core {
	...
	public function init() {
		add_action( 'mcmsseo_head', array( $this, 'date_issued' ), 50 );
	}
	...
	public function dc_tag( $property, $content ) {
		...
		/**
		 * Filter: 'mcmsseo_dc_' . $property - Allow developers to change the content of specific DC meta tags.
		 *
		 * @api string $content The content of the property
		 */
		$content = apply_filters( 'mcmsseo_dc_' . $property, $content );
