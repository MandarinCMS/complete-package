...
( function( $ ) {
	...
	function addUploadButton( preview ) {
		...
		var imageButtonHtml = '<button id="' + imageButtonId + '" ' +
			'class="button button-primary mcmsseo_preview_image_upload_button" type="button">' + uploadButtonText + '</button>';

		var removeButtonId   = imageFieldId + "_remove_button";
		var removeButtonHtml = '<button id="' + removeButtonId + '" type="button" ' +
			'class="button mcmsseo_preview_image_upload_button">' + ultimatumSocialPreview.removeImageButton + '</button>';
