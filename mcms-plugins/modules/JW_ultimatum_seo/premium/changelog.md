...
* Includes every change in Ultimatum SEO core 3.8.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.7.2 October 20th, 2016
* Includes every change in Ultimatum SEO core 3.7.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.7.1 October 11th, 2016
* Adds a message when no prominent words were detected in the text.

### 3.7.0: October 11th, 2016
* Adds an insights section to the Ultimatum SEO metabox that shows authors the most prominent words in their text.
* Adds a validation to check if the origin url in a redirect contains the subdirectory in case MandarinCMS is installed in a subdirectory.
...
* Includes every change in Ultimatum SEO core 3.7.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.6.1: October 3rd, 2016
* Includes every change in Ultimatum SEO core 3.6.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/). 

### 3.6: September 27th, 2016
* Includes every change in Ultimatum SEO core 3.6.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/). 
...
* Includes every change in Ultimatum SEO core 3.5.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Includes every change in Ultimatum SEO core 3.4.2, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.4.1: August 2nd, 2016
* Security hotfix: Includes every change in Ultimatum SEO core 3.4.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.4.0: July 19th, 2016
* Includes every change in Ultimatum SEO core 3.4.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Includes every change in Ultimatum SEO core 3.3.3 and 3.3.4, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.3.2: June 21st, 2016
* Includes every change in Ultimatum SEO core 3.3.2, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Includes every change in Ultimatum SEO core 3.3.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Includes every change in Ultimatum SEO core 3.3.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/). 
...
* Includes every change in Ultimatum SEO core 3.2.5, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.2.2: April 21th, 2016
* Fixes a bug where notification for a deleted post wasn't shown.
* Includes every change in Ultimatum SEO core 3.2.3, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Fixes a bug where Ultimatum SEO would fatal when activating while Ultimatum SEO was active.
* Fixes a bug where the home URL wasn't correctly stripped from the redirect old URL.
* Fixes a bug where clicking the 'Update now' button on the module page didn't update correctly.
* Includes every change in Ultimatum SEO core 3.2.0, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.1.3: March 23rd, 2016
* Fixes a few bugs related to term slugs that were altered by our module after they were saved. This especially caused issues for terms with parents. We will simply not touch term slugs anymore until the way terms are saved is fixed in MandarinCMS, see also https://core.trac.mandarincms.com/ticket/22293.
...
* Merge with Ultimatum SEO core 3.1.2, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Merge with Ultimatum SEO core 3.1.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
...
* Takes the MCMS permalink structure into account in deciding if we should redirect to a slug with or without trailing slash.
...
* Merge with Ultimatum SEO core 3.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.7: December 23rd, 2015
* Merge with Ultimatum SEO core 3.0.7, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.6: December 1st, 2015
* Merge with Ultimatum SEO core 3.0.6, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.5: December 1st, 2015
* Fixed performance issues in custom fields integration.
* Merge with Ultimatum SEO core 3.0.5, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.4: November 25th, 2015
* Merge with Ultimatum SEO core 3.0.4, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.3: November 19th, 2015
* Merge with Ultimatum SEO core 3.0.3, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.2: November 19th, 2015
* Merge with Ultimatum SEO core 3.0.2, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0.1: November 18th, 2015
* Merge with Ultimatum SEO core 3.0.1, see the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 3.0: November 18th, 2015
* Merge with Ultimatum SEO core 3.0, including the realtime content analysis tool and social settings for taxonomies. See the [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).
* Added possibility to analyze multiple keywords per post/page.
* Added support beacon to all the Ultimatum SEO settings pages, allowing users to ask for support straight from their MandarinCMS backend.

### 2.3.5: September 16th, 2015
* Merge with Ultimatum SEO core 2.3.5

### 2.3.4: August 6th, 2015
* Merge with Ultimatum SEO core 2.3.4

### 2.3.3: August 6th, 2015
* Added a filter `mcmsseo_hide_version` that allows webmasters to hide the Ultimatum SEO version number in the debug marker.
* Merge with Ultimatum SEO core 2.3.3

### 2.3.2: July 23rd, 2015
* Merge with Ultimatum SEO core 2.3.2

### 2.3.1: July 22nd, 2015
* Fixes a bug where the .htaccess redirect import was no longer available.
* Fixes a bug where upgrading to version 2.3 would occasionally cause WSOD's on both admin and frontend. We were unable to pinpoint the exact conflicting modules and myskins, but we are quite confident it was caused by us using, and others hooking into, MCMS_Query too early.
* Merge with Ultimatum SEO core 2.3.1

### 2.3: July 21st, 2015
* Renamed module to "Ultimatum SEO"
* Fixes compatibility issue with Post type order module.
* Merge with Ultimatum SEO core 2.3
...
* Merge with Ultimatum SEO core 2.2.1

### 2.2: June 10th, 2015
* Adds a X-Redirect-By header to redirects that were created using Ultimatum SEO. Works for all PHP redirects and regular NGINX redirects. Doesn't work for Apache.
...
* Merge with Ultimatum SEO core 2.2

### 2.1.1: April 21st, 2015
* Merge with Ultimatum SEO core 2.1.1

### 2.1: April 20th, 2015
* Merge with Ultimatum SEO core 2.1

### 2.0.1: April 1st, 2015
* Merge with Ultimatum SEO core 2.0.1

### 2.0: March 11th, 2015
* Merge with Ultimatum SEO core 2.0
* Made the version number for the Premium module the same as for the Free module to avoid confusion.
* Contains several performance improvements, making the module much faster.

### 1.5.3: March 11th, 2015
* Security hotfix: Merge with Ultimatum SEO core 1.7.4, see [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 1.5.2.2: February 23rd, 2015
* Merge with Ultimatum SEO core 1.7.3.2

### 1.5.2.1: February 19th, 2015
* Merge with Ultimatum SEO core 1.7.3.1
...
* Reuses translations from the free version of this module, thereby dramatically reducing the amount of strings that need to be translated for the premium module.
* Merge with Ultimatum SEO core 1.7.3

### 1.5.1: November 26th, 2014
* Security hotfix: Merge with Ultimatum SEO core 1.7.1, see [core changelog](https://mandarincms.com/modules/mandarincms-seo/changelog/).

### 1.5: November 18th, 2014
* Merge with Ultimatum SEO core 1.7
...
* Merge with Ultimatum SEO core 1.6.3

### 1.4.2: October 8th, 2014
* Merge with Ultimatum SEO core 1.6.2
* Implement new filter for issue types on the Google Webmaster Tools issues screen

### 1.4.1: September 16th, 2014
* Merge with Ultimatum SEO core 1.6.1

### 1.4: September 9th, 2014
* Merge with Ultimatum SEO core 1.6

### 1.3.5: August 26th, 2014
* Merge with Ultimatum SEO core 1.5.6, updated for MCMS 4.0

### 1.3.4: August 15th, 2014
* Fix incomplete merge with Ultimatum SEO core to 1.5.5.3

### 1.3.3: August 14th, 2014
* Updated Ultimatum SEO core to 1.5.5.3

### 1.3.2: August 14th, 2014
* Fixed bug in core Ultimatum SEO that made SEO icon value wrong.
* Updated Ultimatum SEO core to 1.5.5.2
...
### 1.2.2: July 4th, 2014
* Added link to Ultimatum Knowledge Base to regex redirects.
...
* Created a Ultimatum overlay for a more user friendly way of displaying errors.
* Implemented autoloader to enhance module performance.
* Updated Ultimatum SEO core to 1.5.3.3.

### 1.1.3: May 22nd, 2014
* Updated Ultimatum SEO core to 1.5.3.2

### 1.1.2: April 25th, 2014
* Fixed notices when fetching remote crawl issues and there are now crawl issues from remote.
* Updated Ultimatum SEO core to 1.5.2.8

### 1.1.1: April 15th, 2014
* Updated Ultimatum SEO core to 1.5.2.7

### 1.1.0: April 4st, 2014
* Updated Ultimatum SEO core to 1.5.x
...
* Added import option from Redirection module.
* Added a redirect link to MandarinCMS toolbar on 404 pages.
* Added support for REGEX redirects.

### 1.0.8: March 21st, 2014
* Updated Ultimatum SEO core to 1.5.2.5

### 1.0.7: March 14st, 2014
* Updated Ultimatum SEO core to 1.5.2.2

### 1.0.6: March 12st, 2014
* Updated Ultimatum SEO core to 1.5.2.1

### 1.0.5: March 11st, 2014
* Updated Ultimatum SEO core to 1.5.2

### 1.0.4: March 11st, 2014
* Updated Ultimatum SEO core to 1.5.0

### 1.0.3: Feb 26st, 2014
* Fixed an incorrect constant define.
* Updated Ultimatum SEO core to 1.4.25.
* Now using the correct file reference (MCMSSEO_FILE) in main MCMSSEO file.

### 1.0.2: Feb 18st, 2014
* Fixed a bug that prevented options on the MCMSSEO dashboard from saving.
* Updated Ultimatum SEO core to 1.4.24.

### 1.0.1: Jan 31st, 2014
* Remove dependency on PHP 5.3 function DateTime::getTimestamp() so module works on PHP 5.2 installs too.
