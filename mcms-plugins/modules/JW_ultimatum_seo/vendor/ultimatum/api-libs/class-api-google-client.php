<?php
/**
 * Class Ultimatum_Api_Google_Client
 */
class Ultimatum_Api_Google_Client extends Ultimatum_Google_Client {
	...
	public function authenticate_client( $authorization_code = null ) {
		...
		} catch ( Ultimatum_Google_AuthException $exception ) {
	...
	public function do_request( $target_request_url, $decode_response = false, $request_method = 'GET' ) {
		...
		$response = $this->getIo()->authenticatedRequest(
			new Ultimatum_Google_HttpRequest( $this->api_url . $target_request_url, $request_method )
		);
