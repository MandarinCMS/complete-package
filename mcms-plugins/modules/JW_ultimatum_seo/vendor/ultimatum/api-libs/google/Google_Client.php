 ...
 */
class Ultimatum_Google_Client {
  /**
   * @static
   * @var Ultimatum_Google_Auth $auth
   */
  static $auth;

  /**
   * @static
   * @var Ultimatum_Google_IO $io
   */
  static $io;

  /**
   * @static
   * @var Ultimatum_Google_Cache $cache
   */
  static $cache;
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new Ultimatum_Google_Exception('Cant add services after having authenticated');
    }
   ...
   * or Ultimatum_Google_Client#getAccessToken().
   ...
   * @return Ultimatum_Google_LoginTicket Returns an apiLoginTicket if the verification was
   * successful.
   */
  ...
  /**
   * @param Ultimatum_Google_AssertionCredentials $creds
   * @return void
   */
  ...
  /**
   * @static
   * @return Ultimatum_Google_Auth the implementation of apiAuth.
   */
  public static function getAuth() {
    return Ultimatum_Google_Client::$auth;
  }

  /**
   * @static
   * @return Ultimatum_Google_IO the implementation of apiIo.
   */
  public static function getIo() {
    return Ultimatum_Google_Client::$io;
  }

  /**
   * @return Ultimatum_Google_Cache the implementation of apiCache.
   */
  public function getCache() {
    return Ultimatum_Google_Client::$cache;
  }
}

// Exceptions that the Google PHP API Library can throw
class Ultimatum_Google_Exception extends Exception {}
class Ultimatum_Google_AuthException extends Ultimatum_Google_Exception {}
class Ultimatum_Google_CacheException extends Ultimatum_Google_Exception {}
class Ultimatum_Google_IOException extends Ultimatum_Google_Exception {}
class Ultimatum_Google_ServiceException extends Ultimatum_Google_Exception {
  /**
