...
class Ultimatum_Google_Model {
   ...
   * @throws Ultimatum_Google_Exception Thrown if $obj isn't an array.
  ...
  public function assertIsArray($obj, $type, $method) {
    if ($obj && !is_array($obj)) {
      throw new Ultimatum_Google_Exception("Incorrect parameter type passed to $method(), expected an"
