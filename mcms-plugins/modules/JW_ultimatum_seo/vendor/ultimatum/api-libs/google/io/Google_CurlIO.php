...
class Ultimatum_Google_CurlIO extends Ultimatum_Google_IO {
   ...
   * @throws Ultimatum_Google_IOException on curl or IO error
   */
  public function makeRequest(Ultimatum_Google_HttpRequest $request) {
    ...
    if ($curlErrorNum != CURLE_OK) {
      throw new Ultimatum_Google_IOException("HTTP Error: ($respHttpCode) $curlError");
    }
