...
/**
 * Include this class to use the Ultimatum_Api_Libs, you can include this as a submodule in your project
 ...
 * - Class name should be 'Ultimatum_Api_Oauth'
 */
class Ultimatum_Api_Libs {
