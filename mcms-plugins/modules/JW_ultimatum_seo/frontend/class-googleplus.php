...
class MCMSSEO_GooglePlus {
	...
	public function output() {
		_deprecated_function( 'MCMSSEO_GooglePlus::output', '3.2' );
	}
	...
	public function description() {
		_deprecated_function( 'MCMSSEO_GooglePlus::description', '3.2' );
	}
	...
	public function google_plus_title() {
		_deprecated_function( 'MCMSSEO_GooglePlus::google_plus_title', '3.2' );
	}
	...
	public function google_plus_image() {
		_deprecated_function( 'MCMSSEO_GooglePlus::google_plus_image', '3.2' );
	}
}
