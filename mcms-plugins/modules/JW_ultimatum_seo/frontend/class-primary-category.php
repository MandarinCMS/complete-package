 ...
 */
class MCMSSEO_Frontend_Primary_Category {
	 ...
	 *
	 * @return array|null|object|MCMS_Error The category we want to use for the post link.
	 */
	...
	protected function get_primary_category( $post = null ) {
		...
		$primary_term = new MCMSSEO_Primary_Term( 'category', $post->ID );
	 ...
	 *
	 * @return array|null|object|MCMS_Error
	 */
