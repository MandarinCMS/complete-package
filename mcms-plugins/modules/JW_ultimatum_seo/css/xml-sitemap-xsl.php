		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="https://jiiworks.net/">Ultimatum</a> <a href="https://jiiworks.net/mandarincms/modules/seo/">SEO</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
				...
				<script type="text/javascript" src="<?php echo modules_url( 'js/dist/jquery.tablesorter.min.js', MCMSSEO_FILE ) ?>"></script>
