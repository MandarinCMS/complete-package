<?php
/*
* Add-on Name: Info Circle for RazorLeaf Conductor
...
if(!class_exists('Ultimate_Info_Circle'))
{
	class Ultimate_Info_Circle
	{
		function __construct()
		{
			...
			add_action("mcms_enqueue_scripts", array($this, "register_info_circle_assets"),1);
				...
				array(
				   ...
				   "params" => array(
						...
						*/
						...
						array(
							"type" => "ult_param_heading",
							"text" => "<span style='display: block;'><a href='http://jiiworks.net/z-dpz' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
...
{
	if ( ! class_exists( 'MCMSBakeryShortCode_info_circle' ) ) {
		class MCMSBakeryShortCode_info_circle extends MCMSBakeryShortCodesContainer {
		}	
	}
	
	if ( ! class_exists( 'MCMSBakeryShortCode_info_circle_item' ) ) {
		class MCMSBakeryShortCode_info_circle_item extends MCMSBakeryShortCode {
		}
	}
}
if(class_exists('Ultimate_Info_Circle'))
