...
if(!class_exists("Ultimate_Team")){
	class Ultimate_Team{
		function __construct(){
			...
			add_action("mcms_enqueue_scripts", array($this, "register_team_assets"),1);
		}
		...
		function admin_scripts($hook) {
		  	...
		  	if($hook == "post.php" || $hook == "post-new.php" || $hook == 'visual-composer_page_vc-roles'){
				...
				if($bsf_dev_mode === 'enable') {
					mcms_enqueue_script('ult-team-admin',UAVC_URL.'admin/js/team-admin.js',array('jquery'),ULTIMATE_VERSION,true);
				}
			}
		}
	...
	if(class_exists('MCMSBakeryShortCode') && !class_exists('MCMSBakeryShortCode_ult_team') )
	{
		class MCMSBakeryShortCode_ult_team extends MCMSBakeryShortCode {
		}
	}
