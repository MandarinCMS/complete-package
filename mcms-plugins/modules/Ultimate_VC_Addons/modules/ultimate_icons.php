...
if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_icons' ) ) {
    class MCMSBakeryShortCode_ultimate_icons extends MCMSBakeryShortCodesContainer {
    }
}
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_single_icon' ) ) {
    class MCMSBakeryShortCode_single_icon extends MCMSBakeryShortCode {
    }
}