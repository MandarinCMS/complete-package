...
if(!class_exists("Ultimate_Google_Trends")){
				...
				vc_map( array(
					...
					"params" => array(
						...
						array(
							...
							"text" => "<span style='display: block;'><a href='http://jiiworks.net/skwuz' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
	...
	if(class_exists('MCMSBakeryShortCode') && !class_exists('MCMSBakeryShortCode_ultimate_google_trends'))
	{
		class MCMSBakeryShortCode_ultimate_google_trends extends MCMSBakeryShortCode {
		}
	}
