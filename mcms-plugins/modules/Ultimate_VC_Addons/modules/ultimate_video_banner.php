...
if(!class_exists('Ultimate_Video_Banner')) {
	class Ultimate_Video_Banner {
		function __construct() {
			...
			add_action("mcms_enqueue_scripts", array($this, "register_video_banner_assets"),1);
		}
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_video_banner' ) ) {
    class MCMSBakeryShortCode_ultimate_video_banner extends MCMSBakeryShortCode {
    }
}
?>