<?php
/*
* Add-on Name: Adjustable Spacer for RazorLeaf Conductor
...
if(!class_exists("Ultimate_Spacer")){
	...
	new Ultimate_Spacer;
	if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_spacer' ) ) {
	    class MCMSBakeryShortCode_ultimate_spacer extends MCMSBakeryShortCode {
	    }
	}
}