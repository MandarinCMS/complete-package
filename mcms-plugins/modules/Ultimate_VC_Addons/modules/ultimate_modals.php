...
* Add-on URI: https://www.jiiworks.com
*/
	...
	class Ultimate_Modals
	{
		function __construct()
		{
			if ( Ultimate_VC_Addons::$uavc_editor_enable ) {
				// Initialize the modal popup component for RazorLeaf Conductor
			...
			add_action("mcms_enqueue_scripts", array($this, "register_modal_assets"),1);
		}
		function register_modal_assets()
		{
			...
			if($bsf_dev_mode === 'enable') {
				...
				$ext = '';
				mcms_register_script("ultimate-modal-customizer", $js_path."modernizr-custom.js",array('jquery'),ULTIMATE_VERSION);
				mcms_register_script("ultimate-modal-classie", $js_path."classie.js",array('jquery'),ULTIMATE_VERSION);
				mcms_register_script("ultimate-modal-froogaloop2", $js_path."froogaloop2-min.js",array('jquery'),ULTIMATE_VERSION);
				mcms_register_script("ultimate-modal-snap-svg", $js_path."snap-svg.js",array('jquery'),ULTIMATE_VERSION);
				mcms_register_script("ultimate-modal", $js_path."modal.js",array('jquery', 'ultimate-modal-customizer', 'ultimate-modal-classie', 'ultimate-modal-froogaloop2', 'ultimate-modal-snap-svg' ),ULTIMATE_VERSION);
			}
			else {
			...
			mcms_register_script("ultimate-modal-all", UAVC_URL.'assets/min-js/modal-all.min.js',array('jquery'),ULTIMATE_VERSION);
		...
		function modal_shortcode($atts, $content = null)
		{
			...
			$vc_version = (defined('MCMSB_VC_VERSION')) ? MCMSB_VC_VERSION : 0;
			...
			if( $modal_on == 'onload' && $ult_hide_modal_mobile != '' && $ult_hide_modal != '' ) {
				if( ( ! Ultimate_Modals::uavc_is_medium_device() ) && mcms_is_mobile()){
			...
			if($icon_type == 'custom'){
				//$ico_img = mcms_get_attachment_image_src( $icon_img, 'large');
			...
			if($modal_on == "button"){
				...
				if($btn_img !==''){
					...
					// $img = mcms_get_attachment_image_src( $btn_img, 'large');
					...
					array(
						...
						"params" => array(
							...
							array(
								...
								"group" => "General",
								"edit_field_class" => "ult_hide_editor_fullscreen vc_col-xs-12 vc_column mcmsb_el_type_textarea_html vc_wrapper-param-type-textarea_html vc_shortcode-param",
							),
							array(
								"type" => "dropdown",
								...
								"description" => __("Please put the embed code in the content for videos, eg: <a href='http://jiiworks.net/kuv3-' target='_blank' rel='noopener'>http://jiiworks.net/kuv3-</a><br>
									For hosted video - Add any video with MandarinCMS media uploader or with <a href='https://codex.mandarincms.org/Video_Shortcode' target='_blank' rel='noopener'>[video]</a> shortcode.", "ultimate_vc"),
								"group" => "General",
							),
							array(
								"type" => "dropdown",
							...
							array(
								...
								//"text" => "<span style='display: block;'><a href='https://goo.gl/1kCZkG' target='_blank'>".__("Need More Features?","ultimate_vc")." &nbsp;&nbsp;&nbsp;</a><a href='http://jiiworks.net/ei2r5' target='_blank'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_modal' ) ) {
    class MCMSBakeryShortCode_ultimate_modal extends MCMSBakeryShortCode {
    }
}
