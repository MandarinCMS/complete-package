<?php
/*
* Add-on Name: Info Tables for RazorLeaf Conductor
...
if(!class_exists("Ultimate_Info_Table")){
	class Ultimate_Info_Table{
		function __construct(){
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'info_table_assets' ), 1 );
		}
			...
			if(function_exists("vc_map")){
				...
				array(
				   ...
				   "params" => array(
						...
						array(
							"type" => "ult_param_heading",
							"text" => "<span style='display: block;'><a href='http://jiiworks.net/t9vlh' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
	...
	if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_info_table' ) ) {
	    class MCMSBakeryShortCode_ultimate_info_table extends MCMSBakeryShortCode {
	    }
	}
}