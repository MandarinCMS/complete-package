...
if(!class_exists('Ultimate_Image_Separator'))
{
	class Ultimate_Image_Separator{
		function __construct(){
			...
			add_action('mcms_enqueue_scripts', array($this, 'register_easy_separator_assets'),1);
		}
		...
		function ultimate_img_separator_shortcode($atts, $content)
		{
			...
			if($ultimate_custom_vc_row == '')
				$ultimate_custom_vc_row = 'mcmsb_row';
			...
			$img_alignment = '';
			if($img_separator_alignment == 'ult-left-img' && ! mcms_is_mobile() )
			{
				$img_alignment = 'ult-left-img';
			}
			else if($img_separator_alignment == 'ult-right-img' && ! mcms_is_mobile() )
			{
			...
			if($img_separator_alignment == 'ult-left-img' && $img_position_left != '' && ! mcms_is_mobile() )
			{
			...
			else if($img_separator_alignment == 'ult-right-img' && $img_position_right != '' && ! mcms_is_mobile() ){
