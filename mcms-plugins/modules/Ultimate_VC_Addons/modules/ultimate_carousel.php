<?php
/*
Module Name: Ultimate Carousel for RazorLeaf Conductor
Module URI: https://www.jiiworks.com/demos/ultimate-carousel
*/
if ( ! class_exists( "Ultimate_Carousel" ) ) {
	class Ultimate_Carousel {
		...
		function __construct() {
			...
			add_action( "mcms_enqueue_scripts", array( $this, "ultimate_front_scripts" ), 1 );
		...
		function ultimate_admin_scripts( $hook ) {
			if ( $hook == "post.php" || $hook == "post-new.php" ) {
				mcms_enqueue_style( "ult-icons", UAVC_URL.'assets/css/icons.css' );
			}
		}
					...
					array(
						...
						"params"                  => array(
							...
							array(
								...
								"text"             => "<span style='display: block;'><a href='http://jiiworks.net/bzyci' target='_blank' rel='noopener'>" . __( "Watch Video Tutorial", "ultimate_vc" ) . " &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
	...
	if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_carousel' ) ) {
		class MCMSBakeryShortCode_ultimate_carousel extends MCMSBakeryShortCodesContainer {
		}
	}
}
