  ...
  if(!class_exists('ULT_iHover')) {
	class ULT_iHover {
		function __construct() {
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'ult_ihover_scripts' ), 1 );
		}
		...
		function ult_ihover_init() {
			  ...
			  if(function_exists("vc_map")){
				  vc_map( array(
					  ...
					  //'admin_enqueue_js' => array( modules_url('../assets/js/ihover.js',__FILE__)), // This will load js file in the VC backend editor
					  //"admin_enqueue_css" => array( modules_url('../assets/css/ihover.css',__FILE__)), // This will load css file in the VC backend editor
					 //"is_container"    => true,
					  "params" => array(
						  array(
							  "type" => "dropdown",
		...
		//     Load module css and javascript files which you may need on front end of your site
	...
	new ULT_iHover;
	  ...
	  if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ult_ihover' ) ) {
			  class MCMSBakeryShortCode_ult_ihover extends MCMSBakeryShortCodesContainer {
		  }
	  }
	  if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ult_ihover_item' ) ) {
			  class MCMSBakeryShortCode_ult_ihover_item extends MCMSBakeryShortCode {
		  }
	  }
  }
