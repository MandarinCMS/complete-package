<?php
/*
* Add-on Name: CountDown for RazorLeaf Conductor
...
if(!class_exists('Ultimate_CountDown'))
{
	class Ultimate_CountDown
	{
		function __construct()
		{
			...
			add_action('mcms_enqueue_scripts',array($this,'count_down_scripts'),1);
		}
		...
		function admin_scripts($hook) {
		   if($hook == "post.php" || $hook == "post-new.php"){
				...
				if($bsf_dev_mode === 'enable') {
					...
					mcms_enqueue_style('ult-colorpicker-style');
				}
		   }
	   	}
					...
					array(
					   ...
					   "params" => array(
							...
							array(
								...
								"param_name" => "ult_tz",
								"value" => array(
										__("MandarinCMS Defined Timezone","ultimate_vc") => "ult-mcmstz",
							...
							array(
								...
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/szdd2' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
   ...
   //          );
	...
	if(class_exists('MCMSBakeryShortCode') && !class_exists('MCMSBakeryShortCode_ult_countdown'))
	{
		class MCMSBakeryShortCode_ult_countdown extends MCMSBakeryShortCode {
		}
	}
}