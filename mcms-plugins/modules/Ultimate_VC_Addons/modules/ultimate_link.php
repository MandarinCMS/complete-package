<?php
/*
* Add-on Name: Creatve Link for RazorLeaf Conductor
...
if(!class_exists('AIO_creative_link'))
{
...

	{
		function __construct()
		{
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'creative_link_scripts'), 1 );
		}
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ult_createlink' ) ) {
    class MCMSBakeryShortCode_ult_createlink extends MCMSBakeryShortCode {
    }
}