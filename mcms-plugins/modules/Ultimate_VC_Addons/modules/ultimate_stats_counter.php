<?php
/*
* Add-on Name: Stats Counter for RazorLeaf Conductor
...
if(!class_exists('AIO_Stats_Counter'))
{
	class AIO_Stats_Counter
	{
		...
		function __construct()
		{
			...
			add_action("mcms_enqueue_scripts", array($this, "register_counter_assets"),1);
					   ...
					   "params" => array(
						 ...
						 //  array(
						  ...
						  array(
							...
							array(
								"type" => "ult_param_heading",
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/t23kn' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
		...
		function counter_shortcode($atts)
		{
			...
			//mcms_enqueue_script('front-js',modules_url('../assets/min-js/countUp.min.js',__FILE__));
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_stat_counter' ) ) {
    class MCMSBakeryShortCode_stat_counter extends MCMSBakeryShortCode {
    }
}