<?php
/*
* Add-on Name: Interactive Banners for RazorLeaf Conductor
...
if(!class_exists('AIO_Interactive_Banners'))
{
	class AIO_Interactive_Banners
	{
		function __construct() {
			...
			add_action('mcms_enqueue_scripts', array($this, 'register_ib_banner_assets'),1);
		}
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_interactive_banner' ) ) {
    class MCMSBakeryShortCode_interactive_banner extends MCMSBakeryShortCode {
    }
}