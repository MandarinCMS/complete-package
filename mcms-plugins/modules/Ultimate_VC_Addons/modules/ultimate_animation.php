...
if(!class_exists('Ultimate_Animation')){
					...
					array(
						...
						"params" => array(
							...
							array(
								...
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/pd-ct' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
	...
	if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ult_animation_block' ) ) {
		class MCMSBakeryShortCode_ult_animation_block extends MCMSBakeryShortCodesContainer {
		}
	}
}