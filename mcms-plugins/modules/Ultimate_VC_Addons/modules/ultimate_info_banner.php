...
if(!class_exists('Ultimate_Info_Banner'))
{
	class Ultimate_Info_Banner{
		function __construct(){
			...
			add_action('mcms_enqueue_scripts', array($this, 'register_info_banner_assets'),1);
		}
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_info_banner' ) ) {
    class MCMSBakeryShortCode_ultimate_info_banner extends MCMSBakeryShortCode {
    }
}
