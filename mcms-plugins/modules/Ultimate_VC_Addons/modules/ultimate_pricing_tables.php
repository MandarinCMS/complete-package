<?php
/*
* Add-on Name: Pricing Tables for RazorLeaf Conductor
...
if(!class_exists("Ultimate_Pricing_Table")){
	class Ultimate_Pricing_Table{
		function __construct(){
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'price_table_assets' ), 1 );
		}
	...
	if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_pricing' ) ) {
	    class MCMSBakeryShortCode_ultimate_pricing extends MCMSBakeryShortCode {
	    }
	}
}