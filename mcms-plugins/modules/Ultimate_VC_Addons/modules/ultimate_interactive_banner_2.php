...
if(!class_exists('Ultimate_Interactive_Banner'))
{
	class Ultimate_Interactive_Banner{
		function __construct(){
			...
			add_action('mcms_enqueue_scripts', array($this, 'register_ib2_banner_assets'),1);
		}
				...
				vc_map(
					array(
					   ...
					   "params" => array(
							...
							array(
								"type" => "ult_param_heading",
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/n8o33' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
		...
		function banner_shortcode($atts)
		{
			...
			//$img = mcms_get_attachment_image_src( $banner_image, 'full');
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_interactive_banner_2' ) ) {
    class MCMSBakeryShortCode_interactive_banner_2 extends MCMSBakeryShortCode {
    }
}