	...
	*/
	class Ultimate_Range_Slider
	{
		...
		function __construct()
		{
			...
			add_action( "mcms_enqueue_scripts", array( $this, "range_slider_scripts" ), 1 );
		}
...
//////////design data
	...
	if ( class_exists( "MCMSBakeryShortCode" ) && !class_exists( "MCMSBakeryShortCode_ult_range_slider" ) ) {
		class MCMSBakeryShortCode_ult_range_slider extends MCMSBakeryShortCode {
		}
	}
}