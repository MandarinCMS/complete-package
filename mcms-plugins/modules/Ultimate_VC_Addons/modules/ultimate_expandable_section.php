<?php
/*
* Add-on Name: Expandable Section for RazorLeaf Conductor
...
if(!class_exists('AIO_ultimate_exp_section'))
{
...

	{
		function __construct()
		{
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'ultimate_exp_scripts') , 1);
...
if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_exp_section' ) ) {
		class MCMSBakeryShortCode_ultimate_exp_section extends MCMSBakeryShortCodesContainer {
		}
	}
