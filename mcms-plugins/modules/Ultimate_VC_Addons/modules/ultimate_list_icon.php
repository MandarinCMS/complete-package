<?php
/*
* Add-on Name: Icons Block for RazorLeaf Conductor
*/
if(!class_exists('Ultimate_List_Icon'))
{
	class Ultimate_List_Icon
	{
		...
		function ultimate_icon_list_shortcode($atts,$content = null)
		{
			...
			// enqueue js
			//mcms_enqueue_script('aio-tooltip',modules_url('../assets/min-js/',__FILE__).'tooltip.min.js',array('jquery'));
...
//Extend MCMSBakeryShortCodesContainer class to inherit all required functionality
if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_icon_list' ) ) {
    class MCMSBakeryShortCode_ultimate_icon_list extends MCMSBakeryShortCodesContainer {
    }
}
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_icon_list_item' ) ) {
    class MCMSBakeryShortCode_ultimate_icon_list_item extends MCMSBakeryShortCode {
    }
}