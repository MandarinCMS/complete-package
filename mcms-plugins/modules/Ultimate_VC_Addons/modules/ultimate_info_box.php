	...
	class AIO_Icons_Box
	{
		function __construct()
		{
			if ( Ultimate_VC_Addons::$uavc_editor_enable ) {
				// Initialize the icon box component for RazorLeaf Conductor
				add_action('init', array( &$this, 'icon_box_init' ) );
			}
			// Add shortcode for icon box
			add_shortcode('bsf-info-box', array(&$this, 'icon_boxes' ) );
			add_action( 'mcms_enqueue_scripts', array( $this, 'icon_box_scripts' ), 1 );
				...
				vc_map(
					array(
						...
						"params" => array(
							...
							array(
								"type" => "ult_param_heading",
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/kqzzi' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
