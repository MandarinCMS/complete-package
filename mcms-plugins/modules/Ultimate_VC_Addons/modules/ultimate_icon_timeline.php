...
if(!class_exists('Ultimate_Icon_Timeline'))
{
	class Ultimate_Icon_Timeline
	{
		function __construct()
		{
			...
			add_action('mcms_enqueue_scripts', array($this, 'register_timeline_assets'),1);
		}
					   ...
					   "params" => array(
						   ...
						   array(
							...
							array(
								...
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/agey7' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
		...
		{
			//mcms_enqueue_script('masonry',modules_url('../assets/min-js/',__FILE__).'masonry.min.js', array('jquery'), false, true);
			...
			if($timeline_style=='jstime'){
				$output .= '<div class="'.esc_attr($timeline_style).' timeline_preloader" style="opacity:0;width:35px;margin:auto;margin-top:30px;"><img style="box-shadow:none;" alt="timeline_pre_loader" src="'.module_dir_url( __FILE__ ).'../assets/img/timeline_pre-loader.gif" /></div>';
...
if(class_exists('MCMSBakeryShortCodesContainer') && !class_exists('MCMSBakeryShortCode_icon_timeline'))
{
	class MCMSBakeryShortCode_icon_timeline extends MCMSBakeryShortCodesContainer {
	}
}
if(class_exists('MCMSBakeryShortCodesContainer') && !class_exists('MCMSBakeryShortCode_icon_timeline_item'))
{
	class MCMSBakeryShortCode_icon_timeline_item extends MCMSBakeryShortCode {
	}
}
if(class_exists('Ultimate_Icon_Timeline'))
{
