	...
	*/
	class Ultimate_Sticky_Section
	{
		...
		function __construct()
		{
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'ult_sticky_section_scripts' ), 1 );
			//add_action( 'mcms_enqueue_scripts', array( $this , 'enqueue_style' ) );
	...
	if ( class_exists( 'MCMSBakeryShortCodesContainer' ) && !class_exists( 'MCMSBakeryShortCode_ult_sticky_section' ) ) {
		class MCMSBakeryShortCode_ult_sticky_section extends MCMSBakeryShortCodesContainer {
		}
	}
}