<?php
/*
* Add-on Name: Just Icon for RazorLeaf Conductor
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_just_icon' ) ) {
    class MCMSBakeryShortCode_just_icon extends MCMSBakeryShortCode {
    }
}