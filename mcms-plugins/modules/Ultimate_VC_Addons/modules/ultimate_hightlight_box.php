...
if(!class_exists('Ultimate_Highlight_Box'))
{
	class Ultimate_Highlight_Box{
		function __construct(){
			...
			add_action('mcms_enqueue_scripts', array($this, 'register_cta_assets'),1);
		}
...
if ( class_exists( 'MCMSBakeryShortCode' ) && !class_exists( 'MCMSBakeryShortCode_ultimate_ctation' ) ) {
    class MCMSBakeryShortCode_ultimate_ctation extends MCMSBakeryShortCode {
    }
}
