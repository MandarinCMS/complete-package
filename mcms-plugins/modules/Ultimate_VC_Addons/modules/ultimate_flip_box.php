<?php
/*
* Add-on Name: Flip Box for RazorLeaf Conductor
...
if(!class_exists('AIO_Flip_Box'))
{
	class AIO_Flip_Box
	{
		function __construct()
		{
			...
			add_action( 'mcms_enqueue_scripts', array( $this, 'flip_box_scripts' ), 1 );
		}
		function block_init()
		{
				...
				vc_map(
					array(
					   ...
					   "params" => array(
							...
							array(
								"type" => "ult_param_heading",
								"text" => "<span style='display: block;'><a href='http://jiiworks.net/1qnl6' target='_blank' rel='noopener'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
	...
	new AIO_Flip_Box;
	if(class_exists('MCMSBakeryShortCode') && !class_exists('MCMSBakeryShortCode_icon_counter'))
	{
		class MCMSBakeryShortCode_icon_counter extends MCMSBakeryShortCode {
		}
	}
}
