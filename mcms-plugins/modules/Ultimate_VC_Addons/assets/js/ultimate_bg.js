	...
	jQuery(document).ready(function(){
		...
		jQuery.fn.ultimate_video_bg = function(option) {
			jQuery(this).each(function(){
				...
				if(typeof myskin_support === 'undefined')
					myskin_support = 'disable';
				...
				//vc = parseFloat(vc);
				if(is_vc_4_4 == true || myskin_support == 'enable')
				{
				...
				{
					selector.prepend('<div class="upb_video-wrapper '+fixer_class+'"><div class="upb_video-bg utube" data-rtl="'+rtl+'" data-bg-override="'+ride+'" data-row="'+vc_row_class+'" data-myskin-support="'+myskin_support+'">'+overlay_html+'</div></div>');
				}
				else
				{
					selector.prepend(' <div class="upb_video-wrapper"><div class="upb_video-bg" data-bg-override="'+ride+'" data-rtl="'+rtl+'" data-row="'+vc_row_class+'" data-myskin-support="'+myskin_support+'"><video class="upb_video-src"></video>'+control_html+overlay_html+'</div></div>');
				}
		...
		jQuery.fn.ultimate_parallax_animation = function(applyTo) {
					...
					if(jQuery(this).data('upb_br_animation')=='upb_fade_animation'){
						...
						if ((top+height)-windowHeight < pos) {
							...
							if(applyTo=='parent'){
								...
								op += op_c/2.3;
								jQuery(this).parents('.mcmsb_row').css({opacity :op})
							}
							if(applyTo=='self'){
								var op = parseInt(jQuery(this).css('opacity'));
								op += op_c/2.3;
		 ...
		 var temp_vdo_pos = 0;
			...
			jQuery('.upb_no_bg').each(function(index, nobg) {
				...
				var myskin_support = jQuery(nobg).data('myskin-support');
				...
				vc = parseFloat(vc);
				if(vc < 4.4 || myskin_support == 'enable')
				{
			...
			var resizees = function(){
				jQuery('.upb_row_bg').each(function() {
					var ride = jQuery(this).data('bg-override');
					var myskin_support = jQuery(this).data('myskin-support');
					var vc_row = jQuery(this).data('row');

					var ancenstor,parent;

					if(typeof myskin_support !== 'undefined' && myskin_support !== 'enable')
