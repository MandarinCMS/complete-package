  ...
  function resize_ult_section()
  {
    ...
    jQuery('.ult_exp_section_layer').each(function(i,element){
      ...
      if(override != 0)
      {
        ...
        if(jQuery(element).parents('.mcmsb_row').length > 0)
          var ancenstor = jQuery(element).parents('.mcmsb_column');
        else if(jQuery(element).parents('.mcmsb_column').length > 0)
          var ancenstor = jQuery(element).parents('.mcmsb_row');
        else
