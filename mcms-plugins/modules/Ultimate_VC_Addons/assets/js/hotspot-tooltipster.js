...
(function(e, t, n) {
    function s(t, n) {
        ...
        this.timerShow = null;
        this.$tooltip;
        this.options.iconMySkin = this.options.iconMySkin.replace(".", "");
        this.options.myskin = this.options.myskin.replace(".", "");
        this._init()
    }
    ...
    var r = "ulttooltipster",
        i = {
            ...
            iconDesktop: false,
            iconTouch: false,
            iconMySkin: "ult-tooltipster-icon",
            interactive: false,
            ...
            speed: 350,
            timer: 0,
            myskin: "ult-tooltipster-default",
            touchDevices: true,
            trigger: "hover",
            ...
            if (n.querySelector) {
                ...
                if (!u && t.options.iconDesktop || u && t.options.iconTouch) {
                    if (typeof t.options.icon === "string") {
                        t.$elProxy = e('<span class="' + t.options.iconMySkin + '"></span>');
            ...
            r.options.functionBefore.call(r.$el, r.$el, function() {
                if (r.enabled && r.Content !== null) {
                    ...
                    if (r.Status !== "hidden") {
                        ...
                        r.$tooltip = e('<div id="'+r.options.ult_adv_id+'" class="ult-tooltipster-base ' + r.options.myskin + '" style="'+BaseStyle+'"><div class="ult-tooltipster-content ult-responsive" data-ultimate-target="'+r.options.ultimate_target+'" data-responsive-json-new = \''+r.options.responsive_json_new+'\' style="'+contentStyle+'"></div></div>');
                        /*r.$tooltip = e('<div class="ult-tooltipster-base ' + r.options.myskin + '" style="' + ultCW + " " + f + " " + c + " " + h + " " + a + '"><div class="ult-tooltipster-content" style="'+ultSize+'"></div></div>');*/
