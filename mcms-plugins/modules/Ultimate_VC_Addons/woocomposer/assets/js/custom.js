		...
		if(cls >=1 ){
			...
			*/
			//console.log(elementWidth); 
				...
				jQuery('.edge').after('<div class="wcmp-view-wrap vc_span12 mcmsb_column column_container woocommerce" style="height:0px; margin-top: -20px; width:100%;"><div class="info-pc" style="left:'+pointerPos+'px; float:right; top:-10px;"></div><div class="wcmp-view-content product">'+quickView+'</div><div class="wcmp-close"><i class="wooicon-cross2"></i></div></div>');
