!function($) {
	...
	$('body').on('click', '.style_by_google', function(){
		...
		if($(this).is(':checked'))
		{
			var mcmsb_el_type_ultimate_google_fonts_style = $(this).parents('.mcmsb_el_type_ultimate_google_fonts_style');
			var mcmsb_el_type_ultimate_google_fonts = mcmsb_el_type_ultimate_google_fonts_style.prev();
			var vc_ultimate_google_font = mcmsb_el_type_ultimate_google_fonts.find('.vc-ultimate-google-font').val();
			...
			mcmsb_el_type_ultimate_google_fonts.find('.vc-ultimate-google-font').val(new_font);
		}
	});
}(window.jQuery);
var temp_count = 0;
...
{
	var ultimate_vc_gfonts_field = $select.parents('.mcmsb_el_type_ultimate_google_fonts');
	...
	var $next_fstyler = ultimate_vc_gfonts_field.next('.mcmsb_el_type_ultimate_google_fonts_style').find('.ultimate_fstyle');	
