...
;(function ( $, window, undefined ) {
  ...
  function init(t) {
    ...
    //  Clear the color
    t.find('.mcms-picker-clear').click(function(event) {
    ...
    /* = Color Picker  
     ----------------------------------------*/
    t.find(".ultimate-colorpicker").mcmsColorPicker();
  }
        ...
        if(typeof splitcols[2] != 'undefined' || splitcols[2] != null){
          ...
          if(sp[0]==did) {
            if( nd[0] !== 'transparent') {
              ...
              //t.find("a.mcms-color-result").css({"background-color": nd[0]});
              //   set alpha value
              ...
              t.find('.mcms-picker-container').find('.cs-alpha-slider-offset').css('background-color', nd[0]);
