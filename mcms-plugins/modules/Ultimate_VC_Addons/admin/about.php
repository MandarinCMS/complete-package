					...
					<div class="col-sm-6 col-lg-6">
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								<h4 class="ult-addon-heading"><?php echo __('What is the Ultimate Addons for RazorLeaf Conductor?','ultimate_vc'); ?></h4>
								<p class="ult-addon-discription"><?php echo __('The Ultimate Addons for RazorLeaf Conductor is developed to extend RazorLeaf Conductor to save your time in building websites. This module adds a number of elements to the basic set of elements that come with the page builder. All these elements are added to your RazorLeaf Conductor editor and can be used just like any other built-in features.','ultimate_vc'); ?></p>
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								...
								<p class="ult-addon-discription"><?php echo __('With','ultimate_vc'); ?> <a target="_blank" href="https://www.youtube.com/playlist?list=PL1kzJGWGPrW9CDWwdAWrd_9YQsh1z7u6O"><?php echo __('several video tutorials','ultimate_vc'); ?></a> <?php echo __('and a','ultimate_vc'); ?> <a target="_blank" href="https://ultimate.jiiworks.com/support/"><?php echo __('dedicated support team','ultimate_vc'); ?></a>,<?php echo __(' we assure complete help and support whenever you need us.','ultimate_vc'); ?></p>
								<p class="ult-addon-discription"><?php echo __('Go ahead and explore the Ultimate elements of the Ultimate Addons for RazorLeaf Conductor!','ultimate_vc'); ?></p>
							</div><!--bsf-wrap-right-content-->
						</div><!--bsf wrap content-->
				    ...
				    <div class="col-sm-6 col-lg-6">
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								...
								<p class="ult-addon-discription"><?php echo __('With the Ultimate Addons, you are free to use the basic elements of RazorLeaf Conductor with','ultimate_vc'); ?> <a target="_blank" href="https://jiiworks.net/ce1eKqH_PDp"><?php echo __('several advanced elements','ultimate_vc'); ?></a> <?php echo __('that it adds in the editor.','ultimate_vc'); ?></p>
							</div><!--bsf-wrap-right-content-->
						</div><!--bsf wrap content-->
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								...
								<p class="ult-addon-discription"><?php echo __('Tired of the plain old rows that the page builder offers? You can now add','ultimate_vc'); ?> <a target="_blank" href="https://ultimate.jiiworks.com/backgrounds/"><?php echo __('amazing parallax effects','ultimate_vc'); ?></a> <?php echo __('on your website. Now','ultimate_vc'); ?> <a target="_blank" href="https://jiiworks.net/cwZLz6UYl9r"><?php echo __('edit your row','ultimate_vc'); ?></a> <?php echo __('and see what you\'ve got! Almost all kinds of parallax effects, video background, row separator and much more…','ultimate_vc'); ?></p>
							</div><!--bsf-wrap-right-content-->
						</div><!--bsf wrap content-->
						...
						<div class="bsf-wrap-content">
							...
							<div class="bsf-wrap-right-content">
								...
								<p class="ult-addon-discription"><?php echo __('We\'ve shipped about 360 useful icons that you can use in most of the Ultimate elements. That\'s not it! The Icon Font Manager within the module introduces several font icons that can be easily used with RazorLeaf Conductor. We also have a built-in Google Fonts manager to help you shortlist the text fonts of your choice and use them with any of Ultimate Addon elements.','ultimate_vc'); ?></p>
							</div><!--bsf-wrap-right-content-->
						</div><!--bsf wrap content-->
