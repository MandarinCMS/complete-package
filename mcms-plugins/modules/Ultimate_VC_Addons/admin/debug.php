				...
				<?php if($author) : ?>
			        <div id="ultimate-debug" class="ult-tabs active-tab">
			            <form method="post" id="ultimate_debug_settings">
			            	<input type="hidden" name="security" value="<?php echo mcms_create_nonce( 'ultimate-debug-settings' ); ?>" />
			            	<input type="hidden" name="action" value="update_ultimate_debug_options" />
			            	<table class="form-table">
			        			<tbody>
			                    	<tr>
			                        	<th scope="row"><?php echo __('MySkin', 'ultimate_vc') ?></th>
			                            <td>
											<?php
			                        ...
			                        <?php
										...
										if($ultimate_ajax_myskin == 'enable')
											$ultimate_ajax_myskin = 'checked="checked"';
									?>
									<tr valign="top">
										<th scope="row"><?php echo __("Ajax","ultimate_vc"); ?></th>
										<td> <div class="onoffswitch">
										<input type="checkbox" <?php echo $ultimate_ajax_myskin; ?> id="ultimate_ajax_myskin" value="enable" class="onoffswitch-checkbox" name="ultimate_ajax_myskin" />
											 <label class="onoffswitch-label" for="ultimate_ajax_myskin">
												<div class="onoffswitch-inner">
													<div class="onoffswitch-active">
														<div class="onoffswitch-switch"><?php echo __('ON','ultimate_vc'); ?></div>
													</div>
			                        ...
			                        <?php
										...
										$myskin_dependant = '';
										if($ultimate_myskin_support == 'enable')
										{
											$ultimate_myskin_support = 'checked="checked"';
											$myskin_dependant = 'display:none;';
										}
									?>
			                        <tr valign="top">
										<th scope="row"><?php echo __("MySkin Support","ultimate_vc"); ?></th>
										<td> <div class="onoffswitch" id="ult-myskin-support-row">
										<input type="checkbox" <?php echo $ultimate_myskin_support; ?> id="ultimate_myskin_support" value="enable" class="onoffswitch-checkbox" name="ultimate_myskin_support" />
											 <label class="onoffswitch-label" for="ultimate_myskin_support">
												<div class="onoffswitch-inner">
													<div class="onoffswitch-active">
														<div class="onoffswitch-switch"><?php echo __('ON','ultimate_vc'); ?></div>
													</div>
									...
									?>
									<tr valign="top" class="ult-myskin-support-row-dependant" style="<?php echo $myskin_dependant; ?>">
...
jQuery(document).ready(function(e) {
	...
	jQuery('.onoffswitch').on('onUltimateSwitchClick',function(){
		setTimeout(function(){
			if(jQuery('#ultimate_myskin_support').is(':checked'))
			{
				jQuery('.ult-myskin-support-row-dependant').fadeOut(200);
			}
			else
			{
				jQuery('.ult-myskin-support-row-dependant').fadeIn(200);
			}
		},300);
	});
