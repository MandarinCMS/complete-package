...
<div class="wrap about-wrap bsf-page-wrapper ultimate-smooth-scroll bend">
  <div class="wrap-container">
    <div class="bend-heading-section ultimate-header">
      ...
      <h3><?php _e( "If optimized option is set to ON, a combined file for all modules in our module will be loaded on your website. Use this option if you use Ultimate Addons significantly on your website.", "ultimate_vc" ); ?></h3>
        ...
        <div class="col-md-12">
		    ...
		    <div id="css-settings" class="ult-tabs active-tab">
		        <form method="post" id="css_settings">
		        	<input type="hidden" name="security" value="<?php echo mcms_create_nonce( 'css-settings-setting' ); ?>" />
