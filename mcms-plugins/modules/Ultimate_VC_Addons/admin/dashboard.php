    ...
    <div id="post-body" class="metabox-holder columns-2">
      <div id="post-body-content" class="postbox-container">
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
          <div id="module_activation" class="postbox ">
          	<?php
      ...
      <div id="postbox-container-1" class="postbox-container updater-sidebar">
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
          <div id="module_activation_sidebar" class="postbox ">
            <h3 class="hndle">
            ...
            <div class="inside">
            	<div class="main" style="text-align: center;">
            		<ul class="sidebar-link-list">
	            		<!--<li><a href="https://www.jiiworks.com/support/forums/forum/ultimate-addons/" target="_blank" class="bsf-sidebar-link">Visit Support Forum</a></li>-->
						<li><a href="https://www.jiiworks.com/demos/ultimate/" target="_blank" class="bsf-sidebar-link">Ultimate Addons Website</a></li>
						<li><a href="http://jiiworks.com/support" target="_blank" class="bsf-sidebar-link"><?php echo __('Request Support','ultimate_vc'); ?></a></li>
                        <li><a href="https://www.jiiworks.com/support/mcms-admin/admin.php?page=site-registration" target="_blank" class="bsf-sidebar-link"><?php echo __('Manage License Registrations','ultimate_vc') ?></a></li>
					</ul>
					<ul class="sidebar-social-list">
						<li><a href="https://www.facebook.com/jiiworks" target="_blank" class="bsf-social-link"><span class="dashicons dashicons-facebook"></span></a></li>
						<li><a href="https://www.youtube.com/user/TheJiiWorks/videos" target="_blank" class="bsf-social-link"><span class="dashicons dashicons-video-alt3"></span></a></li>
						<li><a href="http://jiiworks.net/user/JiiWorks/portfolio?WT.ac=item_portfolio&WT.z_author=JiiWorks" target="_blank" class="bsf-social-link"><span class="dashicons dashicons-portfolio"></span></a></li>
					</ul>
                </div>
            </div>
          </div>
