		...
		function icon_manager($settings, $value)
		{
			...
			$output = '<div class="my_param_block">'
					 .'<input name="'.esc_attr( $settings['param_name'] ).'"
					  class="mcmsb_txt_icon_value mcmsb_vc_param_value mcmsb-textinput '. esc_attr( $settings['param_name'] ).' 
			...
			$output .= '<div class="mcmsb_txt_icons_block" data-old-icon-value="'.esc_attr( $pcnt ).'">'.$font_manager.'</div>';
			return $output;
		}
