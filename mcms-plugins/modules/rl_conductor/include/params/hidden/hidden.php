...
function vc_hidden_form_field( $settings, $value ) {
	...
	return '<input name="' . $settings['param_name'] . '" class="mcmsb_vc_param_value vc_hidden-field vc_param-name-' . $settings['param_name'] . ' ' . $settings['type'] . '" type="hidden" value="' . $value . '"/>';
}
