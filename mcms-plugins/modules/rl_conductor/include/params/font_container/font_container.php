...
class Vc_Font_Container {
	...
	public function render( $settings, $value ) {
		...
		if ( ! empty( $fields ) ) {
			if ( isset( $fields['tag'] ) ) {
                ...
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Element tag', 'rl_conductor' ) . '</div>
			...
			if ( isset( $fields['font_size'] ) ) {
				$data['font_size'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Font size', 'rl_conductor' ) . '</div>
			...
			if ( isset( $fields['text_align'] ) ) {
				$data['text_align'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Text align', 'rl_conductor' ) . '</div>
                    <div class="vc_font_container_form_field-text_align-container">
                        <select class="vc_font_container_form_field-text_align-select">
                            <option value="left" class="left" ' . ( 'left' === $values['text_align'] ? 'selected="selected"' : '' ) . '>' . __( 'left', 'rl_conductor' ) . '</option>
                            <option value="right" class="right" ' . ( 'right' === $values['text_align'] ? 'selected="selected"' : '' ) . '>' . __( 'right', 'rl_conductor' ) . '</option>
                            <option value="center" class="center" ' . ( 'center' === $values['text_align'] ? 'selected="selected"' : '' ) . '>' . __( 'center', 'rl_conductor' ) . '</option>
                            <option value="justify" class="justify" ' . ( 'justify' === $values['text_align'] ? 'selected="selected"' : '' ) . '>' . __( 'justify', 'rl_conductor' ) . '</option>
                        </select>
                    </div>';
			...
			if ( isset( $fields['line_height'] ) ) {
				$data['line_height'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Line height', 'rl_conductor' ) . '</div>
			...
			if ( isset( $fields['color'] ) ) {
				$data['color'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Text color', 'rl_conductor' ) . '</div>
			...
			if ( isset( $fields['font_family'] ) ) {
				$data['font_family'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Font Family', 'rl_conductor' ) . '</div>
			...
			if ( isset( $fields['font_style'] ) ) {
				$data['font_style'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="mcmsb_element_label">' . __( 'Font style', 'rl_conductor' ) . '</div>
                    <div class="vc_font_container_form_field-font_style-container">
                        <label>
                            <input type="checkbox" class="vc_font_container_form_field-font_style-checkbox italic" value="italic" ' . ( '1' === $values['font_style_italic'] ? 'checked' : '' ) . '><span class="vc_font_container_form_field-font_style-label italic">' . __( 'italic', 'rl_conductor' ) . '</span>
                         </label>
                        <br />
                        <label>
                            <input type="checkbox" class="vc_font_container_form_field-font_style-checkbox bold" value="bold" ' . ( '1' === $values['font_style_bold'] ? 'checked' : '' ) . '><span class="vc_font_container_form_field-font_style-label bold">' . __( 'bold', 'rl_conductor' ) . '</span>
                        </label>
                    </div>';
		...
		$output .= '<input name="' . $settings['param_name'] . '" class="mcmsb_vc_param_value  ' . $settings['param_name'] . ' ' . $settings['type'] . '_field" type="hidden" value="' . $value . '" />';
