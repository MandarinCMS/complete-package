...
class Vc_Grid_Item_Preview {
	...
	public function enqueue() {
		...
		VcShortcodeAutoloader::getInstance()->includeClass( 'MCMSBakeryShortCode_VC_Basic_Grid' );

		$grid = new MCMSBakeryShortCode_VC_Basic_Grid( array( 'base' => 'vc_basic_grid' ) );
	...
	public function mockingPost() {
		...
		setup_postdata( $post );
		$post->post_title = __( 'Post title', 'rl_conductor' );
		$post->post_content = __( 'The MandarinCMS Excerpt is an optional summary or description of a post; in short, a post summary.', 'rl_conductor' );
		$post->post_excerpt = __( 'The MandarinCMS Excerpt is an optional summary or description of a post; in short, a post summary.', 'rl_conductor' );
