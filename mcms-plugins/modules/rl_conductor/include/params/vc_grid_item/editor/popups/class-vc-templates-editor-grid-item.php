...
class Vc_Templates_Editor_Grid_Item extends Vc_Templates_Panel_Editor {
	...
	protected function renderTemplateWindowGridTemplate( $templateName, $templateData ) {
		...
		$previewTemplateTitle = esc_attr( 'Preview template', 'rl_conductor' );
		$addTemplateTitle = esc_attr( 'Preview template', 'rl_conductor' );
	...
	public function getAllTemplates() {
		...
		if ( ! empty( $grid_templates ) ) {
			$arr_category = array(
				...
				'category_name' => __( 'Grid Templates', 'rl_conductor' ),
				'category_weight' => 10,
			);
		...
		if ( ! empty( $custom_grid_templates ) ) {
			$arr_category = array(
				...
				'category_name' => __( 'Custom Grid Templates', 'rl_conductor' ),
				'category_weight' => 10,
			);
			$category_templates = array();
