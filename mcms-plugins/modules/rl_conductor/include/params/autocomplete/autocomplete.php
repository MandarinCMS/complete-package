...
class Vc_AutoComplete {
	...
	public function render() {
		...
		$output .= '<li class="vc_autocomplete-input"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span><input class="vc_auto_complete_param" type="text" placeholder="' . __( 'Click here and start typing...', 'rl_conductor' ) . '" value="' . $this->value . '" autocomplete="off"></li>' .
		           '<li class="vc_autocomplete-clear"></li>' .
		           '</ul>';

		$output .= '<input name="' .
		           $this->settings['param_name'] .
		           '" class="mcmsb_vc_param_value  ' .
		           $this->settings['param_name'] . ' ' .
...
/**
 * @action mcms_ajax_vc_get_autocomplete_suggestion - since 4.4 used to hook ajax requests for autocomplete suggestions
 */
add_action( 'mcms_ajax_vc_get_autocomplete_suggestion', 'vc_get_autocomplete_suggestion' );
/**
 * @since 4.4
 */
...
/*	vc_map(
	    array(
			'name'        => __( 'Check autocomplete', 'rl_conductor' ),
			'base'        => 'vc_some_autocomplete',
			'icon'        => 'icon-mcmsb-empty_space',
			'category'    => __( 'New Elements', 'rl_conductor' ),
			'description' => __( 'Something cool and best', 'rl_conductor' ),
			'params'      => array(
				array(
					'type'        => 'autocomplete',
					'heading'     => __( 'Type a for example', 'rl_conductor' ),
					'param_name'  => 'ids',
					'settings'    => array(
						'multiple' => true,
						'sortable' => true,
	...
	See \rl_conductor\include\classes\vendors\modules\class-vc-vendor-woocommerce.php
	vc_map( array(
