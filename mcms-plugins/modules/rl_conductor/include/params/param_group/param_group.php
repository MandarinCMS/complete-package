...
class Vc_ParamGroup {
	...
	public function render() {
		...
		$output .= '<li class="mcmsb_column_container vc_container_for_children vc_param_group-add_content vc_empty-container"></li></ul>';
		...
		$output .= '<input name="' . $this->settings['param_name'] . '" class="mcmsb_vc_param_value  ' . $this->settings['param_name'] . ' ' . $this->settings['type'] . '_field" type="hidden" value="' . $this->unparsed_value . '" />';
...
add_action( 'mcms_ajax_vc_param_group_clone', 'vc_param_group_clone' );
