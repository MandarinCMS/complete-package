...
class Vc_IconPicker {
	 ...
	 * mcms-content/modules/rl_conductor/assets/js/params/composer-atts.js init
	 * method
	...
	protected function setDefaults() {
		...
		if ( ! isset( $this->settings['settings'], $this->settings['settings']['allCategoryText'] ) ) {
			...
			$this->settings['settings']['allCategoryText'] = __( 'From all categories', 'rl_conductor' );
		}
		if ( ! isset( $this->settings['settings'], $this->settings['settings']['unCategorizedText'] ) ) {
			// If categorized then use this option
			$this->settings['settings']['unCategorizedText'] = __( 'Uncategorized', 'rl_conductor' );
		}
	 ...
	 * mcms-content/modules/rl_conductor/include/autoload/hook-vc-iconpicker-param.php
	 * folder
	 * @since 4.4
	...
	public function render() {
		...
		$output .= '<input name="' . esc_attr( $this->settings['param_name'] ) . '" class="mcmsb_vc_param_value  ' . esc_attr( $this->settings['param_name'] ) . ' ' . esc_attr( $this->settings['type'] ) . '_field" type="hidden" value="' . esc_attr( $this->value ) . '" ' . ( ( isset( $this->settings['settings'] ) && ! empty( $this->settings['settings'] ) ) ? ' data-settings="' . esc_attr( json_encode( $this->settings['settings'] ) ) . '" ' : '' ) . ' />';
...
function vc_iconpicker_type_fontawesome( $icons ) {
	...
	$fontawesome_icons = array(
		'New in 4.6' => array(
			...
			array( 'fa fa-mcmsbeginner' => 'MCMSBeginner' ),
			array( 'fa fa-mcmsforms' => 'MCMSForms' ),
			...
			array( 'fa fa-myskinisle' => 'MySkinIsle' ),
		...
		'Brand Icons' => array(
			...
			array( 'fa fa-mandarincms' => 'MandarinCMS Logo' ),
...
function vc_iconpicker_type_monosocial( $icons ) {
	$monosocial = array(
		...
		array( 'vc-mono vc-mono-mandarincms' => 'MandarinCMS' ),
