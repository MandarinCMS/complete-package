...
// @see Vc_Backend_Editor::printScriptsMessages (mcms-content/modules/rl_conductor/include/classes/editors/class-vc-backend-editor.php),
...
// @see Vc_Frontend_Editor::enqueueAdmin (mcms-content/modules/rl_conductor/include/classes/editors/class-vc-frontend-editor.php),
...
function vc_iconpicker_base_register_css() {
	...
	mcms_register_style( 'vc_typicons', vc_asset_url( 'css/lib/typicons/src/font/typicons.min.css' ), false, MCMSB_VC_VERSION );
	mcms_register_style( 'vc_openiconic', vc_asset_url( 'css/lib/vc-open-iconic/vc_openiconic.min.css' ), false, MCMSB_VC_VERSION );
	mcms_register_style( 'vc_linecons', vc_asset_url( 'css/lib/vc-linecons/vc_linecons_icons.min.css' ), false, MCMSB_VC_VERSION );
	mcms_register_style( 'vc_entypo', vc_asset_url( 'css/lib/vc-entypo/vc_entypo.min.css' ), false, MCMSB_VC_VERSION );
	mcms_register_style( 'vc_monosocialiconsfont', vc_asset_url( 'css/lib/monosocialiconsfont/monosocialiconsfont.min.css' ), false, MCMSB_VC_VERSION );
	mcms_register_style( 'vc_material', vc_asset_url( 'css/lib/vc-material/vc_material.min.css' ), false, MCMSB_VC_VERSION );
	// MySkin
	mcms_register_style( 'vc-icon-picker-main-css', vc_asset_url( 'lib/bower/vcIconPicker/css/jquery.fonticonpicker.min.css' ), false, MCMSB_VC_VERSION );
	mcms_register_style( 'vc-icon-picker-main-css-myskin', vc_asset_url( 'lib/bower/vcIconPicker/myskins/grey-myskin/jquery.fonticonpicker.vcgrey.min.css' ), false, MCMSB_VC_VERSION );
}
...
function vc_iconpicker_base_register_js() {
	mcms_register_script( 'vc-icon-picker', vc_asset_url( 'lib/bower/vcIconPicker/jquery.fonticonpicker.min.js' ), array( 'jquery' ), MCMSB_VC_VERSION );
}
...
function vc_iconpicker_editor_jscss() {
	// Enqueue js and myskin css files
	mcms_enqueue_script( 'vc-icon-picker' );
	mcms_enqueue_style( 'vc-icon-picker-main-css' );
	mcms_enqueue_style( 'vc-icon-picker-main-css-myskin' );
