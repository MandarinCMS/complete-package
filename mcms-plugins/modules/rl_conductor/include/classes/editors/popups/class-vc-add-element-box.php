...
class Vc_Add_Element_Box implements Vc_Render {
	...
	public function shortcodes() {
		return MCMSBMap::getSortedUserShortCodes();
	}
	 ...
	 * @see MCMSBMap::getSortedUserShortCodes
	 * @return mixed|void
	 */
	public function getControls() {
		$output = '<ul class="mcmsb-content-layouts">';
		/** @var array $element */
		$buttons_count = 0;
	...
	public function getCategories() {
		return MCMSBMap::getUserCategories();
	}
