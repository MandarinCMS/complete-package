...
/**
 * Class Vc_Vendor_MCMSML
 * @since 4.9
 */
class Vc_Vendor_MCMSML implements Vc_Vendor_Interface {
	...
	public function load() {
		...
		if ( vc_is_page_editable() && 'vc_frontend_load_template' === $action ) {
			...
			remove_action( 'mcms_loaded', array( $sitepress, 'maybe_set_this_lang' ) );
		}
	}
	...
	public function filterMediaId( $id ) {
		return apply_filters( 'mcmsml_object_id', $id, 'post', true );
	}
}
