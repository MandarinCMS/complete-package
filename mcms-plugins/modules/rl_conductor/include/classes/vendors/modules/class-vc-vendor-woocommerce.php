...
class Vc_Vendor_Woocommerce implements Vc_Vendor_Interface {
	...
	public function enqueueJsBackend() {
		mcms_enqueue_script( 'vc_vendor_woocommerce_backend', vc_asset_url( 'js/vendors/woocommerce.js' ), array( 'vc-backend-min-js' ), '1.0', true );
	}
	...
	public function enqueueJsFrontend() {
		mcms_enqueue_script( 'vc_vendor_woocommerce_frontend', vc_asset_url( 'js/vendors/woocommerce.js' ), array( 'vc-frontend-editor-min-js' ), '1.0', true );
	}
	...
	public function addShortcodeSettings( $tag ) {
		...
		switch ( $tag ) {
			case 'woocommerce_cart':
				$settings = array(
					'name' => __( 'Cart', 'rl_conductor' ),
					'base' => 'woocommerce_cart',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Displays the cart contents', 'rl_conductor' ),
			...
			case 'woocommerce_checkout':
				 ...
				 */
				$settings = array(
					'name' => __( 'Checkout', 'rl_conductor' ),
					'base' => 'woocommerce_checkout',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Displays the checkout', 'rl_conductor' ),
					'show_settings_on_create' => false,
					'php_class_name' => 'Vc_WooCommerce_NotEditable',
				);
				break;
			case 'woocommerce_order_tracking':
				 ...
				 */
				$settings = array(
					'name' => __( 'Order Tracking Form', 'rl_conductor' ),
					'base' => 'woocommerce_order_tracking',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Lets a user see the status of an order', 'rl_conductor' ),
					'show_settings_on_create' => false,
					'php_class_name' => 'Vc_WooCommerce_NotEditable',
				);
				break;
			case 'woocommerce_my_account':
				 ...
				 */
				$settings = array(
					'name' => __( 'My Account', 'rl_conductor' ),
					'base' => 'woocommerce_my_account',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Shows the "my account" section', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Order count', 'rl_conductor' ),
							'value' => 15,
							'save_always' => true,
							'param_name' => 'order_count',
							'description' => __( 'You can specify the number or order to show, it\'s set by default to 15 (use -1 to display all orders.)', 'rl_conductor' ),
						),
					),
				);
				break;
			case 'recent_products':
				 ...
				 * To learn more about the default ‘orderby’ parameters please reference the MandarinCMS Codex: http://codex.mandarincms.com/Class_Reference/MCMS_Query
				 *
				 ...
				 */
				$settings = array(
					'name' => __( 'Recent products', 'rl_conductor' ),
					'base' => 'recent_products',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Lists recent products', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
							'value' => 12,
							'save_always' => true,
							'param_name' => 'per_page',
							'description' => __( 'The "per_page" shortcode determines how many products to show on the page', 'rl_conductor' ),
						),
						array(
							'type' => 'textfield',
							'heading' => __( 'Columns', 'rl_conductor' ),
							'value' => 4,
							'param_name' => 'columns',
							'save_always' => true,
							'description' => __( 'The columns attribute controls how many columns wide the products should be before wrapping.', 'rl_conductor' ),
						),
						array(
							'type' => 'dropdown',
							...
							'save_always' => true,
							'description' => sprintf( __( 'Select how to sort retrieved products. More at %s.', 'rl_conductor' ), '<a href="http://codex.mandarincms.com/Class_Reference/MCMS_Query#Order_.26_Orderby_Parameters" target="_blank">MandarinCMS codex page</a>' ),
						),
						array(
							'type' => 'dropdown',
							...
							'save_always' => true,
							'description' => sprintf( __( 'Designates the ascending or descending order. More at %s.', 'rl_conductor' ), '<a href="http://codex.mandarincms.com/Class_Reference/MCMS_Query#Order_.26_Orderby_Parameters" target="_blank">MandarinCMS codex page</a>' ),
						),
					),
				);
				break;
			case 'featured_products':
				 ...
				 */
				$settings = array(
					'name' => __( 'Featured products', 'rl_conductor' ),
					'base' => 'featured_products',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Display products set as "featured"', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
			...
			case 'product':
				 ...
				 */
				$settings = array(
					'name' => __( 'Product', 'rl_conductor' ),
					'base' => 'product',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Show a single product by ID or SKU', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'autocomplete',
							'heading' => __( 'Select identificator', 'rl_conductor' ),
							'param_name' => 'id',
							'description' => __( 'Input product ID or product SKU or product title to see suggestions', 'rl_conductor' ),
						),
						array(
							'type' => 'hidden',
			...
			case 'products':
				$settings = array(
					'name' => __( 'Products', 'rl_conductor' ),
					'base' => 'products',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Show multiple products by ID or SKU.', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Columns', 'rl_conductor' ),
						...
						array(
							...
							'std' => 'title',
							'save_always' => true,
							'description' => sprintf( __( 'Select how to sort retrieved products. More at %s. Default by Title', 'rl_conductor' ), '<a href="http://codex.mandarincms.com/Class_Reference/MCMS_Query#Order_.26_Orderby_Parameters" target="_blank">MandarinCMS codex page</a>' ),
						),
						array(
							'type' => 'dropdown',
							'heading' => __( 'Sort order', 'rl_conductor' ),
							...
							'value' => $order_way_values,
							'save_always' => true,
							'description' => sprintf( __( 'Designates the ascending or descending order. More at %s. Default by ASC', 'rl_conductor' ), '<a href="http://codex.mandarincms.com/Class_Reference/MCMS_Query#Order_.26_Orderby_Parameters" target="_blank">MandarinCMS codex page</a>' ),
						),
						array(
							'type' => 'autocomplete',
							'heading' => __( 'Products', 'rl_conductor' ),
							'param_name' => 'ids',
							'settings' => array(
								'multiple' => true,
								'sortable' => true,
							...
							'save_always' => true,
							'description' => __( 'Enter List of Products', 'rl_conductor' ),
						),
						array(
							'type' => 'hidden',
							'param_name' => 'skus',
			...
			case 'add_to_cart':
				 ...
				 */
				$settings = array(
					'name' => __( 'Add to cart', 'rl_conductor' ),
					'base' => 'add_to_cart',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Show multiple products by ID or SKU', 'rl_conductor' ),
					'params' => array(
						...
						array(
							'type' => 'textfield',
							'heading' => __( 'Wrapper inline style', 'rl_conductor' ),
							'param_name' => 'style',
						),
					),
				);
			...
			case 'add_to_cart_url':
				 ...
				 */
				$settings = array(
					'name' => __( 'Add to cart URL', 'rl_conductor' ),
					'base' => 'add_to_cart_url',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Show URL on the add to cart button', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'autocomplete',
							'heading' => __( 'Select identificator', 'rl_conductor' ),
			...
			case 'product_page':
				 ...
				 */
				$settings = array(
					'name' => __( 'Product page', 'rl_conductor' ),
					'base' => 'product_page',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Show single product by ID or SKU', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'autocomplete',
							'heading' => __( 'Select identificator', 'rl_conductor' ),
			...
			case 'product_category':
				...
				$settings = array(
					'name' => __( 'Product category', 'rl_conductor' ),
					'base' => 'product_category',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Show multiple products in a category', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
							...
							'save_always' => true,
							'param_name' => 'per_page',
							'description' => __( 'How much items per page to show', 'rl_conductor' ),
						),
						array(
							'type' => 'textfield',
							'heading' => __( 'Columns', 'rl_conductor' ),
							...
							'save_always' => true,
							'param_name' => 'columns',
							'description' => __( 'How much columns grid', 'rl_conductor' ),
						),
						array(
							'type' => 'dropdown',
							'heading' => __( 'Order by', 'rl_conductor' ),
						...
						array(
							'type' => 'dropdown',
							'heading' => __( 'Category', 'rl_conductor' ),
							'value' => $product_categories_dropdown,
							'param_name' => 'category',
							'save_always' => true,
							'description' => __( 'Product category list', 'rl_conductor' ),
						),
					),
				);
				break;
			case 'product_categories':
				$settings = array(
					'name' => __( 'Product categories', 'rl_conductor' ),
					'base' => 'product_categories',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'Display product categories loop', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Number', 'rl_conductor' ),
							'param_name' => 'number',
							'description' => __( 'The `number` field is used to display the number of products.', 'rl_conductor' ),
						),
						array(
							'type' => 'dropdown',
							'heading' => __( 'Order by', 'rl_conductor' ),
						...
						array(
							...
							'description' => __( 'Hide empty', 'rl_conductor' ),
						),
						array(
							'type' => 'autocomplete',
							...
							'save_always' => true,
							'description' => __( 'List of product categories', 'rl_conductor' ),
						),
					),
				);
				break;
			case 'sale_products':
				 ...
				 */
				$settings = array(
					'name' => __( 'Sale products', 'rl_conductor' ),
					'base' => 'sale_products',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'List all products on sale', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
			...
			case 'best_selling_products':
				 ...
				 */
				$settings = array(
					'name' => __( 'Best Selling Products', 'rl_conductor' ),
					'base' => 'best_selling_products',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'List best selling products on sale', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
			...
			case 'top_rated_products':
				 ...
				 */
				$settings = array(
					'name' => __( 'Top Rated Products', 'rl_conductor' ),
			...
			case 'product_attribute':
				...
				$settings = array(
					'name' => __( 'Product Attribute', 'rl_conductor' ),
					'base' => 'product_attribute',
					'icon' => 'icon-mcmsb-woocommerce',
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'List products with an attribute shortcode', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
						...
						array(
							'type' => 'dropdown',
							'heading' => __( 'Attribute', 'rl_conductor' ),
							'param_name' => 'attribute',
							'value' => $attributes,
							'save_always' => true,
							'description' => __( 'List of product taxonomy attribute', 'rl_conductor' ),
						),
						array(
							'type' => 'checkbox',
							'heading' => __( 'Filter', 'rl_conductor' ),
							'param_name' => 'filter',
							'value' => array( 'empty' => 'empty' ),
							'save_always' => true,
							'description' => __( 'Taxonomy values', 'rl_conductor' ),
							'dependency' => array(
			...
			case 'related_products':
				...
				$settings = array(
					'name' => __( 'Related Products', 'rl_conductor' ),
					'base' => 'related_products',
					'icon' => 'icon-mcmsb-woocommerce',
					'content_element' => 'product' === $post_type,
					// disable showing if not product type
					'category' => __( 'WooCommerce', 'rl_conductor' ),
					'description' => __( 'List related products', 'rl_conductor' ),
					'params' => array(
						array(
							'type' => 'textfield',
							'heading' => __( 'Per page', 'rl_conductor' ),
							...
							'save_always' => true,
							'param_name' => 'per_page',
							'description' => __( 'Please note: the "per_page" shortcode argument will determine how many products are shown on a page. This will not add pagination to the shortcode. ', 'rl_conductor' ),
						),
						array(
							'type' => 'textfield',
							'heading' => __( 'Columns', 'rl_conductor' ),
	...
	public function mapShortcodes() {
		add_action( 'mcms_ajax_vc_woocommerce_get_attribute_terms', array(
			&$this,
	...
	public function mapGridItemShortcodes( array $shortcodes ) {
		require_once vc_path_dir( 'VENDORS_DIR', 'modules/woocommerce/class-vc-gitem-woocommerce-shortcode.php' );
		require_once vc_path_dir( 'VENDORS_DIR', 'modules/woocommerce/grid-item-attributes.php' );
		$wc_shortcodes = include vc_path_dir( 'VENDORS_DIR', 'modules/woocommerce/grid-item-shortcodes.php' );
	...
	public function getAttributeTermsAjax() {
		...
		foreach ( $values as $label => $v ) {
			$param_line .= ' <label class="vc_checkbox-label"><input id="' . $param['param_name'] . '-' . $v . '" value="' . $v . '" class="mcmsb_vc_param_value ' . $param['param_name'] . ' ' . $param['type'] . '" type="checkbox" name="' . $param['param_name'] . '"' . '> ' . $label . '</label>';
		}
	...
	public function productIdAutocompleteSuggester( $query ) {
		...
		$post_meta_infos = $mcmsdb->get_results( $mcmsdb->prepare( "SELECT a.ID AS id, a.post_title AS title, b.meta_value AS sku
					FROM {$mcmsdb->posts} AS a
					LEFT JOIN ( SELECT meta_value, post_id  FROM {$mcmsdb->postmeta} WHERE `meta_key` = '_sku' ) AS b ON b.post_id = a.ID
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data = array();
				$data['value'] = $value['id'];
				$data['label'] = __( 'Id', 'rl_conductor' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . __( 'Title', 'rl_conductor' ) . ': ' . $value['title'] : '' ) . ( ( strlen( $value['sku'] ) > 0 ) ? ' - ' . __( 'Sku', 'rl_conductor' ) . ': ' . $value['sku'] : '' );
				$results[] = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $product_object ) ) {
				...
				if ( ! empty( $product_sku ) ) {
					$product_sku_display = ' - ' . __( 'Sku', 'rl_conductor' ) . ': ' . $product_sku;
				}

				$product_title_display = '';
				if ( ! empty( $product_title ) ) {
					$product_title_display = ' - ' . __( 'Title', 'rl_conductor' ) . ': ' . $product_title;
				}

				$product_id_display = __( 'Id', 'rl_conductor' ) . ': ' . $product_id;
	...
	public function productIdAutocompleteSuggesterExactSku( $query ) {
		global $mcmsdb;
		$query = trim( $query );
		$product_id = $mcmsdb->get_var( $mcmsdb->prepare( "SELECT post_id FROM {$mcmsdb->postmeta} WHERE meta_key='_sku' AND meta_value='%s' LIMIT 1", stripslashes( $query ) ) );
	...
	public function productCategoryCategoryAutocompleteSuggester( $query, $slug = false ) {
		...
		$cat_id = (int) $query;
		$query = trim( $query );
		$post_meta_infos = $mcmsdb->get_results( $mcmsdb->prepare( "SELECT a.term_id AS id, b.name as name, b.slug AS slug
						FROM {$mcmsdb->term_taxonomy} AS a
						INNER JOIN {$mcmsdb->terms} AS b ON b.term_id = a.term_id
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = __( 'Id', 'rl_conductor' ) . ': ' . $value['id'] . ( ( strlen( $value['name'] ) > 0 ) ? ' - ' . __( 'Name', 'rl_conductor' ) . ': ' . $value['name'] : '' ) . ( ( strlen( $value['slug'] ) > 0 ) ? ' - ' . __( 'Slug', 'rl_conductor' ) . ': ' . $value['slug'] : '' );
				$result[] = $data;
			}
		}
	...
	protected function productCategoryTermOutput( $term ) {
		...
		$term_slug_display = '';
		if ( ! empty( $term_slug ) ) {
			$term_slug_display = ' - ' . __( 'Sku', 'rl_conductor' ) . ': ' . $term_slug;
		}

		$term_title_display = '';
		if ( ! empty( $term_title ) ) {
			$term_title_display = ' - ' . __( 'Title', 'rl_conductor' ) . ': ' . $term_title;
		}

		$term_id_display = __( 'Id', 'rl_conductor' ) . ': ' . $term_id;
	...
	public static function getProductsFieldsList() {
		return array(
			__( 'SKU', 'rl_conductor' ) => 'sku',
			__( 'ID', 'rl_conductor' ) => 'id',
			__( 'Price', 'rl_conductor' ) => 'price',
			__( 'Regular Price', 'rl_conductor' ) => 'regular_price',
			__( 'Sale Price', 'rl_conductor' ) => 'sale_price',
			__( 'Price html', 'rl_conductor' ) => 'price_html',
			__( 'Reviews count', 'rl_conductor' ) => 'reviews_count',
			__( 'Short description', 'rl_conductor' ) => 'short_description',
			__( 'Dimensions', 'rl_conductor' ) => 'dimensions',
			__( 'Rating count', 'rl_conductor' ) => 'rating_count',
			__( 'Weight', 'rl_conductor' ) => 'weight',
			__( 'Is on sale', 'rl_conductor' ) => 'on_sale',
			__( 'Custom field', 'rl_conductor' ) => '_custom_',
		);
	}
	...
	public static function getOrderFieldsList() {
		return array(
			__( 'ID', 'rl_conductor' ) => 'id',
			__( 'Order number', 'rl_conductor' ) => 'order_number',
			__( 'Currency', 'rl_conductor' ) => 'order_currency',
			__( 'Total', 'rl_conductor' ) => 'total',
			__( 'Status', 'rl_conductor' ) => 'status',
			__( 'Payment method', 'rl_conductor' ) => 'payment_method',
			__( 'Billing address city', 'rl_conductor' ) => 'billing_address_city',
			__( 'Billing address country', 'rl_conductor' ) => 'billing_address_country',
			__( 'Shipping address city', 'rl_conductor' ) => 'shipping_address_city',
			__( 'Shipping address country', 'rl_conductor' ) => 'shipping_address_country',
			__( 'Customer Note', 'rl_conductor' ) => 'customer_note',
			__( 'Customer API', 'rl_conductor' ) => 'customer_api',
			__( 'Custom field', 'rl_conductor' ) => '_custom_',
		);
	}
	...
	public function yoastSeoCompatibility() {
		if ( function_exists( 'WC' ) ) {
			...
			include_once( WC()->module_path() . '/includes/wc-template-functions.php' );
			// include_once WC()->module_path() . '';
		}
	}
}
 ...
 * @since 4.4
 */
class Vc_WooCommerce_NotEditable extends MCMSBakeryShortCode {
	/**
	 * @since 4.4
	 * @var array
	 */
