...
/*** RazorLeaf Conductor Content elements refresh ***/
class VcSharedLibrary {
	// Here we will store module wise (shared) settings. Colors, Locations, Sizes, etc...
	/**
	 * @var array
	 */
	...
	public static function getColorsDashed() {
		$colors = array(
			__( 'Blue', 'rl_conductor' ) => 'blue',
			__( 'Turquoise', 'rl_conductor' ) => 'turquoise',
			__( 'Pink', 'rl_conductor' ) => 'pink',
			__( 'Violet', 'rl_conductor' ) => 'violet',
			__( 'Peacoc', 'rl_conductor' ) => 'peacoc',
			__( 'Chino', 'rl_conductor' ) => 'chino',
			__( 'Mulled Wine', 'rl_conductor' ) => 'mulled-wine',
			__( 'Vista Blue', 'rl_conductor' ) => 'vista-blue',
			__( 'Black', 'rl_conductor' ) => 'black',
			__( 'Grey', 'rl_conductor' ) => 'grey',
			__( 'Orange', 'rl_conductor' ) => 'orange',
			__( 'Sky', 'rl_conductor' ) => 'sky',
			__( 'Green', 'rl_conductor' ) => 'green',
			__( 'Juicy pink', 'rl_conductor' ) => 'juicy-pink',
			__( 'Sandy brown', 'rl_conductor' ) => 'sandy-brown',
			__( 'Purple', 'rl_conductor' ) => 'purple',
			__( 'White', 'rl_conductor' ) => 'white',
		);
