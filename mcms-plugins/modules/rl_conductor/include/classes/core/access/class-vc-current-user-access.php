...
class Vc_Current_User_Access extends Vc_Role_Access {
	...
	public function mcmsMulti( $method, $valid, $argsList ) {
	 ...
	 */
	public function mcmsAny() {
		if ( $this->getValidAccess() ) {
			$args = func_get_args();
			$this->mcmsMulti( 'check', true, $args );
		}
	 ...
	 * @return Vc_Current_User_Access
	 */
	public function mcmsAll() {
		if ( $this->getValidAccess() ) {
			$args = func_get_args();
			$this->mcmsMulti( 'check', false, $args );
		}
