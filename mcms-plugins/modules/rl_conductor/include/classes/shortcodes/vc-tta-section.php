...
class MCMSBakeryShortCode_VC_Tta_Section extends MCMSBakeryShortCode_VC_Tta_Accordion {
	protected $controls_css_settings = 'tc vc_control-container';
	protected $controls_list = array( 'add', 'edit', 'clone', 'delete' );
	protected $backened_editor_prepend_controls = false;
	/**
	 * @var MCMSBakeryShortCode_VC_Tta_Accordion
	 */
	...
	public function getParamContent( $atts, $content ) {
		return mcmsb_js_remove_mcmsautop( $content );
	}
