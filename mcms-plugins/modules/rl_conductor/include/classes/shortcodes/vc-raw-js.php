...
class MCMSBakeryShortCode_VC_Raw_js extends MCMSBakeryShortCode_VC_Raw_html {
	...
	protected function contentInline( $atts, $content = null ) {
		...
		$el_class .= ' mcmsb_raw_js';
		$content = rawurldecode( base64_decode( strip_tags( $content ) ) );
		$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'mcmsb_raw_code' . $el_class, $this->settings['base'], $atts );
