...
VcShortcodeAutoloader::getInstance()->includeClass( 'MCMSBakeryShortCode_VC_Tta_Accordion' );

class MCMSBakeryShortCode_VC_Tta_Tabs extends MCMSBakeryShortCode_VC_Tta_Accordion {

	public $layout = 'tabs';

	public function enqueueTtaScript() {
		mcms_register_script( 'vc_tabs_script', vc_asset_url( 'lib/vc_tabs/vc-tabs.min.js' ), array( 'vc_accordion_script' ), MCMSB_VC_VERSION, true );
		parent::enqueueTtaScript();
		mcms_enqueue_script( 'vc_tabs_script' );
	}
