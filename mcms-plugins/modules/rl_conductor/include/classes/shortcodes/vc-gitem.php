...
class MCMSBakeryShortCode_VC_Gitem extends MCMSBakeryShortCodesContainer {
	...
	public function mainHtmlBlockParams( $width, $i ) {
		...
		return 'data-element_type="' . $this->settings['base'] . '" class="' . $this->settings['base'] . '-shortcode ' . $sortable . ' mcmsb_content_holder vc_shortcodes_container"' . $this->customAdminBlockParams();
	}
	...
	public function getControls( $controls ) {
		...
		foreach ( $controls as $control ) {
			switch ( $control ) {
				case 'add':
					if ( $allAccess ) {
						$buttons[] = '<a class="vc_control-btn vc_control-btn-add" href="#" title="' . __( 'Add to this grid item', 'rl_conductor' ) . '" data-vc-control="add"><i class="vc_icon"></i></a>';
					}
					break;

				case 'edit':
					if ( $editAccess ) {
						$buttons[] = '<a class="vc_control-btn vc_control-btn-edit" href="#" title="' . __( 'Edit this grid item', 'rl_conductor' ) . '" data-vc-control="edit"><i class="vc_icon"></i></a>';
					}
					break;

				case 'delete':
					if ( $allAccess ) {
						$buttons[] = '<a class="vc_control-btn vc_control-btn-delete" href="#" title="' . __( 'Delete this grid item ', 'rl_conductor' ) . '" data-vc-control="delete"><i class="vc_icon"></i></a>';
					}
					break;
			}
		}
