		...
		<tr data-vc-role-related-part="<?php echo esc_attr( $part . '-' . $role ) ?>"
			...
			<td>
				<fieldset>
					...
					<?php endif; ?>
					<table class="vc_general vc_mcms-form-table fixed" data-vc-roles="table">
						<thead>
						<tr>
						...
						<?php foreach ( $capabilities as $cap ) : ?>
							<?php if ( ! isset( $ignore_capabilities ) || ! in_array( $cap['base'], $ignore_capabilities ) ) : ?>
								...
								<tr data-vc-capability="<?php echo esc_attr( $cap['base'] ) ?>"
									...
									<?php foreach ( $cap_types as $type ) : ?>
										<td>
											<div class="vc_mcms-form-checkbox">
												<label>
													<input type="checkbox"
		...
		<tr data-vc-role-related-part="<?php echo esc_attr( $part . '-' . $role ) ?>"
			...
			<td>
				<fieldset>
					...
					<div class="vc_mcms-form-row">
						<?php foreach ( $capabilities as $cap ) : ?>
							<div class="vc_mcms-form-col vc_mcms-form-checkbox">
								<label>
									<input type="checkbox"
