...
vc_include_template( 'pages/partials/vc-roles-parts/_part.tpl.php', array(
	...
	'main_label' => __( 'Grid Builder', 'rl_conductor' ),
	'custom_label' => __( 'Grid Builder', 'rl_conductor' ),
	'description' => __( 'Control user access to Grid Builder and Grid Builder Elements.', 'rl_conductor' ),
) );
