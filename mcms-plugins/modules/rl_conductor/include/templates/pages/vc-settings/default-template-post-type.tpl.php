...
<fieldset>
	...
	<table class="vc_general vc_mcms-form-table fixed">
		<thead>
		<tr>
			<th><?php _e( 'Post type', 'rl_conductor' ) ?></th>
			<th><?php _e( 'Template', 'rl_conductor' ) ?></th>
		</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td>
					<select name="<?php echo $field_key ?>[<?php echo $post_type[0] ?>]">
						<option value=""><?php _e( 'None', 'rl_conductor' ) ?></option>
