...
<div<?php echo $inline_css; ?> class="<?php echo esc_attr( trim( $css_class ) ); ?>">
	...
	<?php if ( '' !== $h2 || '' !== $h4 ) :  ?>
		<hgroup>
			<?php if ( '' !== $h2 ) :  ?><h2 class="mcmsb_heading"><?php echo $h2; ?></h2><?php endif ?>
			<?php if ( '' !== $h4 ) :  ?><h4 class="mcmsb_heading"><?php echo $h4; ?></h4><?php endif ?>
		</hgroup>
	<?php endif ?>
	<?php echo mcmsb_js_remove_mcmsautop( $content, true ); ?>
	<?php if ( '' !== $link && 'bottom' === $position ) {
