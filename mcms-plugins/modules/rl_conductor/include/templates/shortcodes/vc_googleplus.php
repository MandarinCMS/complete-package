 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_GooglePlus
 */
...
$class_to_filter = 'mcmsb_googleplus mcmsb_content_element mcmsb_googleplus_type_' . $type . ' vc_googleplus-annotation-' . $annotation . $this->getCSSAnimation( $css_animation ) . $this->getExtraClass( $el_class );
