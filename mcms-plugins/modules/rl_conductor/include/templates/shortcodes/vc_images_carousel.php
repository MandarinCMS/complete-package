 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_images_carousel
 */
...
$class_to_filter = 'mcmsb_images_carousel mcmsb_content_element vc_clearfix';
$class_to_filter .= vc_shortcode_custom_css_class( $css, ' ' ) . $this->getExtraClass( $el_class ) . $this->getCSSAnimation( $css_animation );
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $class_to_filter, $this->settings['base'], $atts );

$carousel_id = 'vc_images-carousel-' . MCMSBakeryShortCode_VC_images_carousel::getCarouselIndex();
				...
				<div class="vc_carousel-slideline">
					<div class="vc_carousel-slideline-inner">
						<?php foreach ( $images as $attach_id ) :  ?>
							...
							$i ++;
							if ( $attach_id > 0 ) {
								$post_thumbnail = mcmsb_getImageBySize( array(
									'attach_id' => $attach_id,
									'thumb_size' => $img_size,
								) );
							} else {
