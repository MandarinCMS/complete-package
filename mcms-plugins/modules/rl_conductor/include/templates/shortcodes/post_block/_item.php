...
<?php elseif ( 'link' === $block ) :  ?>
	<a href="<?php echo $post->link ?>" class="vc_read_more" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'rl_conductor' ), $post->title_attribute ) ); ?>"<?php echo $this->link_target ?>><?php _e( 'Read more', 'rl_conductor' ) ?></a>
<?php endif ?>
