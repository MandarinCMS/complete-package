 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_Vc_Pie
 */
...
$class_to_filter = 'vc_pie_chart mcmsb_content_element';
...
if ( '' !== $title ) {
	$output .= '<h4 class="mcmsb_heading mcmsb_pie_chart_heading">' . $title . '</h4>';
}
