 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_Row
 */
...
if ( $has_video_bg ) {
	...
	mcms_enqueue_script( 'vc_youtube_iframe_api_js' );
}

if ( ! empty( $parallax ) ) {
	mcms_enqueue_script( 'vc_jquery_skrollr_js' );
...
if ( ! empty( $parallax_image ) ) {
	if ( $has_video_bg ) {
		...
		$parallax_image_src = mcms_get_attachment_image_src( $parallax_image_id, 'full' );
...
$output .= mcmsb_js_remove_mcmsautop( $content );
$output .= '</section>';
$output .= $after_output;
