 ...
 * @var $css
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_Raw_html
 */
$el_class = $el_id = $css = '';
...
$class_to_filter = 'mcmsb_raw_code ' . ( ( 'vc_raw_html' === $this->settings['base'] ) ? 'mcmsb_content_element mcmsb_raw_html' : 'mcmsb_raw_js' );
