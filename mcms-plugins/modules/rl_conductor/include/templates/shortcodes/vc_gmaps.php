 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_Gmaps
 */
...
$class_to_filter = 'mcmsb_gmaps_widget mcmsb_content_element' . ( '' === $size ? ' vc_map_responsive' : '' );
...
<div class="<?php echo esc_attr( $css_class ); ?>" <?php echo implode( ' ', $wrapper_attributes ); ?>>
	<?php echo mcmsb_widget_title( array(
		'title' => $title,
		'extraclass' => 'mcmsb_map_heading',
	) ); ?>
	<div class="mcmsb_wrapper">
		<div class="mcmsb_map_wraper">
			<?php
