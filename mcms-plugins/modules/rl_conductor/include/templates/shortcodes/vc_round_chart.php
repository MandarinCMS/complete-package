 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_Vc_Round_Chart
 */
...
mcms_enqueue_script( 'vc_round_chart' );

$class_to_filter = 'vc_chart vc_round-chart mcmsb_content_element';
...
if ( '' !== $title ) {
	$title = '<h2 class="mcmsb_heading">' . $title . '</h4>';
}
