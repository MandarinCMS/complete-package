 ...
 * @var $title
 * Shortcode class
 * @var $this MCMSBakeryShortCode_Vc_Carousel
 */
...
mcms_enqueue_script( 'vc_carousel_js' );
mcms_enqueue_style( 'vc_carousel_css' );

$css_class = $this->settings['base'] . ' mcmsb_content_element vc_carousel_slider_' . $slides_per_view . ' vc_carousel_' . $mode . ( empty( $el_class ) ? '' : ' ' . $el_class );
$carousel_id = esc_attr( 'vc_carousel-' . MCMSBakeryShortCode_Vc_Carousel::getCarouselIndex() );
?>
<div
	...
	<div class="mcmsb_wrapper">
		<?php echo mcmsb_widget_title( array( 'title' => $title, 'extraclass' => 'mcmsb_gallery_heading' ) ) ?>
