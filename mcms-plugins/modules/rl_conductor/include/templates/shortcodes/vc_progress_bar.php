 ...
 * @var $css_animation
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_Progress_Bar
 */
...
$class_to_filter = 'vc_progress_bar mcmsb_content_element';
...
$output .= mcmsb_widget_title( array( 'title' => $title, 'extraclass' => 'mcmsb_progress_bar_heading' ) );
