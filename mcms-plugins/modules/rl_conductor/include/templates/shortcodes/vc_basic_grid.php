 ...
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_Basic_Grid
 */
$this->post_id = false;
$css = $el_class = '';
...
$class_to_filter = 'vc_grid-container vc_clearfix mcmsb_content_element ' . $this->shortcode;
...
if ( isset( $this->atts['style'] ) && 'pagination' === $this->atts['style'] ) {
	mcms_enqueue_script( 'twbs-pagination' );
}
