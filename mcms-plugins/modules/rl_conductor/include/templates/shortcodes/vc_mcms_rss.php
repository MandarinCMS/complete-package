 ...
 * @var $el_id
 * Shortcode class
 * @var $this MCMSBakeryShortCode_VC_Wp_Rss
 */
...
$output = '<div ' . implode( ' ', $wrapper_attributes ) . ' class="vc_mcms_rss mcmsb_content_element' . esc_attr( $el_class ) . '">';
$type = 'MCMS_Widget_RSS';
$args = array();
...
if ( is_object( $mcms_widget_factory ) && isset( $mcms_widget_factory->widgets, $mcms_widget_factory->widgets[ $type ] ) ) {
	...
	echo $this->debugComment( 'Widget ' . esc_attr( $type ) . 'Not found in : vc_mcms_rss' );
}
