...
<div class="vc_row-fluid vc_column">
	<div class="mcmsb_element_label"><?php _e( 'Font Family', 'rl_conductor' ); ?></div>
...
<?php if ( isset( $fields['no_font_style'] ) && false === $fields['no_font_style'] || ! isset( $fields['no_font_style'] ) ) : ?>
	<div class="vc_row-fluid vc_column">
		<div class="mcmsb_element_label"><?php _e( 'Font style', 'rl_conductor' ); ?></div>
...
<div class="vc_row-fluid vc_column vc_google_fonts_form_field-preview-wrapper">
	<div class="mcmsb_element_label"><?php _e( 'Google Fonts preview', 'rl_conductor' ); ?>:</div>
	<div class="vc_google_fonts_form_field-preview-container">
		<span><?php _e( 'Grumpy wizards make toxic brew for the evil Queen and Jack.', 'rl_conductor' ); ?></span>
	</div>
	<div class="vc_google_fonts_form_field-status-container"><span></span></div>
</div>

<input name="<?php echo $settings['param_name']; ?>"
	class="mcmsb_vc_param_value  <?php echo $settings['param_name'] . ' ' . $settings['type']; ?>_field" type="hidden"
