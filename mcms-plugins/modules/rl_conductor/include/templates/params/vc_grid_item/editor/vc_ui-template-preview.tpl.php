...
if ( $vc_grid_item_editor ) {
	...
	add_filter( 'vc_mcmsbakery_shortcode_get_controls_list', array( $vc_grid_item_editor, 'shortcodesControls' ) );
}
...
$menu = array();
remove_action( 'mcms_head', 'print_emoji_detection_script' );
remove_action( 'mcms_print_styles', 'print_emoji_styles' );
...
?>
	<style type="text/css">
		#screen-meta, #adminmenumain, .notice, #mcmsfooter, #message, .updated {
	...
	<div class="vc_ui-template-preview">
		...
		<div id="mcmsb_visual_composer" class="postbox " style="display: block;">
			<div class="inside">
				<div class="metabox-composer-content">
					<div id="visual_composer_content"
					     class="mcmsb_main_sortable main_wrapper ui-sortable ui-droppable"></div>
					<div id="vc_no-content-helper" class="vc_welcome"></div>
				</div>
				<input type="hidden" name="vc_rl_conductor_group_access_show_rule"
				       class="vc_rl_conductor_group_access_show_rule" value="all">
				<input type="hidden" id="mcmsb_vc_js_status" name="mcmsb_vc_js_status" value="true">
				<input type="hidden" id="mcmsb_vc_loading" name="mcmsb_vc_loading" value="Loading, please wait...">
				<input type="hidden" id="mcmsb_vc_loading_row" name="mcmsb_vc_loading_row" value="Crunching...">
