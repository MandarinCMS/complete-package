...
/**
 * @var $vc_btn MCMSBakeryShortCode_VC_Btn
 * @var $post MCMS_Post
 * @var $atts
 *
 * @var $style
...
VcShortcodeAutoloader::getInstance()->includeClass( 'MCMSBakeryShortCode_VC_Btn' );
$vc_btn = new MCMSBakeryShortCode_VC_Btn( array( 'base' => 'vc_btn' ) );
