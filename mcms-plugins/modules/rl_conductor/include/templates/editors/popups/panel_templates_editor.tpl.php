...
<div id="vc_templates-editor" class="vc_panel vc_templates-editor" style="display: none;">
	<div class="vc_panel-heading">
		...
		<h3 class="vc_panel-title"><?php _e( 'Templates', 'rl_conductor' ) ?></h3>
	</div>
	<div class="vc_panel-body vc_templates-body vc_properties-list vc_with-tabs">
		<div class="mcmsb_edit_form_elements">
			<div class="vc_column">
				<div id="vc_tabs-templates" class="vc_panel-tabs">
					...
					<ul class="vc_edit-form-tabs-menu">
						<li class="vc_edit-form-tab-control"><a class="vc_edit-form-link"
						                                        href="#tabs-templates-tabs-1"><?php _e( 'My templates', 'rl_conductor' ); ?></a>
						</li>
						<?php if ( $templates_exists ) :  ?>
							<li class="vc_edit-form-tab-control"><a class="vc_edit-form-link"
							                                        href="#tabs-templates-tabs-2"><?php _e( 'Default templates', 'rl_conductor' ); ?></a>
							</li>
						<?php endif ?>
					</ul>
					<div class="vc_edit-form-tab" id="tabs-templates-tabs-1" data-vc-ui-element="panel-edit-element-tab">
						<div class="vc_col-sm-12 vc_column inside">
							<div
								class="mcmsb_element_label"><?php _e( 'Save current layout as a template', 'rl_conductor' ) ?></div>
							<div class="edit_form_line">
								<input name="padding" class="mcmsb-textinput vc_title_name" type="text" value=""
								       id="vc_template-name"
								       placeholder="<?php _e( 'Template name', 'rl_conductor' ) ?>">
								<button id="vc_template-save"
								        class="vc_btn vc_btn-primary vc_btn-sm"><?php _e( 'Save Template', 'rl_conductor' ) ?></button>
							</div>
								<span
									class="vc_description"><?php _e( 'Save layout and reuse it on different sections of this site.', 'rl_conductor' ) ?></span>
						</div>
						<div class="vc_col-sm-12 vc_column">
							<div class="mcmsb_element_label"><?php _e( 'Load Template', 'rl_conductor' ) ?></div>
								<span
									class="vc_description"><?php _e( 'Append previosly saved template to the current layout', 'rl_conductor' ) ?></span>
							<ul class="mcmsb_templates_list" id="vc_template-list">
					...
					<?php if ( $templates_exists ) :  ?>
						<div class="vc_edit-form-tab" id="tabs-templates-tabs-2" data-vc-ui-element="panel-edit-element-tab">
							<div class="vc_col-sm-12 vc_column inside">
								...
								<div class="mcmsb_element_label"><?php _e( 'Load Template', 'rl_conductor' ); ?></div>
								<span
									class="description"><?php _e( 'Append default template to the current layout', 'rl_conductor' ); ?></span>
								<ul id="vc_default-template-list" class="mcmsb_templates_list">
									<?php foreach ( $templates as $key => $template ) :  ?>
										<li class="mcmsb_template_li" data-vc-ui-element="template">
