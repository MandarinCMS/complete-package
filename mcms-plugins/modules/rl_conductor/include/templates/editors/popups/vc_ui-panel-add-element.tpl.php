...
<div class="vc_ui-font-open-sans vc_ui-panel-window vc_media-xs vc_ui-panel"
	...
	<div class="vc_ui-panel-window-inner">
		<?php vc_include_template( 'editors/popups/vc_ui-header.tpl.php', array(
			'title' => __( 'Add Element', 'rl_conductor' ),
		...
		<div class="vc_ui-panel-content-container">
			<div class="vc_add-element-container">
				<div class="mcmsb-elements-list vc_filter-all" data-vc-ui-filter="*"
					data-vc-ui-element="panel-add-element-list">
					<ul class="mcmsb-content-layouts-container">
						<li class="vc_add-element-deprecated-warning">
							<div class="mcmsb_element_wrapper">
								<?php echo vc_message_warning( __( 'Elements within this list are deprecated and are no longer supported in newer versions of RazorLeaf Conductor.', 'rl_conductor' ) ) ?>
							</div>
						</li>
						...
						<?php if ( $box->isShowEmptyMessage() && true !== $box->getPartState() ) : ?>
							<li class="vc_add-element-access-warning">
								<div class="mcmsb_element_wrapper">
									<?php echo vc_message_warning( __( 'Your user role have restricted access to content elements. If required, contact your site administrator to change RazorLeaf Conductor Role Manager settings for your user role.', 'rl_conductor' ) ) ?>
								</div>
							</li>
						<?php endif; ?>
					</ul>
