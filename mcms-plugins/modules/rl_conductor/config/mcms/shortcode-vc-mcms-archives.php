...
return array(
	'name' => 'MCMS ' . __( 'Archives' ),
	'base' => 'vc_mcms_archives',
	'icon' => 'icon-mcmsb-mcms',
	'category' => __( 'MandarinCMS Widgets', 'rl_conductor' ),
	'class' => 'mcmsb_vc_mcms_widget',
	'weight' => - 50,
	'description' => __( 'A monthly archive of your sites posts', 'rl_conductor' ),
	'params' => array(
		array(
			'type' => 'textfield',
		...
		array(
			...
			'description' => __( 'Select display options for archives.', 'rl_conductor' ),
		),
		array(
			'type' => 'el_id',
