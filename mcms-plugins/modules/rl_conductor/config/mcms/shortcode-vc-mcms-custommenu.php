...
return array(
	'name' => 'MCMS ' . __( 'Custom Menu' ),
	'base' => 'vc_mcms_custommenu',
	'icon' => 'icon-mcmsb-mcms',
	'category' => __( 'MandarinCMS Widgets', 'rl_conductor' ),
	'class' => 'mcmsb_vc_mcms_widget',
	'weight' => - 50,
	'description' => __( 'Use this widget to add one of your custom menus as a widget', 'rl_conductor' ),
	'params' => array(
		array(
			'type' => 'textfield',
		...
		array(
			'type' => 'dropdown',
			'heading' => __( 'Menu', 'rl_conductor' ),
			'param_name' => 'nav_menu',
			'value' => $custom_menus,
			'description' => empty( $custom_menus ) ? __( 'Custom menus not found. Please visit <b>Appearance > Menus</b> page to create new menu.', 'rl_conductor' ) : __( 'Select menu to display.', 'rl_conductor' ),
			'admin_label' => true,
			'save_always' => true,
		),
		array(
