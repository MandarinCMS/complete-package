...
return array(
	...
	'params' => array(
		...
		array(
			...
			'description' => __( 'Select tabs display style.', 'rl_conductor' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'shape',
			...
			'description' => __( 'Select tabs shape.', 'rl_conductor' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'color',
			'heading' => __( 'Color', 'rl_conductor' ),
			'description' => __( 'Select tabs color.', 'rl_conductor' ),
		...
		array(
			...
			'description' => __( 'Select tabs spacing.', 'rl_conductor' ),
			'std' => '1',
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tabs gap.', 'rl_conductor' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tabs navigation position.', 'rl_conductor' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => __( 'Select tabs section title alignment.', 'rl_conductor' ),
		),
		array(
			'type' => 'dropdown',
			'param_name' => 'autoplay',
			...
			'description' => __( 'Select auto rotate for tabs in seconds (Note: disabled by default).', 'rl_conductor' ),
		),
		array(
			'type' => 'textfield',
...
<div class="vc_tta-container" data-vc-action="collapse">
	...
	'default_content' => '
[vc_tta_section title="' . sprintf( '%s %d', __( 'Tab', 'rl_conductor' ), 1 ) . '"][/vc_tta_section]
[vc_tta_section title="' . sprintf( '%s %d', __( 'Tab', 'rl_conductor' ), 2 ) . '"][/vc_tta_section]
	',
