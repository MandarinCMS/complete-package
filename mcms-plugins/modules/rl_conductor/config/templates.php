...
$data = array();
$data['name'] = __( 'Landing Page', 'rl_conductor' );
$data['disabled'] = true;
...
$data = array();
$data['name'] = __( 'Call to Action Page', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Feature List', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description Page', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Service List', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Product Page', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** FAQ section */
$data = array();
$data['name'] = __( 'FAQ section', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** About section */
$data = array();
$data['name'] = __( 'About section', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** About section */
$data = array();
$data['name'] = __( 'About with features', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Three image description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** News list */
$data = array();
$data['name'] = __( 'News list', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Product description */
$data = array();
$data['name'] = __( 'Product description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with accordion', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Two column list */
$data = array();
$data['name'] = __( 'Two column list', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'About with tour section', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Rounded image description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with success message', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Images with tab description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Square on background', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Product description with tabs', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with headings', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Video description */
$data = array();
$data['name'] = __( 'Video with description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with buttons', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Map and Contacts */
$data = array();
$data['name'] = __( 'Map and Contacts', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Help section */
$data = array();
$data['name'] = __( 'Help section', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Screen description */
$data = array();
$data['name'] = __( 'Screen description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with round images', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'FAQ in three columns', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Centre description */
$data = array();
$data['name'] = __( 'Centre description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with gallery', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Centre description with image', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with thumbnails', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'About with left gallery', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Five image layout */
$data = array();
$data['name'] = __( 'Five image layout', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Accordion news list */
$data = array();
$data['name'] = __( 'Accordion news list', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Product with social icons', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Complex news layout */
$data = array();
$data['name'] = __( 'Complex news layout', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Product list with CTA', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Intro with features */
$data = array();
$data['name'] = __( 'Intro with features', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Image gallery with description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** Team members */
$data = array();
$data['name'] = __( 'Team members', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Large image with thumbnails', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Complex news layout II', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Service description layout', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Articles with headings', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" css=".vc_custom_1436530910893{background-color: #32a363 !important;}"][vc_column][vc_empty_space height="200px"][/vc_column][/vc_row][vc_row][vc_column width="1/3"][vc_custom_heading text="CUSTOM HEADING FOR ROW" font_container="tag:h1|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1436530789421{margin-top: 0px !important;}"][/vc_column][vc_column width="1/3"][vc_custom_heading text="Heading with MySkin Font" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1436530550784{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436530603605{margin-bottom: 15px !important;}"]
...
[/vc_column_text][/vc_column][vc_column width="1/3"][vc_custom_heading text="Heading with MySkin Font" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1436530550784{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436530603605{margin-bottom: 15px !important;}"]
This is a block where you can quickly describe less important services or side services which do not require lot of attention or maybe are the part of the main product or service.
...
/** Charts section */
$data = array();
$data['name'] = __( 'Charts section', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" css=".vc_custom_1434544165859{padding-top: 100px !important;padding-bottom: 100px !important;background-color: #eaeaea !important;}"][vc_column][vc_custom_heading text="CUSTOM HEADING TITLE OF THE SECTION" font_container="tag:h2|text_align:center" use_myskin_fonts="yes" css=".vc_custom_1434544875177{margin-top: 0px !important;}"][vc_row_inner][vc_column_inner width="1/4"][vc_round_chart type="doughnut" stroke_width="2" stroke_color="custom" legend="" values="%5B%7B%22title%22%3A%22One%22%2C%22value%22%3A%2260%22%2C%22color%22%3A%22orange%22%7D%2C%7B%22title%22%3A%22Two%22%2C%22value%22%3A%2240%22%2C%22color%22%3A%22sandy-brown%22%7D%5D" custom_stroke_color="#ebebeb"][/vc_column_inner][vc_column_inner width="1/4"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1434544764669{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1434542828932{margin-bottom: 15px !important;}"]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][vc_btn title="Read More" style="flat" color="vista-blue" align="left"][/vc_column_inner][vc_column_inner width="1/4"][vc_round_chart type="doughnut" stroke_width="2" stroke_color="custom" legend="" values="%5B%7B%22title%22%3A%22Two%22%2C%22value%22%3A%2220%22%2C%22color%22%3A%22sandy-brown%22%7D%2C%7B%22title%22%3A%22One%22%2C%22value%22%3A%2280%22%2C%22color%22%3A%22orange%22%7D%5D" custom_stroke_color="#ebebeb"][/vc_column_inner][vc_column_inner width="1/4"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1434544769752{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1434542828932{margin-bottom: 15px !important;}"]
...
/** Chess Grid */
$data = array();
$data['name'] = __( 'Chess Grid', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" css=".vc_custom_1434538871508{margin-bottom: 0px !important;}"][vc_column width="1/3"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" use_myskin_fonts="yes"][vc_column_text]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][vc_btn title="READ MORE" style="flat" color="purple" align="left"][/vc_column][vc_column width="1/3"][vc_single_image img_size="large" css=".vc_custom_1434538915151{margin-right: -15px !important;margin-left: -15px !important;}"][/vc_column][vc_column width="1/3"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" use_myskin_fonts="yes"][vc_column_text]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][vc_btn title="READ MORE" style="flat" color="purple" align="left"][/vc_column][/vc_row][vc_row full_width="stretch_row"][vc_column width="1/3"][vc_single_image img_size="large" css=".vc_custom_1434538921676{margin-right: -15px !important;margin-left: -15px !important;}"][/vc_column][vc_column width="1/3"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" use_myskin_fonts="yes"][vc_column_text]
...
$data = array();
$data['name'] = __( 'Features and articles', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-anchor" color="chino" size="lg" align="center"][vc_custom_heading text="Feature One" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-car" color="chino" size="lg" align="center"][vc_custom_heading text="Feature Two" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-cutlery" color="chino" size="lg" align="center"][vc_custom_heading text="Feature Three" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-life-ring" color="chino" size="lg" align="center"][vc_custom_heading text="Feature Four" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][/vc_row][vc_row full_width="stretch_row" css=".vc_custom_1435233845530{padding-top: 50px !important;padding-bottom: 50px !important;background-color: #f7f7f7 !important;}"][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][/vc_column][vc_column width="1/2"][vc_custom_heading text="Custom Heading Title" use_myskin_fonts="yes"][vc_column_text]
...
[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column width="1/4"][/vc_column][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][vc_btn title="Read More" color="chino" align="center"][/vc_column][vc_column width="1/4"][/vc_column][/vc_row][vc_row][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][vc_btn title="Read More" color="chino" align="center"][/vc_column][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_myskin_fonts="yes"][vc_column_text]
...
/** Features and charts */
$data = array();
$data['name'] = __( 'Features and charts', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row][vc_column width="1/3"][vc_icon type="openiconic" icon_openiconic="vc-oi vc-oi-comment-inv" color="white" background_style="rounded-less" background_color="blue" size="lg" align="center"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h3|text_align:center" use_myskin_fonts="yes" css=".vc_custom_1436536470111{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436536478730{margin-bottom: 15px !important;}"]
...
[/vc_column_text][/vc_column][/vc_row][vc_row full_width="stretch_row" css=".vc_custom_1436536173326{padding-top: 70px !important;padding-bottom: 50px !important;background-color: #4c7ac9 !important;}"][vc_column][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h2|text_align:center|color:%23f9f9f9" use_myskin_fonts="yes" css=".vc_custom_1436536188188{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436536318151{margin-bottom: 15px !important;}"]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column width="1/4"][vc_round_chart type="doughnut" stroke_width="2" legend=""][/vc_column][vc_column width="1/4"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1434544764669{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1434542828932{margin-bottom: 15px !important;}"]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][/vc_column][vc_column width="1/4"][vc_round_chart type="doughnut" stroke_width="2" legend="" values="%5B%7B%22title%22%3A%22Two%22%2C%22value%22%3A%2240%22%2C%22color%22%3A%22pink%22%7D%2C%7B%22title%22%3A%22One%22%2C%22value%22%3A%2260%22%2C%22color%22%3A%22blue%22%7D%5D"][/vc_column][vc_column width="1/4"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1434544764669{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1434542828932{margin-bottom: 15px !important;}"]
...
$data = array();
$data['name'] = __( 'Features with full width promo', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row"][vc_column width="1/3"][vc_single_image img_size="large"][vc_custom_heading text="Custom Heading for Feature Title" use_myskin_fonts="yes" css=".vc_custom_1434543954750{margin-top: 0px !important;}"][vc_column_text]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][/vc_column][vc_column width="1/3"][vc_single_image img_size="large"][vc_custom_heading text="Custom Heading for Feature Title" use_myskin_fonts="yes" css=".vc_custom_1434543954750{margin-top: 0px !important;}"][vc_column_text]
...
[/vc_column_text][/vc_column][/vc_row][vc_row full_width="stretch_row" parallax="content-moving" css=".vc_custom_1434543894706{padding-top: 50px !important;padding-bottom: 50px !important;background-color: #34a875 !important;}"][vc_column][vc_custom_heading text="Custom Heading Element for Promo Block" font_container="tag:h2|text_align:center|color:%23ffffff" use_myskin_fonts="yes" css=".vc_custom_1434543916938{padding-bottom: 10px !important;}"][vc_column_text css=".vc_custom_1434539588856{margin-bottom: 0px !important;}"]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][/vc_row][vc_row full_width="stretch_row"][vc_column width="1/3"][vc_single_image img_size="large"][vc_custom_heading text="Custom Heading for Feature Title" use_myskin_fonts="yes" css=".vc_custom_1434543954750{margin-top: 0px !important;}"][vc_column_text]
...
$data = array();
$data['name'] = __( 'Full height with transparent block', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Header section with features', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT

[vc_row][vc_column width="1/4"][vc_custom_heading text="Custom Heading Title" use_myskin_fonts="yes"][vc_column_text]

MandarinCMS is a free and open-source tool - features include a module architecture and a template system. MandarinCMS was used by more than 23.3% of the top 10 million websites as of January 2015. MandarinCMS is the most popular blogging system in use on the Web, at more than 60 million websites.

[/vc_column_text][/vc_column][vc_column width="3/4" css=".vc_custom_1436799832666{background-color: #f79467 !important;}"][vc_empty_space height="200px"][vc_custom_heading text="Custom Heading Title" font_container="tag:h2|text_align:left|color:%23ffffff" use_myskin_fonts="yes" css=".vc_custom_1436799543928{padding-left: 35px !important;}"][vc_column_text css=".vc_custom_1436799840479{padding-bottom: 50px !important;padding-left: 35px !important;}"]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][/vc_column][/vc_row][vc_row][vc_column width="1/4"][/vc_column][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-credit-card" color="white" background_style="boxed" background_color="sandy_brown" size="lg" align="center"][vc_custom_heading text="Feature One" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-inbox" color="white" background_style="boxed" background_color="sandy_brown" size="lg" align="center"][vc_custom_heading text="Feature Two" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]

Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit.

[/vc_column_text][/vc_column][vc_column width="1/4"][vc_icon icon_fontawesome="fa fa-paper-plane" color="white" background_style="boxed" background_color="sandy_brown" size="lg" align="center"][vc_custom_heading text="Feature Three" font_container="tag:h4|text_align:center" use_myskin_fonts="yes"][vc_column_text]
...
/** Helps with icons */
$data = array();
$data['name'] = __( 'Helps with icons', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Product introduction', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" parallax="content-moving" css=".vc_custom_1436530001615{padding-top: 100px !important;padding-bottom: 50px !important;background-color: #499b7a !important;}"][vc_column width="1/2"][vc_custom_heading text="Custom Heading with MySkin Font" font_container="tag:h2|text_align:left|color:%23ffffff" use_myskin_fonts="yes" css=".vc_custom_1436530166522{padding-bottom: 10px !important;}"][vc_column_text]
...
[/vc_column_text][vc_btn title="Read More" style="outline" shape="square" color="white" align="left"][/vc_column][vc_column width="1/2"][vc_single_image img_size="medium" alignment="center" style="vc_box_rounded"][/vc_column][/vc_row][vc_row][vc_column width="1/3"][vc_custom_heading text="Heading with MySkin Font" font_container="tag:h3|text_align:left" use_myskin_fonts="yes" css=".vc_custom_1436530550784{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436530603605{margin-bottom: 15px !important;}"]
...
$data = array();
$data['name'] = __( 'Services with block buttons', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row"][vc_column width="1/3"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" use_myskin_fonts="yes" css=".vc_custom_1434542653233{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1434542828932{margin-bottom: 15px !important;}"]

I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.

[/vc_column_text][vc_single_image img_size="large"][/vc_column][vc_column width="1/3"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" use_myskin_fonts="yes" css=".vc_custom_1434542653233{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1434542828932{margin-bottom: 15px !important;}"]
...
/** Video section */
$data = array();
$data['name'] = __( 'Video section', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" video_bg="yes" video_bg_parallax="content-moving" css=".vc_custom_1434537920178{padding-top: 150px !important;padding-bottom: 150px !important;}"][vc_column width="1/3"][/vc_column][vc_column width="1/3"][vc_custom_heading text="THIS IS CUSTOM HEADING ELEMENT" font_container="tag:h2|text_align:center|color:%23ffffff" use_myskin_fonts="yes" css=".vc_custom_1434538077842{padding-bottom: 20px !important;}"][vc_separator color="white" border_width="2" el_width="50"][vc_column_text]
...
/** Video promo */
$data = array();
$data['name'] = __( 'Video promo', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" full_height="yes" video_bg="yes" css=".vc_custom_1436534189440{margin-bottom: 0px !important;background-color: #319e60 !important;}"][vc_column width="1/2"][vc_empty_space height="300px"][vc_custom_heading text="CUSTOM HEADING FOR FULL HEIGHT HERO ROW" font_container="tag:h1|text_align:left|color:%23ffffff" use_myskin_fonts="yes" css=".vc_custom_1436532193902{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1438783043420{padding-bottom: 35px !important;}"]This section looks good with color background, background image and even video background and can be used as a nice Hero type header for any type of site or introduction block because of full height row.[/vc_column_text][/vc_column][vc_column width="1/2"][/vc_column][/vc_row][vc_row full_width="stretch_row" full_height="yes" css=".vc_custom_1436534035043{background-color: #dd4944 !important;}"][vc_column width="1/6"][/vc_column][vc_column width="2/3"][vc_custom_heading text="PRODUCT OVERVIEW" font_container="tag:h2|text_align:center|color:%23ffffff" use_myskin_fonts="yes" css=".vc_custom_1436534146913{margin-top: 0px !important;}"][vc_video][/vc_column][vc_column width="1/6"][/vc_column][/vc_row]
CONTENT;
...
/** Equal Feature List */
$data = array();
$data['name'] = __( 'Equal Feature List', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Parallax Introduction', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Full Height Features', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
/** EMy Team Members */
$data = array();
$data['name'] = __( 'My Team Members', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row][vc_column][vc_custom_heading text="Why Business Choose RazorLeaf Conductor?" font_container="tag:h3|font_size:38|text_align:center|color:%233a3a3a|line_height:1.2" google_fonts="font_family:Montserrat%3Aregular%2C700|font_style:400%20regular%3A400%3Anormal" css=".vc_custom_1453298979959{padding-bottom: 35px !important;}"][/vc_column][/vc_row][vc_row gap="15" equal_height="yes" css=".vc_custom_1453299367133{padding-bottom: 50px !important;}"][vc_column width="1/4"][vc_single_image img_size="200x200" alignment="center" style="vc_box_circle" css_animation="top-to-bottom"][vc_custom_heading text="Paula O'Reilly" font_container="tag:h4|font_size:22|text_align:center|color:%233a3a3a|line_height:1.2" google_fonts="font_family:Montserrat%3Aregular%2C700|font_style:400%20regular%3A400%3Anormal"][vc_column_text css=".vc_custom_1437056586937{margin-bottom: 10px !important;}"]Medium Size Business Owner[/vc_column_text][vc_column_text]My client loves how easy it is for them to manage their own site, after I set it up using RazorLeaf Conductor page builder module for MandarinCMS.[/vc_column_text][vc_btn title="Get in Touch" style="flat" shape="round" color="primary" align="center" link="||"][/vc_column][vc_column width="1/4"][vc_single_image img_size="200x200" alignment="center" style="vc_box_circle" css_animation="top-to-bottom"][vc_custom_heading text="Anabella Thomson" font_container="tag:h4|font_size:22|text_align:center|color:%233a3a3a|line_height:1.2" google_fonts="font_family:Montserrat%3Aregular%2C700|font_style:400%20regular%3A400%3Anormal"][vc_column_text css=".vc_custom_1437056567677{margin-bottom: 10px !important;}"]Startup Business Owner[/vc_column_text][vc_column_text]This plug-in was/is one of the BEST investments Iâ€™ve ever made. One thing is certain. Code Canyon/MCMSBakery is on top of this gem.[/vc_column_text][vc_btn title="Get in Touch" style="flat" shape="round" color="primary" align="center" link="||"][/vc_column][vc_column width="1/4"][vc_single_image img_size="200x200" alignment="center" style="vc_box_circle" css_animation="top-to-bottom"][vc_custom_heading text="Martin von Berdich" font_container="tag:h4|font_size:22|text_align:center|color:%233a3a3a|line_height:1.2" google_fonts="font_family:Montserrat%3Aregular%2C700|font_style:400%20regular%3A400%3Anormal"][vc_column_text css=".vc_custom_1437056604397{margin-bottom: 10px !important;}"]Client Relationship Manager[/vc_column_text][vc_column_text]RazorLeaf Conductor is our number one requirement because of RazorLeaf Conductor, our clients can manage their own website[/vc_column_text][vc_btn title="Get in Touch" style="flat" shape="round" color="primary" align="center" link="||"][/vc_column][vc_column width="1/4"][vc_single_image img_size="200x200" alignment="center" style="vc_box_circle" css_animation="top-to-bottom"][vc_custom_heading text="Paula Smith" font_container="tag:h4|font_size:22|text_align:center|color:%233a3a3a|line_height:1.2" google_fonts="font_family:Montserrat%3Aregular%2C700|font_style:400%20regular%3A400%3Anormal"][vc_column_text css=".vc_custom_1437056630846{margin-bottom: 10px !important;}"]Small Business Owner[/vc_column_text][vc_column_text]In my opinion this is the greatest advance of MandarinCMS since itâ€™s creation and is the most outstanding module on the market.[/vc_column_text][vc_btn title="Get in Touch" style="flat" shape="round" color="primary" align="center" link="||"][/vc_column][/vc_row]
CONTENT;
...
$data = array();
$data['name'] = __( 'Hero Image With Description', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
...
$data = array();
$data['name'] = __( 'Description with Image on Background', 'rl_conductor' );
$data['disabled'] = true;
$data['content'] = <<<CONTENT
