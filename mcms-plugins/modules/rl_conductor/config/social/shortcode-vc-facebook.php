...
return array(
	'name' => __( 'Facebook Like', 'rl_conductor' ),
	'base' => 'vc_facebook',
	'icon' => 'icon-mcmsb-balloon-facebook-left',
	'category' => __( 'Social', 'rl_conductor' ),
	'description' => __( 'Facebook "Like" button', 'rl_conductor' ),
	'params' => array(
		array(
			'type' => 'dropdown',
			...
			'admin_label' => true,
			'value' => array(
				__( 'Horizontal', 'rl_conductor' ) => 'standard',
				__( 'Horizontal with count', 'rl_conductor' ) => 'button_count',
				__( 'Vertical with count', 'rl_conductor' ) => 'box_count',
			),
			'description' => __( 'Select button type.', 'rl_conductor' ),
		),
