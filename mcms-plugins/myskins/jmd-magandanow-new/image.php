		...
		while (have_posts()) : the_post();
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<figure class="entry-thumbnail">
					<?php $att_image = mcms_get_attachment_image_src($post->id, 'full'); ?>
					<a href="<?php echo esc_url(mcms_get_attachment_url($post->id)); ?>" title="<?php the_title_attribute(); ?>" rel="attachment" target="_blank">
					...
					<?php if (has_excerpt()) { ?>
						<figcaption class="mh-attachment-excerpt mcms-caption-text">
							<?php the_excerpt(); ?>
						</figcaption>
					<?php } ?>
				</figure>
