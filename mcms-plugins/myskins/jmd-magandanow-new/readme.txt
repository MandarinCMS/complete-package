...
Contributors: mh-myskins
Tags: one-column, two-columns, left-sidebar, right-sidebar, flexible-header, custom-background, custom-colors, custom-header, custom-logo, custom-menu, featured-images, full-width-template, myskin-options, threaded-comments, footer-widgets, translation-ready, rtl-language-support, blog, entertainment, news
...
JMD MagandaNow lite is one of the most popular free responsive magandanews, news, newspaper and blog MandarinCMS myskins for modern online magandanewss, dynamic news websites, professional blogs and other editorial websites

== Description ==

JMD MagandaNow lite is one of the most popular free responsive magandanews, news, newspaper and blog MandarinCMS myskins for modern online magandanewss, dynamic news websites, professional blogs and other editorial websites. This free magandanews myskin is fast, secure, SEO friendly and perfectly suitable for topics like international news, politics, lifestyle, fashion, business, sports, gadgets, travel or anything else.

If you would like to gain access to more awesome features, flexible custom widgets and useful options to customize your website, you can upgrade to the premium version of JMD MagandaNow and take your website to the next level. You can also learn more about this dynamic magandanews MandarinCMS myskin on the MH MySkins website: https://www.mhmyskins.com/myskins/mh/magandanews/

== Installation ==

See myskin documentation: https://www.mhmyskins.com/support/documentation-mh-magandanews/
...
JMD MagandaNow lite MandarinCMS MySkin, Copyright 2013-2018 MH MySkins
JMD MagandaNow lite is distributed under the terms of the GNU GPL
MySkin URI: https://www.mhmyskins.com/myskins/mh/magandanews-lite/

You may remove the link to the MH MySkins website in the footer, but we would appreciate any attribution to our work!
...
2.) jQuery FlexSlider v2.1 | GPLv2 license | Copyright 2012 WooMySkins
Contributing Author: Tyler Smith
Source: https://github.com/woomyskins/FlexSlider
...
7.) Images from MySkin Screenshot
Source: http://pixabay.com/
License: Free Public Domain (GPL Compatible)
Overview: http://demo.mh-myskins.com/magandanews/credits/
...
= v2.8.4 25-09-2018 =
* Display admin notice only for official child myskins
...
= v2.8.0 18-05-2018 =
* Added support for GDPR features in MCMS 4.9.6
* Updated translation files
...
= v2.7.4 12-12-2017 =
* Improved caption of featured image to use MandarinCMS core function

= v2.7.3 16-11-2017 =
* Removed code to support shortcodes in widgets due to support by default in MCMS 4.9

= v2.7.2 22-10-2017 =
* CSS improvements to avoid conflicts with modules based on Bootstrap
...
* Added CSS for new core widgets in MandarinCMS 4.8
* Updated myskin description
* Updated german translation
* Updated translation files

= v2.6.4 15-05-2017 =
* Minor CSS fixes for navigation menu
* Highlighted dates with posts in MandarinCMS Calendar widget
...
= v2.5.8 16-01-2017 =
* Minor CSS adjustments
* Replaced pagination on archives with MandarinCMS core function the_posts_pagination()

= v2.5.7 18-12-2016 =
* Updated myskin links to HTTPS

= v2.5.6 09-12-2016 =
* Removed redundant option to scale background (core functionality in MCMS 4.7)
* Removed redundant function jmd_magandanow_new_html_class()
* Moved redundant jmd_html_class() function to mh-compatibility.php
* Updated translation files
...
= v2.5.4 24-10-2016 =
* Minor CSS adjustments
* Added new function jmd_magandanow_new_loop_layout() to handle archive layouts
* Removed redundant markup on myskin info page
* Changed color of button in welcome notice

= v2.5.3 04-10-2016 =
* Minor CSS adjustments
* Moved myskin links to myskin options panel 
* Removed redundant file mh-customizer.js
* Added dismissible admin notice to refer users to welcome page
* Updated myskin info page
* Updated german translation
* Updated translation files
...
* Removed redundant conditional tag in jmd_magandanow_new_scripts()
* Removed deprecated file content-attachment.php (replaced by image.php)
* Moved deprecated function jmd_magandanow_new_page_title() to mh-compatibility.php
* Updated russian translation - thanks to Denis
* Updated german translation
* Updated translation files

= v2.4.1 16-08-2016 =
* Added minor CSS tweaks to support MCMS User Avatar module (Gravatar alternative)
...
= v2.3.9 25-07-2016 =
* Added myskin support for custom logo (introduced in MCMS 4.5)
* Added icons for menu items to indicate if menu items have sub-menus
* Updated MandarinCMS.org myskin tags
...
= v2.3.0 06-04-2016 =
* Added selective refresh support for widgets (introduced in MCMS 4.5)
...
* Added styling for default MandarinCMS RSS widget

= v2.1.0 31-01-2016 =
* Removed custom meta field for subheading to meet MandarinCMS.org guidelines
* Added new MH Tabbed [lite] widget
* Added new MH Posts Large [lite] widget
* Added basic myskin support for WooCommerce
* Added missing translation strings
* Updated german translation
* Updated translation files

= v2.0.5 02-01-2016 =
* Added myskin features list to customizer
* Updated german translation
* Updated translation files

= v2.0.4 02-01-2016 =
* Renamed file mh-options.php to mh-customizer.php
* Escaped translation strings on myskin info page in MandarinCMS dashboard
* Added myskin related links to customizer to improve usability and support
...
= v2.0.3 02-01-2016 =
* Minor CSS fixes
* Fixed issue where font size of tag cloud could not be modified in child myskins

= v2.0.2 14-12-2015 =
* Reupload to MandarinCMS.org due to technical issues
...
* Removed redundant hook jmd_loop_content()
* Renamed file loop.php to content-loop.php
* Renamed file content.php to content-single.php
* Renamed image placeholders
* Removed option to disable comments on pages (disabled by default since MCMS 4.3)
...
* Prefixed grid to improve module compatibility
...
= v1.9.6 08-11-2015 =
* Fixed issue with MandarinCMS comments appearing on BuddyPress pages

= v1.9.5 02-11-2015 =
* Updated spanish translation - thanks to Rafael Magdalena

= v1.9.4 19-10-2015 =
* Minor CSS fixes to prepare for MCMS 4.4

= v1.9.3 27-09-2015 =
* Added IDs to widget areas for improved customization experience
* Removed backwards compatibility of title tag (introduced in MCMS 4.1)
...
= v1.8.7 30-07-2015 =
* Several minor design improvements
* Improved handling of excerpts for better module support
* Updated german translation
* Updated translation files
...
= v1.8.5 29-06-2015 =
* Updated constructor method for MCMS_Widget

= v1.8.4 21-06-2015 =
* Several code improvements
* Added myskin support for title tags (introduced in MCMS 4.1)
...
* Added viemcmsort meta tag to properly control layout on mobile browsers

= v1.8.0 14-04-2015 =
* Several code improvements
* Added proper copyright attribution to readme.txt
* Added responsive layout to support mobile devices
* Removed social links from myskin info page to meet MandarinCMS.org guidelines
...
= v1.6.8 03-02-2015 =
* Changed text domain to match myskin slug
* Updated translation files

= v1.6.7 16-01-2015 =
* Replaced myskin screenshot
* Added licensing information for images on myskin screenshot
* Updated myskin description
...
* Added myskin info page
* Added customizer panel for myskin options
* Moved settings to myskin options panel
...
= v1.6.3 21-12-2014 =
* Improved handling of options for customizer in MCMS 4.1
...
= v1.6.0 07-01-2014 =
* Fully updated and recoded myskin files
* Several CSS adjustments and code improvements
* Removed default logo due to requirements of MandarinCMS MySkins Directory
* Added new options to MH Facebook Likebox widget
* Added MH Affiliate widget so users can earn money by promoting MH MySkins
* Properly hooked mcms_link_pages() to fix issue with paginated posts
...
* Added "MySkin Support" dashboard widget to improve help with the myskin setup
* Updated translation strings
...
* Removed Customizer link in appearance menu because it's now default in MCMS 3.6
* Updated translation strings

= v1.5.4 10-07-2013 =
* Removed title of footer link due to requirements of MandarinCMS MySkins Directory
...
* Added jQuery migrate module to restore deprecated and removed functionality
...
= v1.5.1 07-07-2013 =
* Added filter to output mcms_title()
* mcms_footer is now called immediately above the closing body tag
* Removed some if function exists wrappers in functions.php
* Escaped home_url('/') in jmd_logo and searchform.php
...
* Several code improvements
* Replaced myskin screenshot due to requirements of MandarinCMS MySkins Directory
* Removed share buttons due to requirements of MandarinCMS MySkins Directory
...
* Replaced myskin logo and myskin screenshot in mcms dashboard
...
* Several code improvements
* Fixed CSS after Contact Form 7 module update
* Fixed CSS ordered lists
* Removed option to set social language because myskin recognizes automatically now
...
* Fixed issue mcmsSEO module regarding remove_action('shutdown', 'mcms_ob_end_flush_all', 1);
* Updated translation strings

= v1.2.0 16-03-2013 =
* Updated translation strings
* Replaced myskin screenshot in MandarinCMS dashboard
...
* Added myskin documentation url to readme.txt
