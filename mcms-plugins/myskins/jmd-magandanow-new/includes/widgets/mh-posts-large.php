...
class jmd_magandanow_new_posts_large extends MCMS_Widget {
	function __construct() {
		parent::__construct(
			'jmd_magandanow_new_posts_large', esc_html_x('MH Posts Large [lite]', 'widget name', 'jmd-magandanow-new'),
			array(
				'classname' => 'jmd_magandanow_new_posts_large',
				'description' => esc_html__('MH Posts Large widget to display posts (large-sized) including thumbnail images.', 'jmd-magandanow-new'),
