...
class jmd_magandanow_new_posts_stacked extends MCMS_Widget {
	function __construct() {
		parent::__construct(
			'jmd_magandanow_new_posts_stacked', esc_html_x('MH Posts Stacked [lite]', 'widget name', 'jmd-magandanow-new'),
			array(
				'classname' => 'jmd_magandanow_new_posts_stacked',
				'description' => esc_html__('MH Posts Stacked widget to display 5 stacked posts nicely including thumbnail, title and meta data.', 'jmd-magandanow-new'),
