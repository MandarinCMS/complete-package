...
class jmd_magandanow_new_tabbed extends MCMS_Widget {
	function __construct() {
		parent::__construct(
			'jmd_magandanow_new_tabbed', esc_html_x('MH Tabbed [lite]', 'widget name', 'jmd-magandanow-new'),
			array(
				'classname' => 'jmd_magandanow_new_tabbed',
				'description' => esc_html__('MH Tabbed widget showing your latest posts, tags and comments.', 'jmd-magandanow-new')
			)
		);
	}
		...
		echo $args['before_widget'];
			...
			<div class="mh-tabbed-widget">
				...
				<div id="tab-<?php echo esc_attr($args['widget_id']); ?>-1" class="mh-tab-content mh-tab-posts"><?php
					$latest_posts = new MCMS_Query(array('post_type' => 'post', 'posts_per_page' => 10, 'ignore_sticky_posts' => 1));
				...
				<div id="tab-<?php echo esc_attr($args['widget_id']); ?>-2" class="mh-tab-content mh-tab-cloud">
                	<div class="tagcloud mh-tab-content-cloud">
	                	<?php mcms_tag_cloud(array('number' => 25, 'smallest' => 12, 'largest' => 12, 'unit' => 'px')); ?>
					</div>
				</div>
				<div id="tab-<?php echo esc_attr($args['widget_id']); ?>-3" class="mh-tab-content mh-tab-comments"><?php
					$comments_query = new MCMS_Comment_Query;
					...
					if ($comments) {
						...
						esc_html_e('No comments found', 'jmd-magandanow-new');
					} ?>
				</div>
			</div><?php
