...
class jmd_custom_posts_widget extends MCMS_Widget {
    function __construct() {
		parent::__construct(
			'jmd_custom_posts', esc_html_x('MH Custom Posts [lite]', 'widget name', 'jmd-magandanow-new'),
			array(
				'classname' => 'jmd_custom_posts',
				'description' => esc_html__('Custom Posts Widget to display posts based on categories or tags.', 'jmd-magandanow-new'),
    ...
    function widget($args, $instance) {
		...
		$widget_loop = new MCMS_Query($query_args);
						...
						<figure class="mh-custom-posts-thumb">
							<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php
								if (has_post_thumbnail()) {
									the_post_thumbnail('jmd-magandanow-new-small');
								} else {
									echo '<img class="mh-image-placeholder" src="' . get_template_directory_uri() . '/images/placeholder-small.png' . '" alt="' . esc_html__('No Image', 'jmd-magandanow-new') . '" />';
								} ?>
							</a>
						</figure>
