 ...
 * @package Pizza Lite
 */
$metadata = mcms_get_attachment_metadata();
get_header(); ?>
<div class="container">
        ...
        <section class="site-main">
			<?php while ( have_posts() ) : the_post(); ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<span class="full-size-link"><a href="<?php echo esc_url( mcms_get_attachment_url() ); ?>"><?php echo esc_html( $metadata['width'] ); ?> &times; <?php echo esc_html( $metadata['height'] ); ?></a></span>
					...
					<?php edit_post_link( __( 'Edit', 'pizza-lite' ), '<span class="edit-link">', '</span>' ); ?>
                        ...
                        <nav role="navigation" id="image-navigation" class="image-navigation">
                            <div class="nav-previous"><?php previous_image_link( false, mcms_kses( '<span class="meta-nav">&larr;</span> Previous', 'pizza-lite' ) ); ?></div>
                            <div class="nav-next"><?php next_image_link( false, mcms_kses( 'Next <span class="meta-nav">&rarr;</span>', 'pizza-lite' ) ); ?></div>
