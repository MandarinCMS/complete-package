...
<div class="head-info-area">
        	<div class="center">
            	<?php $contact_add = get_myskin_mod('contact_add');
				if (!empty($contact_add)) { ?>
            	<div class="left">
                <span class="phntp"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/location.png"> <?php echo mcms_kses_post($contact_add); ?></span></div>   
                <?php } ?>   
                <?php $contact_no = get_myskin_mod('contact_no'); 
			  	if (!empty($contact_no)) { ?>          				
                <div class="right">
  ...
  <div class="clear"></div>      
    <div class="logo">
        ...
        <div class="sitenav">
          <?php mcms_nav_menu( array('myskin_location' => 'primary') ); ?>         
        </div><!-- .sitenav--> 
        <div class="clear"></div> 
  </div> <!-- container -->
</div><!--.header -->